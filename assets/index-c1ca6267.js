 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Be(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function bg(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(Be())}function Qu(){const t=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof t=="object"&&t.id!==void 0}function Ig(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Tg(){const t=Be();return t.indexOf("MSIE ")>=0||t.indexOf("Trident/")>=0}function Yu(){try{return typeof indexedDB=="object"}catch{return!1}}function Xu(){return new Promise((t,e)=>{try{let n=!0;const s="validate-browser-context-for-indexeddb-analytics-module",r=self.indexedDB.open(s);r.onsuccess=()=>{r.result.close(),n||self.indexedDB.deleteDatabase(s),t(!0)},r.onupgradeneeded=()=>{n=!1},r.onerror=()=>{var i;e(((i=r.error)===null||i===void 0?void 0:i.message)||"")}}catch(n){e(n)}})}function Eg(){return!(typeof navigator>"u"||!navigator.cookieEnabled)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oc(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(ph(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(dh(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(mh(e))return"Blackberry";if(yh(e))return"Webos";if(ia(e))return"Safari";if((e.includes("chrome/")||fh(e))&&!e.includes("edge/"))return"Chrome";if(gh(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=t.match(n);if((s==null?void 0:s.length)===2)return s[1]}return"Other"}function dh(t=Be()){return/firefox\//i.test(t)}function ia(t=Be()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function fh(t=Be()){return/crios\//i.test(t)}function ph(t=Be()){return/iemobile/i.test(t)}function gh(t=Be()){return/android/i.test(t)}function mh(t=Be()){return/blackberry/i.test(t)}function yh(t=Be()){return/webos/i.test(t)}function ii(t=Be()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function oy(t=Be()){var e;return ii(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function ay(){return Tg()&&document.documentMode===10}function _h(t=Be()){return ii(t)||gh(t)||yh(t)||mh(t)||/windows phone/i.test(t)||ph(t)}function cy(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vh(t,e=[]){let n;switch(t){case"Browser":n=Oc(Be());break;case"Worker":n=`${Oc(Be())}-${t}`;break;default:n=t}const s=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Ps}/${s}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const V_=5*60,j_=Wu("authIdTokenMaxAge")||V_;let zc=null;const B_=t=>async e=>{const n=e&&await e.getIdTokenResult(),s=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(s&&s>j_)return;const r=n==null?void 0:n.token;zc!==r&&(zc=r,await fetch(t,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))};function q_(t=ea()){const e=dn(t,"auth");if(e.isInitialized())return e.getImmediate();const n=Bm(t,{popupRedirectResolver:M_,persistence:[Hy,Sh,Ch]}),s=Wu("authTokenSyncURL");if(s){const i=B_(s);Dy(n,i,()=>i(n.currentUser)),Cy(n,o=>i(o))}const r=Gu("auth");return r&&hy(n,`http://${r}`),n}x_("Browser");const Mh="@firebase/installations",ha="0.6.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Z0=new Ce(B.comparator);function Ct(){return Z0}const $f=new Ce(B.comparator);function ts(...t){let e=$f;for(const n of t)e=e.insert(n.key,n);return e}function Pf(t){let e=$f;return t.forEach((n,s)=>e=e.insert(n,s.overlayedDocument)),e}function Xt(){return us()}function Lf(){return us()}function us(){return new Kn(t=>t.toString(),(t,e)=>t.isEqual(e))}const eb=new Ce(B.comparator),tb=new Se(B.comparator);function se(...t){let e=tb;for(const n of t)e=e.add(n);return e}const nb=new Se(ue);function Mf(){return nb}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tb{constructor(e){this.oe=e}}function Eb(t){const e=gb({parent:t.parent,structuredQuery:t.structuredQuery});return t.limitType==="LAST"?Bo(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class He{constructor(e,n,s){this.converter=n,this._key=s,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Ut(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new He(this.firestore,e,this._key)}}class Wn{constructor(e,n,s){this.converter=n,this._query=s,this.type="query",this.firestore=e}withConverter(e){return new Wn(this.firestore,e,this._query)}}class Ut extends Wn{constructor(e,n,s){super(e,n,ja(s)),this._path=s,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new He(this.firestore,null,new B(e))}withConverter(e){return new Ut(this.firestore,e,this._path)}}function KI(t,e,...n){if(t=Ae(t),lp("collection","path",e),t instanceof Li){const s=pe.fromString(e,...n);return Bl(s),new Ut(t,null,s)}{if(!(t instanceof He||t instanceof Ut))throw new L(E.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=t._path.child(pe.fromString(e,...n));return Bl(s),new Ut(t.firestore,null,s)}}function gr(t,e,...n){if(t=Ae(t),arguments.length===1&&(e=lf.R()),lp("doc","path",e),t instanceof Li){const s=pe.fromString(e,...n);return jl(s),new He(t,null,new B(s))}{if(!(t instanceof He||t instanceof Ut))throw new L(E.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=t._path.child(pe.fromString(e,...n));return jl(s),new He(t.firestore,t instanceof Ut?t.converter:null,new B(s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
