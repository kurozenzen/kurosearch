 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rg=1e3,Ng=2,Og=4*60*60*1e3,Pg=.5;function yc(t,e=Rg,n=Ng){const s=e*Math.pow(n,t),r=Math.round(Pg*s*(Math.random()-.5)*2);return Math.min(Og,s+r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ee(t){return t&&t._delegate?t._delegate:t}class Ze{constructor(e,n,s){this.name=e,this.instanceFactory=n,this.type=s,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Os=Em;function Xu(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s=Object.assign({name:yo,automaticDataCollectionEnabled:!1},e),r=s.name;if(typeof r!="string"||!r)throw Nt.create("bad-app-name",{appName:String(r)});if(n||(n=mg()),!n)throw Nt.create("no-options");const i=Cr.get(r);if(i){if(hs(n,i.options)&&hs(s,i.config))return i;throw Nt.create("duplicate-app",{appName:r})}const o=new Ug(r);for(const c of _o.values())o.addComponent(c);const a=new Cm(n,s,o);return Cr.set(r,a),a}function Xo(t=yo){const e=Cr.get(t);if(!e&&t===yo)return Xu();if(!e)throw Nt.create("no-app",{appName:t});return e}function Ge(t,e,n){var s;let r=(s=km[t])!==null&&s!==void 0?s:t;n&&(r+=`-${n}`);const i=r.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const a=[`Unable to register library "${r}" with version "${e}":`];i&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),i&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),en.warn(a.join(" "));return}lt(new Ze(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dm="firebase-heartbeat-database",Rm=1,ds="firebase-heartbeat-store";let Hi=null;function Ju(){return Hi||(Hi=Yu(Dm,Rm,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(ds)}}}).catch(t=>{throw Nt.create("idb-open",{originalErrorMessage:t.message})})),Hi}async function Nm(t){try{return(await Ju()).transaction(ds).objectStore(ds).get(Zu(t))}catch(e){if(e instanceof nt)en.warn(e.message);else{const n=Nt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});en.warn(n.message)}}}async function Ic(t,e){try{const s=(await Ju()).transaction(ds,"readwrite");return await s.objectStore(ds).put(e,Zu(t)),s.done}catch(n){if(n instanceof nt)en.warn(n.message);else{const s=Nt.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});en.warn(s.message)}}}function Zu(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sc=new Map;function pt(t){vt(t instanceof Function,"Expected a class definition");let e=Sc.get(t);return e?(vt(e instanceof t,"Instance stored in cache mismatched with class"),e):(e=new t,Sc.set(t,e),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ps{constructor(e,n){this.shortDelay=e,this.longDelay=n,vt(n>e,"Short delay should be less than long delay!"),this.isMobile=vg()||wg()}get(){return qm()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ea(t,e){vt(t.emulator,"Emulator should always be set here");const{url:n}=t.emulator;return e?`${n}${e.startsWith("/")?e.slice(1):e}`:n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yr(t,e,n){return`firebase:${t}:${e}:${n}`}class kn{constructor(e,n,s){this.persistence=e,this.auth=n,this.userKey=s;const{config:r,name:i}=this.auth;this.fullUserKey=yr(this.userKey,r.apiKey,i),this.fullPersistenceKey=yr("persistence",r.apiKey,i),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?Wt._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,s="authUser"){if(!n.length)return new kn(pt(Cc),e,s);const r=(await Promise.all(n.map(async l=>{if(await l._isAvailable())return l}))).filter(l=>l);let i=r[0]||pt(Cc);const o=yr(s,e.config.apiKey,e.name);let a=null;for(const l of n)try{const u=await l._get(o);if(u){const h=Wt._fromJSON(e,u);l!==i&&(a=h),i=l;break}}catch{}const c=r.filter(l=>l._shouldAllowMigration);return!i._shouldAllowMigration||!c.length?new kn(i,e,s):(i=c[0],a&&await i._set(o,a.toJSON()),await Promise.all(n.map(async l=>{if(l!==i)try{await l._remove(o)}catch{}})),new kn(i,e,s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function fy(t,e){return Ls(t,"POST","/v1/accounts:signInWithPassword",$s(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function py(t,e){return Ls(t,"POST","/v1/accounts:signInWithEmailLink",$s(t,e))}async function gy(t,e){return Ls(t,"POST","/v1/accounts:signInWithEmailLink",$s(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Sn(t,e){return Ls(t,"POST","/v1/accounts:signInWithIdp",$s(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class At extends Us{constructor(){super("facebook.com")}static credential(e){return tn._fromParams({providerId:At.PROVIDER_ID,signInMethod:At.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return At.credentialFromTaggedObject(e)}static credentialFromError(e){return At.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return At.credential(e.oauthAccessToken)}catch{return null}}}At.FACEBOOK_SIGN_IN_METHOD="facebook.com";At.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ct extends Us{constructor(){super("github.com")}static credential(e){return tn._fromParams({providerId:Ct.PROVIDER_ID,signInMethod:Ct.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Ct.credentialFromTaggedObject(e)}static credentialFromError(e){return Ct.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Ct.credential(e.oauthAccessToken)}catch{return null}}}Ct.GITHUB_SIGN_IN_METHOD="github.com";Ct.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dt extends Us{constructor(){super("twitter.com")}static credential(e,n){return tn._fromParams({providerId:Dt.PROVIDER_ID,signInMethod:Dt.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:n})}static credentialFromResult(e){return Dt.credentialFromTaggedObject(e)}static credentialFromError(e){return Dt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:n,oauthTokenSecret:s}=e;if(!n||!s)return null;try{return Dt.credential(n,s)}catch{return null}}}Dt.TWITTER_SIGN_IN_METHOD="twitter.com";Dt.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vy(t,e){return Ls(t,"POST","/v1/accounts:signUp",$s(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ky(t,e){return Ee(t).setPersistence(e)}function Sy(t,e,n,s){return Ee(t).onIdTokenChanged(e,n,s)}function Ay(t,e,n){return Ee(t).beforeAuthStateChanged(e,n)}function vh(t,e,n,s){return Ee(t).onAuthStateChanged(e,n,s)}function Cy(t){return Ee(t).signOut()}const Nr="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Py{constructor(e){this.target=e,this.handlers=new Set}removeMessageHandler(e){e.messageChannel&&(e.messageChannel.port1.removeEventListener("message",e.onMessage),e.messageChannel.port1.close()),this.handlers.delete(e)}async _send(e,n,s=50){const r=typeof MessageChannel<"u"?new MessageChannel:null;if(!r)throw new Error("connection_unavailable");let i,o;return new Promise((a,c)=>{const l=oa("",20);r.port1.start();const u=setTimeout(()=>{c(new Error("unsupported_event"))},s);o={messageChannel:r,onMessage(h){const d=h;if(d.data.eventId===l)switch(d.data.status){case"ack":clearTimeout(u),i=setTimeout(()=>{c(new Error("timeout"))},3e3);break;case"done":clearTimeout(i),a(d.data.response);break;default:clearTimeout(u),clearTimeout(i),c(new Error("invalid_response"));break}}},this.handlers.add(o),r.port1.addEventListener("message",o.onMessage),this.target.postMessage({eventType:e,eventId:l,data:n},[r.port2])}).finally(()=>{o&&this.removeMessageHandler(o)})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ot(){return window}function $y(t){ot().location.href=t}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gi="webStorageSupport";class P_{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Eh,this._completeRedirectFn=r_,this._overrideRedirectResult=t_}async _openPopup(e,n,s,r){var i;vt((i=this.eventManagers[e._key()])===null||i===void 0?void 0:i.manager,"_initialize() not called before _openPopup()");const o=Fc(e,n,s,vo(),r);return C_(e,o,oa())}async _openRedirect(e,n,s,r){return await this._originValidation(e),$y(Fc(e,n,s,vo(),r)),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:r,promise:i}=this.eventManagers[n];return r?Promise.resolve(r):(vt(i,"If manager is not set, promise should be"),i)}const s=this.initAndGetManager(e);return this.eventManagers[n]={promise:s},s.catch(()=>{delete this.eventManagers[n]}),s}async initAndGetManager(e){const n=await I_(e),s=new o_(e);return n.register("authEvent",r=>(q(r==null?void 0:r.authEvent,e,"invalid-auth-event"),{status:s.onEvent(r.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:s},this.iframes[e._key()]=n,s}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(Gi,{type:Gi},r=>{var i;const o=(i=r==null?void 0:r[0])===null||i===void 0?void 0:i[Gi];o!==void 0&&n(!!o),Ye(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=h_(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return ph()||na()||si()}}const $_=P_;var xc="@firebase/auth",Vc="0.21.5";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ph=1e4,$h=`w:${ca}`,Mh="FIS_v2",j_="https://firebaseinstallations.googleapis.com/v1",q_=60*60*1e3,z_="installations",H_="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qh=new Map;function zh(t,e){const n=oi(t);Hh(n,e),tv(n,e)}function Hh(t,e){const n=qh.get(t);if(n)for(const s of n)s(e)}function tv(t,e){const n=nv();n&&n.postMessage({key:t,fid:e}),sv()}let zt=null;function nv(){return!zt&&"BroadcastChannel"in self&&(zt=new BroadcastChannel("[Firebase] FID Change"),zt.onmessage=t=>{Hh(t.data.key,t.data.fid)}),zt}function sv(){qh.size===0&&zt&&(zt.close(),zt=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hv({appConfig:t,heartbeatServiceProvider:e},n){const s=dv(t,n),r=G_(t,n),i=e.getImmediate({optional:!0});if(i){const l=await i.getHeartbeatsHeader();l&&r.append("x-firebase-client",l)}const o={installation:{sdkVersion:$h,appId:t.appId}},a={method:"POST",headers:r,body:JSON.stringify(o)},c=await Bh(()=>fetch(s,a));if(c.ok){const l=await c.json();return Fh(l)}else throw await xh("Generate Auth Token",c)}function dv(t,{fid:e}){return`${Uh(t)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $r="analytics",Av="firebase_id",Cv="origin",Dv=60*1e3,Rv="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",Yh="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xh(t){return Promise.all(t.map(e=>e.catch(n=>n)))}function Nv(t,e){const n=document.createElement("script");n.src=`${Yh}?l=${t}&id=${e}`,n.async=!0,document.head.appendChild(n)}function Ov(t){let e=[];return Array.isArray(window[t])?e=window[t]:window[t]=e,e}async function Pv(t,e,n,s,r,i){const o=s[r];try{if(o)await e[o];else{const c=(await Xh(n)).find(l=>l.measurementId===r);c&&await e[c.appId]}}catch(a){ze.error(a)}t("config",r,i)}async function $v(t,e,n,s,r){try{let i=[];if(r&&r.send_to){let o=r.send_to;Array.isArray(o)||(o=[o]);const a=await Xh(n);for(const c of o){const l=a.find(h=>h.measurementId===c),u=l&&e[l.appId];if(u)i.push(u);else{i=[];break}}}i.length===0&&(i=Object.values(e)),await Promise.all(i),t("event",s,r||{})}catch(i){ze.error(i)}}function Mv(t,e,n,s){async function r(i,o,a){try{i==="event"?await $v(t,e,n,o,a):i==="config"?await Pv(t,e,n,s,o,a):i==="consent"?t("consent","update",a):t("set",o)}catch(c){ze.error(c)}}return r}function Lv(t,e,n,s,r){let i=function(...o){window[s].push(arguments)};return window[r]&&typeof window[r]=="function"&&(i=window[r]),window[r]=Mv(i,t,e,n),{gtagCore:i,wrappedGtag:window[r]}}function Uv(t){const e=window.document.getElementsByTagName("script");for(const n of Object.values(e))if(n.src&&n.src.includes(Yh)&&n.src.includes(t))return n;return null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xv{constructor(e){this.app=e}_delete(){return delete ss[this.app.options.appId],Promise.resolve()}}let ss={},zc=[];const Hc={};let Yi="dataLayer",Jv="gtag",Kc,ed,Gc=!1;function Zv(){const t=[];if(Hu()&&t.push("This is a browser extension environment."),Ig()||t.push("Cookies are not available."),t.length>0){const e=t.map((s,r)=>`(${r+1}) ${s}`).join(" "),n=We.create("invalid-analytics-context",{errorInfo:e});ze.warn(n.message)}}function ew(t,e,n){Zv();const s=t.options.appId;if(!s)throw We.create("no-app-id");if(!t.options.apiKey)if(t.options.measurementId)ze.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw We.create("no-api-key");if(ss[s]!=null)throw We.create("already-exists",{id:s});if(!Gc){Ov(Yi);const{wrappedGtag:i,gtagCore:o}=Lv(ss,zc,Hc,Yi,Jv);ed=i,Kc=o,Gc=!0}return ss[s]=Yv(t,zc,Hc,e,Kc,Yi,n),new Xv(t)}function tw(t=Xo()){t=Ee(t);const e=ln(t,$r);return e.isInitialized()?e.getImmediate():nw(t)}function nw(t,e={}){const n=ln(t,$r);if(n.isInitialized()){const r=n.getImmediate();if(hs(e,n.getOptions()))return r;throw We.create("already-initialized")}return n.initialize({options:e})}function sw(t,e,n,s){t=Ee(t),Wv(ed,ss[t.app.options.appId],e,n,s).catch(r=>ze.error(r))}const Wc="@firebase/analytics",Qc="0.9.4";function rw(){lt(new Ze($r,(e,{options:n})=>{const s=e.getProvider("app").getImmediate(),r=e.getProvider("installations-internal").getImmediate();return ew(s,r,n)},"PUBLIC")),lt(new Ze("analytics-internal",t,"PRIVATE")),Ge(Wc,Qc),Ge(Wc,Qc,"esm2017");function t(e){try{const n=e.getProvider($r).getImmediate();return{logEvent:(s,r,i)=>sw(n,s,r,i)}}catch(n){throw We.create("interop-component-reg-failed",{reason:n})}}}rw();var iw="firebase",ow="9.18.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Ge(iw,ow,"app");var aw=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},F,da=da||{},H=aw||self;function Mr(){}function ci(t){var e=typeof t;return e=e!="object"?e:t?Array.isArray(t)?"array":e:"null",e=="array"||e=="object"&&typeof t.length=="number"}function xs(t){var e=typeof t;return e=="object"&&t!=null||e=="function"}function cw(t){return Object.prototype.hasOwnProperty.call(t,Xi)&&t[Xi]||(t[Xi]=++lw)}var Xi="closure_uid_"+(1e9*Math.random()>>>0),lw=0;function uw(t,e,n){return t.call.apply(t.bind,arguments)}function hw(t,e,n){if(!t)throw Error();if(2<arguments.length){var s=Array.prototype.slice.call(arguments,2);return function(){var r=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(r,s),t.apply(e,r)}}return function(){return t.apply(e,arguments)}}function Fe(t,e,n){return Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?Fe=uw:Fe=hw,Fe.apply(null,arguments)}function ar(t,e){var n=Array.prototype.slice.call(arguments,1);return function(){var s=n.slice();return s.push.apply(s,arguments),t.apply(this,s)}}function Ne(t,e){function n(){}n.prototype=e.prototype,t.X=e.prototype,t.prototype=new n,t.prototype.constructor=t,t.Wb=function(s,r,i){for(var o=Array(arguments.length-2),a=2;a<arguments.length;a++)o[a-2]=arguments[a];return e.prototype[r].apply(s,o)}}function Ut(){this.s=this.s,this.o=this.o}var dw=0;Ut.prototype.s=!1;Ut.prototype.na=function(){!this.s&&(this.s=!0,this.M(),dw!=0)&&cw(this)};Ut.prototype.M=function(){if(this.o)for(;this.o.length;)this.o.shift()()};const td=Array.prototype.indexOf?function(t,e){return Array.prototype.indexOf.call(t,e,void 0)}:function(t,e){if(typeof t=="string")return typeof e!="string"||e.length!=1?-1:t.indexOf(e,0);for(let n=0;n<t.length;n++)if(n in t&&t[n]===e)return n;return-1};function fa(t){const e=t.length;if(0<e){const n=Array(e);for(let s=0;s<e;s++)n[s]=t[s];return n}return[]}function Yc(t,e){for(let n=1;n<arguments.length;n++){const s=arguments[n];if(ci(s)){const r=t.length||0,i=s.length||0;t.length=r+i;for(let o=0;o<i;o++)t[r+o]=s[o]}else t.push(s)}}function xe(t,e){this.type=t,this.g=this.target=e,this.defaultPrevented=!1}xe.prototype.h=function(){this.defaultPrevented=!0};var fw=function(){if(!H.addEventListener||!Object.defineProperty)return!1;var t=!1,e=Object.defineProperty({},"passive",{get:function(){t=!0}});try{H.addEventListener("test",Mr,e),H.removeEventListener("test",Mr,e)}catch{}return t}();function Lr(t){return/^[\s\xa0]*$/.test(t)}var Xc=String.prototype.trim?function(t){return t.trim()}:function(t){return/^[\s\xa0]*([\s\S]*?)[\s\xa0]*$/.exec(t)[1]};function Ji(t,e){return t<e?-1:t>e?1:0}function li(){var t=H.navigator;return t&&(t=t.userAgent)?t:""}function st(t){return li().indexOf(t)!=-1}function pa(t){return pa[" "](t),t}pa[" "]=Mr;function pw(t){var e=yw;return Object.prototype.hasOwnProperty.call(e,9)?e[9]:e[9]=t(9)}var gw=st("Opera"),Dn=st("Trident")||st("MSIE"),nd=st("Edge"),Io=nd||Dn,sd=st("Gecko")&&!(li().toLowerCase().indexOf("webkit")!=-1&&!st("Edge"))&&!(st("Trident")||st("MSIE"))&&!st("Edge"),mw=li().toLowerCase().indexOf("webkit")!=-1&&!st("Edge");function rd(){var t=H.document;return t?t.documentMode:void 0}var Ur;e:{var Zi="",eo=function(){var t=li();if(sd)return/rv:([^\);]+)(\)|;)/.exec(t);if(nd)return/Edge\/([\d\.]+)/.exec(t);if(Dn)return/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(t);if(mw)return/WebKit\/(\S+)/.exec(t);if(gw)return/(?:Version)[ \/]?(\S+)/.exec(t)}();if(eo&&(Zi=eo?eo[1]:""),Dn){var to=rd();if(to!=null&&to>parseFloat(Zi)){Ur=String(to);break e}}Ur=Zi}var yw={};function _w(){return pw(function(){let t=0;const e=Xc(String(Ur)).split("."),n=Xc("9").split("."),s=Math.max(e.length,n.length);for(let o=0;t==0&&o<s;o++){var r=e[o]||"",i=n[o]||"";do{if(r=/(\d*)(\D*)(.*)/.exec(r)||["","","",""],i=/(\d*)(\D*)(.*)/.exec(i)||["","","",""],r[0].length==0&&i[0].length==0)break;t=Ji(r[1].length==0?0:parseInt(r[1],10),i[1].length==0?0:parseInt(i[1],10))||Ji(r[2].length==0,i[2].length==0)||Ji(r[2],i[2]),r=r[3],i=i[3]}while(t==0)}return 0<=t})}var To;if(H.document&&Dn){var Jc=rd();To=Jc||parseInt(Ur,10)||void 0}else To=void 0;var vw=To;function ms(t,e){if(xe.call(this,t?t.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,t){var n=this.type=t.type,s=t.changedTouches&&t.changedTouches.length?t.changedTouches[0]:null;if(this.target=t.target||t.srcElement,this.g=e,e=t.relatedTarget){if(sd){e:{try{pa(e.nodeName);var r=!0;break e}catch{}r=!1}r||(e=null)}}else n=="mouseover"?e=t.fromElement:n=="mouseout"&&(e=t.toElement);this.relatedTarget=e,s?(this.clientX=s.clientX!==void 0?s.clientX:s.pageX,this.clientY=s.clientY!==void 0?s.clientY:s.pageY,this.screenX=s.screenX||0,this.screenY=s.screenY||0):(this.clientX=t.clientX!==void 0?t.clientX:t.pageX,this.clientY=t.clientY!==void 0?t.clientY:t.pageY,this.screenX=t.screenX||0,this.screenY=t.screenY||0),this.button=t.button,this.key=t.key||"",this.ctrlKey=t.ctrlKey,this.altKey=t.altKey,this.shiftKey=t.shiftKey,this.metaKey=t.metaKey,this.pointerId=t.pointerId||0,this.pointerType=typeof t.pointerType=="string"?t.pointerType:ww[t.pointerType]||"",this.state=t.state,this.i=t,t.defaultPrevented&&ms.X.h.call(this)}}Ne(ms,xe);var ww={2:"touch",3:"pen",4:"mouse"};ms.prototype.h=function(){ms.X.h.call(this);var t=this.i;t.preventDefault?t.preventDefault():t.returnValue=!1};var Vs="closure_listenable_"+(1e6*Math.random()|0),bw=0;function Iw(t,e,n,s,r){this.listener=t,this.proxy=null,this.src=e,this.type=n,this.capture=!!s,this.ha=r,this.key=++bw,this.ba=this.ea=!1}function ui(t){t.ba=!0,t.listener=null,t.proxy=null,t.src=null,t.ha=null}function ga(t,e,n){for(const s in t)e.call(n,t[s],s,t)}function id(t){const e={};for(const n in t)e[n]=t[n];return e}const Zc="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function od(t,e){let n,s;for(let r=1;r<arguments.length;r++){s=arguments[r];for(n in s)t[n]=s[n];for(let i=0;i<Zc.length;i++)n=Zc[i],Object.prototype.hasOwnProperty.call(s,n)&&(t[n]=s[n])}}function hi(t){this.src=t,this.g={},this.h=0}hi.prototype.add=function(t,e,n,s,r){var i=t.toString();t=this.g[i],t||(t=this.g[i]=[],this.h++);var o=ko(t,e,s,r);return-1<o?(e=t[o],n||(e.ea=!1)):(e=new Iw(e,this.src,i,!!s,r),e.ea=n,t.push(e)),e};function Eo(t,e){var n=e.type;if(n in t.g){var s=t.g[n],r=td(s,e),i;(i=0<=r)&&Array.prototype.splice.call(s,r,1),i&&(ui(e),t.g[n].length==0&&(delete t.g[n],t.h--))}}function ko(t,e,n,s){for(var r=0;r<t.length;++r){var i=t[r];if(!i.ba&&i.listener==e&&i.capture==!!n&&i.ha==s)return r}return-1}var ma="closure_lm_"+(1e6*Math.random()|0),no={};function ad(t,e,n,s,r){if(s&&s.once)return ld(t,e,n,s,r);if(Array.isArray(e)){for(var i=0;i<e.length;i++)ad(t,e[i],n,s,r);return null}return n=va(n),t&&t[Vs]?t.N(e,n,xs(s)?!!s.capture:!!s,r):cd(t,e,n,!1,s,r)}function cd(t,e,n,s,r,i){if(!e)throw Error("Invalid event type");var o=xs(r)?!!r.capture:!!r,a=_a(t);if(a||(t[ma]=a=new hi(t)),n=a.add(e,n,s,o,i),n.proxy)return n;if(s=Tw(),n.proxy=s,s.src=t,s.listener=n,t.addEventListener)fw||(r=o),r===void 0&&(r=!1),t.addEventListener(e.toString(),s,r);else if(t.attachEvent)t.attachEvent(hd(e.toString()),s);else if(t.addListener&&t.removeListener)t.addListener(s);else throw Error("addEventListener and attachEvent are unavailable.");return n}function Tw(){function t(n){return e.call(t.src,t.listener,n)}const e=Ew;return t}function ld(t,e,n,s,r){if(Array.isArray(e)){for(var i=0;i<e.length;i++)ld(t,e[i],n,s,r);return null}return n=va(n),t&&t[Vs]?t.O(e,n,xs(s)?!!s.capture:!!s,r):cd(t,e,n,!0,s,r)}function ud(t,e,n,s,r){if(Array.isArray(e))for(var i=0;i<e.length;i++)ud(t,e[i],n,s,r);else s=xs(s)?!!s.capture:!!s,n=va(n),t&&t[Vs]?(t=t.i,e=String(e).toString(),e in t.g&&(i=t.g[e],n=ko(i,n,s,r),-1<n&&(ui(i[n]),Array.prototype.splice.call(i,n,1),i.length==0&&(delete t.g[e],t.h--)))):t&&(t=_a(t))&&(e=t.g[e.toString()],t=-1,e&&(t=ko(e,n,s,r)),(n=-1<t?e[t]:null)&&ya(n))}function ya(t){if(typeof t!="number"&&t&&!t.ba){var e=t.src;if(e&&e[Vs])Eo(e.i,t);else{var n=t.type,s=t.proxy;e.removeEventListener?e.removeEventListener(n,s,t.capture):e.detachEvent?e.detachEvent(hd(n),s):e.addListener&&e.removeListener&&e.removeListener(s),(n=_a(e))?(Eo(n,t),n.h==0&&(n.src=null,e[ma]=null)):ui(t)}}}function hd(t){return t in no?no[t]:no[t]="on"+t}function Ew(t,e){if(t.ba)t=!0;else{e=new ms(e,this);var n=t.listener,s=t.ha||t.src;t.ea&&ya(t),t=n.call(s,e)}return t}function _a(t){return t=t[ma],t instanceof hi?t:null}var so="__closure_events_fn_"+(1e9*Math.random()>>>0);function va(t){return typeof t=="function"?t:(t[so]||(t[so]=function(e){return t.handleEvent(e)}),t[so])}function Ce(){Ut.call(this),this.i=new hi(this),this.P=this,this.I=null}Ne(Ce,Ut);Ce.prototype[Vs]=!0;Ce.prototype.removeEventListener=function(t,e,n,s){ud(this,t,e,n,s)};function Re(t,e){var n,s=t.I;if(s)for(n=[];s;s=s.I)n.push(s);if(t=t.P,s=e.type||e,typeof e=="string")e=new xe(e,t);else if(e instanceof xe)e.target=e.target||t;else{var r=e;e=new xe(s,t),od(e,r)}if(r=!0,n)for(var i=n.length-1;0<=i;i--){var o=e.g=n[i];r=cr(o,s,!0,e)&&r}if(o=e.g=t,r=cr(o,s,!0,e)&&r,r=cr(o,s,!1,e)&&r,n)for(i=0;i<n.length;i++)o=e.g=n[i],r=cr(o,s,!1,e)&&r}Ce.prototype.M=function(){if(Ce.X.M.call(this),this.i){var t=this.i,e;for(e in t.g){for(var n=t.g[e],s=0;s<n.length;s++)ui(n[s]);delete t.g[e],t.h--}}this.I=null};Ce.prototype.N=function(t,e,n,s){return this.i.add(String(t),e,!1,n,s)};Ce.prototype.O=function(t,e,n,s){return this.i.add(String(t),e,!0,n,s)};function cr(t,e,n,s){if(e=t.i.g[String(e)],!e)return!0;e=e.concat();for(var r=!0,i=0;i<e.length;++i){var o=e[i];if(o&&!o.ba&&o.capture==n){var a=o.listener,c=o.ha||o.src;o.ea&&Eo(t.i,o),r=a.call(c,s)!==!1&&r}}return r&&!s.defaultPrevented}var wa=H.JSON.stringify;function kw(){var t=pd;let e=null;return t.g&&(e=t.g,t.g=t.g.next,t.g||(t.h=null),e.next=null),e}class Sw{constructor(){this.h=this.g=null}add(e,n){const s=dd.get();s.set(e,n),this.h?this.h.next=s:this.g=s,this.h=s}}var dd=new class{constructor(t,e){this.i=t,this.j=e,this.h=0,this.g=null}get(){let t;return 0<this.h?(this.h--,t=this.g,this.g=t.next,t.next=null):t=this.i(),t}}(()=>new Aw,t=>t.reset());class Aw{constructor(){this.next=this.g=this.h=null}set(e,n){this.h=e,this.g=n,this.next=null}reset(){this.next=this.g=this.h=null}}function Cw(t){H.setTimeout(()=>{throw t},0)}function fd(t,e){So||Dw(),Ao||(So(),Ao=!0),pd.add(t,e)}var So;function Dw(){var t=H.Promise.resolve(void 0);So=function(){t.then(Rw)}}var Ao=!1,pd=new Sw;function Rw(){for(var t;t=kw();){try{t.h.call(t.g)}catch(n){Cw(n)}var e=dd;e.j(t),100>e.h&&(e.h++,t.next=e.g,e.g=t)}Ao=!1}function di(t,e){Ce.call(this),this.h=t||1,this.g=e||H,this.j=Fe(this.lb,this),this.l=Date.now()}Ne(di,Ce);F=di.prototype;F.ca=!1;F.R=null;F.lb=function(){if(this.ca){var t=Date.now()-this.l;0<t&&t<.8*this.h?this.R=this.g.setTimeout(this.j,this.h-t):(this.R&&(this.g.clearTimeout(this.R),this.R=null),Re(this,"tick"),this.ca&&(ba(this),this.start()))}};F.start=function(){this.ca=!0,this.R||(this.R=this.g.setTimeout(this.j,this.h),this.l=Date.now())};function ba(t){t.ca=!1,t.R&&(t.g.clearTimeout(t.R),t.R=null)}F.M=function(){di.X.M.call(this),ba(this),delete this.g};function Ia(t,e,n){if(typeof t=="function")n&&(t=Fe(t,n));else if(t&&typeof t.handleEvent=="function")t=Fe(t.handleEvent,t);else throw Error("Invalid listener argument");return 2147483647<Number(e)?-1:H.setTimeout(t,e||0)}function gd(t){t.g=Ia(()=>{t.g=null,t.i&&(t.i=!1,gd(t))},t.j);const e=t.h;t.h=null,t.m.apply(null,e)}class Nw extends Ut{constructor(e,n){super(),this.m=e,this.j=n,this.h=null,this.i=!1,this.g=null}l(e){this.h=arguments,this.g?this.i=!0:gd(this)}M(){super.M(),this.g&&(H.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function ys(t){Ut.call(this),this.h=t,this.g={}}Ne(ys,Ut);var el=[];function md(t,e,n,s){Array.isArray(n)||(n&&(el[0]=n.toString()),n=el);for(var r=0;r<n.length;r++){var i=ad(e,n[r],s||t.handleEvent,!1,t.h||t);if(!i)break;t.g[i.key]=i}}function yd(t){ga(t.g,function(e,n){this.g.hasOwnProperty(n)&&ya(e)},t),t.g={}}ys.prototype.M=function(){ys.X.M.call(this),yd(this)};ys.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};function fi(){this.g=!0}fi.prototype.Aa=function(){this.g=!1};function Ow(t,e,n,s,r,i){t.info(function(){if(t.g)if(i)for(var o="",a=i.split("&"),c=0;c<a.length;c++){var l=a[c].split("=");if(1<l.length){var u=l[0];l=l[1];var h=u.split("_");o=2<=h.length&&h[1]=="type"?o+(u+"="+l+"&"):o+(u+"=redacted&")}}else o=null;else o=i;return"XMLHTTP REQ ("+s+") [attempt "+r+"]: "+e+`
`+n+`
`+o})}function Pw(t,e,n,s,r,i,o){t.info(function(){return"XMLHTTP RESP ("+s+") [ attempt "+r+"]: "+e+`
`+n+`
`+i+" "+o})}function Tn(t,e,n,s){t.info(function(){return"XMLHTTP TEXT ("+e+"): "+Mw(t,n)+(s?" "+s:"")})}function $w(t,e){t.info(function(){return"TIMEOUT: "+e})}fi.prototype.info=function(){};function Mw(t,e){if(!t.g)return e;if(!e)return null;try{var n=JSON.parse(e);if(n){for(t=0;t<n.length;t++)if(Array.isArray(n[t])){var s=n[t];if(!(2>s.length)){var r=s[1];if(Array.isArray(r)&&!(1>r.length)){var i=r[0];if(i!="noop"&&i!="stop"&&i!="close")for(var o=1;o<r.length;o++)r[o]=""}}}}return wa(n)}catch{return e}}var un={},tl=null;function pi(){return tl=tl||new Ce}un.Pa="serverreachability";function _d(t){xe.call(this,un.Pa,t)}Ne(_d,xe);function _s(t){const e=pi();Re(e,new _d(e))}un.STAT_EVENT="statevent";function vd(t,e){xe.call(this,un.STAT_EVENT,t),this.stat=e}Ne(vd,xe);function je(t){const e=pi();Re(e,new vd(e,t))}un.Qa="timingevent";function wd(t,e){xe.call(this,un.Qa,t),this.size=e}Ne(wd,xe);function Bs(t,e){if(typeof t!="function")throw Error("Fn must not be null and must be a function");return H.setTimeout(function(){t()},e)}var gi={NO_ERROR:0,mb:1,zb:2,yb:3,tb:4,xb:5,Ab:6,Ma:7,TIMEOUT:8,Db:9},bd={rb:"complete",Nb:"success",Na:"error",Ma:"abort",Fb:"ready",Gb:"readystatechange",TIMEOUT:"timeout",Bb:"incrementaldata",Eb:"progress",ub:"downloadprogress",Vb:"uploadprogress"};function Ta(){}Ta.prototype.h=null;function nl(t){return t.h||(t.h=t.i())}function Id(){}var js={OPEN:"a",qb:"b",Na:"c",Cb:"d"};function Ea(){xe.call(this,"d")}Ne(Ea,xe);function ka(){xe.call(this,"c")}Ne(ka,xe);var Co;function mi(){}Ne(mi,Ta);mi.prototype.g=function(){return new XMLHttpRequest};mi.prototype.i=function(){return{}};Co=new mi;function qs(t,e,n,s){this.l=t,this.j=e,this.m=n,this.U=s||1,this.S=new ys(this),this.O=Lw,t=Io?125:void 0,this.T=new di(t),this.H=null,this.i=!1,this.s=this.A=this.v=this.K=this.F=this.V=this.B=null,this.D=[],this.g=null,this.C=0,this.o=this.u=null,this.Y=-1,this.I=!1,this.N=0,this.L=null,this.$=this.J=this.Z=this.P=!1,this.h=new Td}function Td(){this.i=null,this.g="",this.h=!1}var Lw=45e3,Do={},Fr={};F=qs.prototype;F.setTimeout=function(t){this.O=t};function Ro(t,e,n){t.K=1,t.v=_i(wt(e)),t.s=n,t.P=!0,Ed(t,null)}function Ed(t,e){t.F=Date.now(),zs(t),t.A=wt(t.v);var n=t.A,s=t.U;Array.isArray(s)||(s=[String(s)]),Od(n.i,"t",s),t.C=0,n=t.l.H,t.h=new Td,t.g=Zd(t.l,n?e:null,!t.s),0<t.N&&(t.L=new Nw(Fe(t.La,t,t.g),t.N)),md(t.S,t.g,"readystatechange",t.ib),e=t.H?id(t.H):{},t.s?(t.u||(t.u="POST"),e["Content-Type"]="application/x-www-form-urlencoded",t.g.da(t.A,t.u,t.s,e)):(t.u="GET",t.g.da(t.A,t.u,null,e)),_s(),Ow(t.j,t.u,t.A,t.m,t.U,t.s)}F.ib=function(t){t=t.target;const e=this.L;e&&gt(t)==3?e.l():this.La(t)};F.La=function(t){try{if(t==this.g)e:{const u=gt(this.g);var e=this.g.Ea();const h=this.g.aa();if(!(3>u)&&(u!=3||Io||this.g&&(this.h.h||this.g.fa()||ol(this.g)))){this.I||u!=4||e==7||(e==8||0>=h?_s(3):_s(2)),yi(this);var n=this.g.aa();this.Y=n;t:if(kd(this)){var s=ol(this.g);t="";var r=s.length,i=gt(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){Ht(this),rs(this);var o="";break t}this.h.i=new H.TextDecoder}for(e=0;e<r;e++)this.h.h=!0,t+=this.h.i.decode(s[e],{stream:i&&e==r-1});s.splice(0,r),this.h.g+=t,this.C=0,o=this.h.g}else o=this.g.fa();if(this.i=n==200,Pw(this.j,this.u,this.A,this.m,this.U,u,n),this.i){if(this.Z&&!this.J){t:{if(this.g){var a,c=this.g;if((a=c.g?c.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!Lr(a)){var l=a;break t}}l=null}if(n=l)Tn(this.j,this.m,n,"Initial handshake response via X-HTTP-Initial-Response"),this.J=!0,No(this,n);else{this.i=!1,this.o=3,je(12),Ht(this),rs(this);break e}}this.P?(Sd(this,u,o),Io&&this.i&&u==3&&(md(this.S,this.T,"tick",this.hb),this.T.start())):(Tn(this.j,this.m,o,null),No(this,o)),u==4&&Ht(this),this.i&&!this.I&&(u==4?Qd(this.l,this):(this.i=!1,zs(this)))}else n==400&&0<o.indexOf("Unknown SID")?(this.o=3,je(12)):(this.o=0,je(13)),Ht(this),rs(this)}}}catch{}finally{}};function kd(t){return t.g?t.u=="GET"&&t.K!=2&&t.l.Da:!1}function Sd(t,e,n){let s=!0,r;for(;!t.I&&t.C<n.length;)if(r=Uw(t,n),r==Fr){e==4&&(t.o=4,je(14),s=!1),Tn(t.j,t.m,null,"[Incomplete Response]");break}else if(r==Do){t.o=4,je(15),Tn(t.j,t.m,n,"[Invalid Chunk]"),s=!1;break}else Tn(t.j,t.m,r,null),No(t,r);kd(t)&&r!=Fr&&r!=Do&&(t.h.g="",t.C=0),e!=4||n.length!=0||t.h.h||(t.o=1,je(16),s=!1),t.i=t.i&&s,s?0<n.length&&!t.$&&(t.$=!0,e=t.l,e.g==t&&e.$&&!e.K&&(e.j.info("Great, no buffering proxy detected. Bytes received: "+n.length),Oa(e),e.K=!0,je(11))):(Tn(t.j,t.m,n,"[Invalid Chunked Response]"),Ht(t),rs(t))}F.hb=function(){if(this.g){var t=gt(this.g),e=this.g.fa();this.C<e.length&&(yi(this),Sd(this,t,e),this.i&&t!=4&&zs(this))}};function Uw(t,e){var n=t.C,s=e.indexOf(`
`,n);return s==-1?Fr:(n=Number(e.substring(n,s)),isNaN(n)?Do:(s+=1,s+n>e.length?Fr:(e=e.substr(s,n),t.C=s+n,e)))}F.cancel=function(){this.I=!0,Ht(this)};function zs(t){t.V=Date.now()+t.O,Ad(t,t.O)}function Ad(t,e){if(t.B!=null)throw Error("WatchDog timer not null");t.B=Bs(Fe(t.gb,t),e)}function yi(t){t.B&&(H.clearTimeout(t.B),t.B=null)}F.gb=function(){this.B=null;const t=Date.now();0<=t-this.V?($w(this.j,this.A),this.K!=2&&(_s(),je(17)),Ht(this),this.o=2,rs(this)):Ad(this,this.V-t)};function rs(t){t.l.G==0||t.I||Qd(t.l,t)}function Ht(t){yi(t);var e=t.L;e&&typeof e.na=="function"&&e.na(),t.L=null,ba(t.T),yd(t.S),t.g&&(e=t.g,t.g=null,e.abort(),e.na())}function No(t,e){try{var n=t.l;if(n.G!=0&&(n.g==t||Oo(n.h,t))){if(!t.J&&Oo(n.h,t)&&n.G==3){try{var s=n.Fa.g.parse(e)}catch{s=null}if(Array.isArray(s)&&s.length==3){var r=s;if(r[0]==0){e:if(!n.u){if(n.g)if(n.g.F+3e3<t.F)Br(n),bi(n);else break e;Na(n),je(18)}}else n.Ba=r[1],0<n.Ba-n.T&&37500>r[2]&&n.L&&n.A==0&&!n.v&&(n.v=Bs(Fe(n.cb,n),6e3));if(1>=Md(n.h)&&n.ja){try{n.ja()}catch{}n.ja=void 0}}else Kt(n,11)}else if((t.J||n.g==t)&&Br(n),!Lr(e))for(r=n.Fa.g.parse(e),e=0;e<r.length;e++){let l=r[e];if(n.T=l[0],l=l[1],n.G==2)if(l[0]=="c"){n.I=l[1],n.ka=l[2];const u=l[3];u!=null&&(n.ma=u,n.j.info("VER="+n.ma));const h=l[4];h!=null&&(n.Ca=h,n.j.info("SVER="+n.Ca));const d=l[5];d!=null&&typeof d=="number"&&0<d&&(s=1.5*d,n.J=s,n.j.info("backChannelRequestTimeoutMs_="+s)),s=n;const p=t.g;if(p){const m=p.g?p.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(m){var i=s.h;i.g||m.indexOf("spdy")==-1&&m.indexOf("quic")==-1&&m.indexOf("h2")==-1||(i.j=i.l,i.g=new Set,i.h&&(Sa(i,i.h),i.h=null))}if(s.D){const g=p.g?p.g.getResponseHeader("X-HTTP-Session-Id"):null;g&&(s.za=g,pe(s.F,s.D,g))}}n.G=3,n.l&&n.l.xa(),n.$&&(n.P=Date.now()-t.F,n.j.info("Handshake RTT: "+n.P+"ms")),s=n;var o=t;if(s.sa=Jd(s,s.H?s.ka:null,s.V),o.J){Ld(s.h,o);var a=o,c=s.J;c&&a.setTimeout(c),a.B&&(yi(a),zs(a)),s.g=o}else Gd(s);0<n.i.length&&Ii(n)}else l[0]!="stop"&&l[0]!="close"||Kt(n,7);else n.G==3&&(l[0]=="stop"||l[0]=="close"?l[0]=="stop"?Kt(n,7):Ra(n):l[0]!="noop"&&n.l&&n.l.wa(l),n.A=0)}}_s(4)}catch{}}function Fw(t){if(t.W&&typeof t.W=="function")return t.W();if(typeof Map<"u"&&t instanceof Map||typeof Set<"u"&&t instanceof Set)return Array.from(t.values());if(typeof t=="string")return t.split("");if(ci(t)){for(var e=[],n=t.length,s=0;s<n;s++)e.push(t[s]);return e}e=[],n=0;for(s in t)e[n++]=t[s];return e}function xw(t){if(t.oa&&typeof t.oa=="function")return t.oa();if(!t.W||typeof t.W!="function"){if(typeof Map<"u"&&t instanceof Map)return Array.from(t.keys());if(!(typeof Set<"u"&&t instanceof Set)){if(ci(t)||typeof t=="string"){var e=[];t=t.length;for(var n=0;n<t;n++)e.push(n);return e}e=[],n=0;for(const s in t)e[n++]=s;return e}}}function Cd(t,e){if(t.forEach&&typeof t.forEach=="function")t.forEach(e,void 0);else if(ci(t)||typeof t=="string")Array.prototype.forEach.call(t,e,void 0);else for(var n=xw(t),s=Fw(t),r=s.length,i=0;i<r;i++)e.call(void 0,s[i],n&&n[i],t)}var Dd=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Vw(t,e){if(t){t=t.split("&");for(var n=0;n<t.length;n++){var s=t[n].indexOf("="),r=null;if(0<=s){var i=t[n].substring(0,s);r=t[n].substring(s+1)}else i=t[n];e(i,r?decodeURIComponent(r.replace(/\+/g," ")):"")}}}function Qt(t,e){if(this.g=this.s=this.j="",this.m=null,this.o=this.l="",this.h=!1,t instanceof Qt){this.h=e!==void 0?e:t.h,xr(this,t.j),this.s=t.s,this.g=t.g,Vr(this,t.m),this.l=t.l,e=t.i;var n=new vs;n.i=e.i,e.g&&(n.g=new Map(e.g),n.h=e.h),sl(this,n),this.o=t.o}else t&&(n=String(t).match(Dd))?(this.h=!!e,xr(this,n[1]||"",!0),this.s=Xn(n[2]||""),this.g=Xn(n[3]||"",!0),Vr(this,n[4]),this.l=Xn(n[5]||"",!0),sl(this,n[6]||"",!0),this.o=Xn(n[7]||"")):(this.h=!!e,this.i=new vs(null,this.h))}Qt.prototype.toString=function(){var t=[],e=this.j;e&&t.push(Jn(e,rl,!0),":");var n=this.g;return(n||e=="file")&&(t.push("//"),(e=this.s)&&t.push(Jn(e,rl,!0),"@"),t.push(encodeURIComponent(String(n)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),n=this.m,n!=null&&t.push(":",String(n))),(n=this.l)&&(this.g&&n.charAt(0)!="/"&&t.push("/"),t.push(Jn(n,n.charAt(0)=="/"?qw:jw,!0))),(n=this.i.toString())&&t.push("?",n),(n=this.o)&&t.push("#",Jn(n,Hw)),t.join("")};function wt(t){return new Qt(t)}function xr(t,e,n){t.j=n?Xn(e,!0):e,t.j&&(t.j=t.j.replace(/:$/,""))}function Vr(t,e){if(e){if(e=Number(e),isNaN(e)||0>e)throw Error("Bad port number "+e);t.m=e}else t.m=null}function sl(t,e,n){e instanceof vs?(t.i=e,Kw(t.i,t.h)):(n||(e=Jn(e,zw)),t.i=new vs(e,t.h))}function pe(t,e,n){t.i.set(e,n)}function _i(t){return pe(t,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),t}function Xn(t,e){return t?e?decodeURI(t.replace(/%25/g,"%2525")):decodeURIComponent(t):""}function Jn(t,e,n){return typeof t=="string"?(t=encodeURI(t).replace(e,Bw),n&&(t=t.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),t):null}function Bw(t){return t=t.charCodeAt(0),"%"+(t>>4&15).toString(16)+(t&15).toString(16)}var rl=/[#\/\?@]/g,jw=/[#\?:]/g,qw=/[#\?]/g,zw=/[#\?@]/g,Hw=/#/g;function vs(t,e){this.h=this.g=null,this.i=t||null,this.j=!!e}function Ft(t){t.g||(t.g=new Map,t.h=0,t.i&&Vw(t.i,function(e,n){t.add(decodeURIComponent(e.replace(/\+/g," ")),n)}))}F=vs.prototype;F.add=function(t,e){Ft(this),this.i=null,t=Vn(this,t);var n=this.g.get(t);return n||this.g.set(t,n=[]),n.push(e),this.h+=1,this};function Rd(t,e){Ft(t),e=Vn(t,e),t.g.has(e)&&(t.i=null,t.h-=t.g.get(e).length,t.g.delete(e))}function Nd(t,e){return Ft(t),e=Vn(t,e),t.g.has(e)}F.forEach=function(t,e){Ft(this),this.g.forEach(function(n,s){n.forEach(function(r){t.call(e,r,s,this)},this)},this)};F.oa=function(){Ft(this);const t=Array.from(this.g.values()),e=Array.from(this.g.keys()),n=[];for(let s=0;s<e.length;s++){const r=t[s];for(let i=0;i<r.length;i++)n.push(e[s])}return n};F.W=function(t){Ft(this);let e=[];if(typeof t=="string")Nd(this,t)&&(e=e.concat(this.g.get(Vn(this,t))));else{t=Array.from(this.g.values());for(let n=0;n<t.length;n++)e=e.concat(t[n])}return e};F.set=function(t,e){return Ft(this),this.i=null,t=Vn(this,t),Nd(this,t)&&(this.h-=this.g.get(t).length),this.g.set(t,[e]),this.h+=1,this};F.get=function(t,e){return t?(t=this.W(t),0<t.length?String(t[0]):e):e};function Od(t,e,n){Rd(t,e),0<n.length&&(t.i=null,t.g.set(Vn(t,e),fa(n)),t.h+=n.length)}F.toString=function(){if(this.i)return this.i;if(!this.g)return"";const t=[],e=Array.from(this.g.keys());for(var n=0;n<e.length;n++){var s=e[n];const i=encodeURIComponent(String(s)),o=this.W(s);for(s=0;s<o.length;s++){var r=i;o[s]!==""&&(r+="="+encodeURIComponent(String(o[s]))),t.push(r)}}return this.i=t.join("&")};function Vn(t,e){return e=String(e),t.j&&(e=e.toLowerCase()),e}function Kw(t,e){e&&!t.j&&(Ft(t),t.i=null,t.g.forEach(function(n,s){var r=s.toLowerCase();s!=r&&(Rd(this,s),Od(this,r,n))},t)),t.j=e}var Gw=class{constructor(e,n){this.h=e,this.g=n}};function Pd(t){this.l=t||Ww,H.PerformanceNavigationTiming?(t=H.performance.getEntriesByType("navigation"),t=0<t.length&&(t[0].nextHopProtocol=="hq"||t[0].nextHopProtocol=="h2")):t=!!(H.g&&H.g.Ga&&H.g.Ga()&&H.g.Ga().$b),this.j=t?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}var Ww=10;function $d(t){return t.h?!0:t.g?t.g.size>=t.j:!1}function Md(t){return t.h?1:t.g?t.g.size:0}function Oo(t,e){return t.h?t.h==e:t.g?t.g.has(e):!1}function Sa(t,e){t.g?t.g.add(e):t.h=e}function Ld(t,e){t.h&&t.h==e?t.h=null:t.g&&t.g.has(e)&&t.g.delete(e)}Pd.prototype.cancel=function(){if(this.i=Ud(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const t of this.g.values())t.cancel();this.g.clear()}};function Ud(t){if(t.h!=null)return t.i.concat(t.h.D);if(t.g!=null&&t.g.size!==0){let e=t.i;for(const n of t.g.values())e=e.concat(n.D);return e}return fa(t.i)}function Aa(){}Aa.prototype.stringify=function(t){return H.JSON.stringify(t,void 0)};Aa.prototype.parse=function(t){return H.JSON.parse(t,void 0)};function Qw(){this.g=new Aa}function Yw(t,e,n){const s=n||"";try{Cd(t,function(r,i){let o=r;xs(r)&&(o=wa(r)),e.push(s+i+"="+encodeURIComponent(o))})}catch(r){throw e.push(s+"type="+encodeURIComponent("_badmap")),r}}function Xw(t,e){const n=new fi;if(H.Image){const s=new Image;s.onload=ar(lr,n,s,"TestLoadImage: loaded",!0,e),s.onerror=ar(lr,n,s,"TestLoadImage: error",!1,e),s.onabort=ar(lr,n,s,"TestLoadImage: abort",!1,e),s.ontimeout=ar(lr,n,s,"TestLoadImage: timeout",!1,e),H.setTimeout(function(){s.ontimeout&&s.ontimeout()},1e4),s.src=t}else e(!1)}function lr(t,e,n,s,r){try{e.onload=null,e.onerror=null,e.onabort=null,e.ontimeout=null,r(s)}catch{}}function Hs(t){this.l=t.ac||null,this.j=t.jb||!1}Ne(Hs,Ta);Hs.prototype.g=function(){return new vi(this.l,this.j)};Hs.prototype.i=function(t){return function(){return t}}({});function vi(t,e){Ce.call(this),this.D=t,this.u=e,this.m=void 0,this.readyState=Ca,this.status=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.v=new Headers,this.h=null,this.C="GET",this.B="",this.g=!1,this.A=this.j=this.l=null}Ne(vi,Ce);var Ca=0;F=vi.prototype;F.open=function(t,e){if(this.readyState!=Ca)throw this.abort(),Error("Error reopening a connection");this.C=t,this.B=e,this.readyState=1,ws(this)};F.send=function(t){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const e={headers:this.v,method:this.C,credentials:this.m,cache:void 0};t&&(e.body=t),(this.D||H).fetch(new Request(this.B,e)).then(this.Wa.bind(this),this.ga.bind(this))};F.abort=function(){this.response=this.responseText="",this.v=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Ks(this)),this.readyState=Ca};F.Wa=function(t){if(this.g&&(this.l=t,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=t.headers,this.readyState=2,ws(this)),this.g&&(this.readyState=3,ws(this),this.g)))if(this.responseType==="arraybuffer")t.arrayBuffer().then(this.Ua.bind(this),this.ga.bind(this));else if(typeof H.ReadableStream<"u"&&"body"in t){if(this.j=t.body.getReader(),this.u){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.A=new TextDecoder;Fd(this)}else t.text().then(this.Va.bind(this),this.ga.bind(this))};function Fd(t){t.j.read().then(t.Ta.bind(t)).catch(t.ga.bind(t))}F.Ta=function(t){if(this.g){if(this.u&&t.value)this.response.push(t.value);else if(!this.u){var e=t.value?t.value:new Uint8Array(0);(e=this.A.decode(e,{stream:!t.done}))&&(this.response=this.responseText+=e)}t.done?Ks(this):ws(this),this.readyState==3&&Fd(this)}};F.Va=function(t){this.g&&(this.response=this.responseText=t,Ks(this))};F.Ua=function(t){this.g&&(this.response=t,Ks(this))};F.ga=function(){this.g&&Ks(this)};function Ks(t){t.readyState=4,t.l=null,t.j=null,t.A=null,ws(t)}F.setRequestHeader=function(t,e){this.v.append(t,e)};F.getResponseHeader=function(t){return this.h&&this.h.get(t.toLowerCase())||""};F.getAllResponseHeaders=function(){if(!this.h)return"";const t=[],e=this.h.entries();for(var n=e.next();!n.done;)n=n.value,t.push(n[0]+": "+n[1]),n=e.next();return t.join(`\r
`)};function ws(t){t.onreadystatechange&&t.onreadystatechange.call(t)}Object.defineProperty(vi.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(t){this.m=t?"include":"same-origin"}});var Jw=H.JSON.parse;function me(t){Ce.call(this),this.headers=new Map,this.u=t||null,this.h=!1,this.C=this.g=null,this.H="",this.m=0,this.j="",this.l=this.F=this.v=this.D=!1,this.B=0,this.A=null,this.J=xd,this.K=this.L=!1}Ne(me,Ce);var xd="",Zw=/^https?$/i,e0=["POST","PUT"];F=me.prototype;F.Ka=function(t){this.L=t};F.da=function(t,e,n,s){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.H+"; newUri="+t);e=e?e.toUpperCase():"GET",this.H=t,this.j="",this.m=0,this.D=!1,this.h=!0,this.g=this.u?this.u.g():Co.g(),this.C=this.u?nl(this.u):nl(Co),this.g.onreadystatechange=Fe(this.Ha,this);try{this.F=!0,this.g.open(e,String(t),!0),this.F=!1}catch(i){il(this,i);return}if(t=n||"",n=new Map(this.headers),s)if(Object.getPrototypeOf(s)===Object.prototype)for(var r in s)n.set(r,s[r]);else if(typeof s.keys=="function"&&typeof s.get=="function")for(const i of s.keys())n.set(i,s.get(i));else throw Error("Unknown input type for opt_headers: "+String(s));s=Array.from(n.keys()).find(i=>i.toLowerCase()=="content-type"),r=H.FormData&&t instanceof H.FormData,!(0<=td(e0,e))||s||r||n.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[i,o]of n)this.g.setRequestHeader(i,o);this.J&&(this.g.responseType=this.J),"withCredentials"in this.g&&this.g.withCredentials!==this.L&&(this.g.withCredentials=this.L);try{jd(this),0<this.B&&((this.K=t0(this.g))?(this.g.timeout=this.B,this.g.ontimeout=Fe(this.qa,this)):this.A=Ia(this.qa,this.B,this)),this.v=!0,this.g.send(t),this.v=!1}catch(i){il(this,i)}};function t0(t){return Dn&&_w()&&typeof t.timeout=="number"&&t.ontimeout!==void 0}F.qa=function(){typeof da<"u"&&this.g&&(this.j="Timed out after "+this.B+"ms, aborting",this.m=8,Re(this,"timeout"),this.abort(8))};function il(t,e){t.h=!1,t.g&&(t.l=!0,t.g.abort(),t.l=!1),t.j=e,t.m=5,Vd(t),wi(t)}function Vd(t){t.D||(t.D=!0,Re(t,"complete"),Re(t,"error"))}F.abort=function(t){this.g&&this.h&&(this.h=!1,this.l=!0,this.g.abort(),this.l=!1,this.m=t||7,Re(this,"complete"),Re(this,"abort"),wi(this))};F.M=function(){this.g&&(this.h&&(this.h=!1,this.l=!0,this.g.abort(),this.l=!1),wi(this,!0)),me.X.M.call(this)};F.Ha=function(){this.s||(this.F||this.v||this.l?Bd(this):this.fb())};F.fb=function(){Bd(this)};function Bd(t){if(t.h&&typeof da<"u"&&(!t.C[1]||gt(t)!=4||t.aa()!=2)){if(t.v&&gt(t)==4)Ia(t.Ha,0,t);else if(Re(t,"readystatechange"),gt(t)==4){t.h=!1;try{const a=t.aa();e:switch(a){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var e=!0;break e;default:e=!1}var n;if(!(n=e)){var s;if(s=a===0){var r=String(t.H).match(Dd)[1]||null;if(!r&&H.self&&H.self.location){var i=H.self.location.protocol;r=i.substr(0,i.length-1)}s=!Zw.test(r?r.toLowerCase():"")}n=s}if(n)Re(t,"complete"),Re(t,"success");else{t.m=6;try{var o=2<gt(t)?t.g.statusText:""}catch{o=""}t.j=o+" ["+t.aa()+"]",Vd(t)}}finally{wi(t)}}}}function wi(t,e){if(t.g){jd(t);const n=t.g,s=t.C[0]?Mr:null;t.g=null,t.C=null,e||Re(t,"ready");try{n.onreadystatechange=s}catch{}}}function jd(t){t.g&&t.K&&(t.g.ontimeout=null),t.A&&(H.clearTimeout(t.A),t.A=null)}function gt(t){return t.g?t.g.readyState:0}F.aa=function(){try{return 2<gt(this)?this.g.status:-1}catch{return-1}};F.fa=function(){try{return this.g?this.g.responseText:""}catch{return""}};F.Sa=function(t){if(this.g){var e=this.g.responseText;return t&&e.indexOf(t)==0&&(e=e.substring(t.length)),Jw(e)}};function ol(t){try{if(!t.g)return null;if("response"in t.g)return t.g.response;switch(t.J){case xd:case"text":return t.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in t.g)return t.g.mozResponseArrayBuffer}return null}catch{return null}}F.Ea=function(){return this.m};F.Oa=function(){return typeof this.j=="string"?this.j:String(this.j)};function qd(t){let e="";return ga(t,function(n,s){e+=s,e+=":",e+=n,e+=`\r
`}),e}function Da(t,e,n){e:{for(s in n){var s=!1;break e}s=!0}s||(n=qd(n),typeof t=="string"?n!=null&&encodeURIComponent(String(n)):pe(t,e,n))}function Gn(t,e,n){return n&&n.internalChannelParams&&n.internalChannelParams[t]||e}function zd(t){this.Ca=0,this.i=[],this.j=new fi,this.ka=this.sa=this.F=this.V=this.g=this.za=this.D=this.ia=this.o=this.S=this.s=null,this.ab=this.U=0,this.Za=Gn("failFast",!1,t),this.L=this.v=this.u=this.m=this.l=null,this.Y=!0,this.pa=this.Ba=this.T=-1,this.Z=this.A=this.C=0,this.Xa=Gn("baseRetryDelayMs",5e3,t),this.bb=Gn("retryDelaySeedMs",1e4,t),this.$a=Gn("forwardChannelMaxRetries",2,t),this.ta=Gn("forwardChannelRequestTimeoutMs",2e4,t),this.ra=t&&t.xmlHttpFactory||void 0,this.Da=t&&t.Zb||!1,this.J=void 0,this.H=t&&t.supportsCrossDomainXhr||!1,this.I="",this.h=new Pd(t&&t.concurrentRequestLimit),this.Fa=new Qw,this.O=t&&t.fastHandshake||!1,this.N=t&&t.encodeInitMessageHeaders||!1,this.O&&this.N&&(this.N=!1),this.Ya=t&&t.Xb||!1,t&&t.Aa&&this.j.Aa(),t&&t.forceLongPolling&&(this.Y=!1),this.$=!this.O&&this.Y&&t&&t.detectBufferingProxy||!1,this.ja=void 0,this.P=0,this.K=!1,this.la=this.B=null}F=zd.prototype;F.ma=8;F.G=1;function Ra(t){if(Hd(t),t.G==3){var e=t.U++,n=wt(t.F);pe(n,"SID",t.I),pe(n,"RID",e),pe(n,"TYPE","terminate"),Gs(t,n),e=new qs(t,t.j,e,void 0),e.K=2,e.v=_i(wt(n)),n=!1,H.navigator&&H.navigator.sendBeacon&&(n=H.navigator.sendBeacon(e.v.toString(),"")),!n&&H.Image&&(new Image().src=e.v,n=!0),n||(e.g=Zd(e.l,null),e.g.da(e.v)),e.F=Date.now(),zs(e)}Xd(t)}function bi(t){t.g&&(Oa(t),t.g.cancel(),t.g=null)}function Hd(t){bi(t),t.u&&(H.clearTimeout(t.u),t.u=null),Br(t),t.h.cancel(),t.m&&(typeof t.m=="number"&&H.clearTimeout(t.m),t.m=null)}function Ii(t){$d(t.h)||t.m||(t.m=!0,fd(t.Ja,t),t.C=0)}function n0(t,e){return Md(t.h)>=t.h.j-(t.m?1:0)?!1:t.m?(t.i=e.D.concat(t.i),!0):t.G==1||t.G==2||t.C>=(t.Za?0:t.$a)?!1:(t.m=Bs(Fe(t.Ja,t,e),Yd(t,t.C)),t.C++,!0)}F.Ja=function(t){if(this.m)if(this.m=null,this.G==1){if(!t){this.U=Math.floor(1e5*Math.random()),t=this.U++;const r=new qs(this,this.j,t,void 0);let i=this.s;if(this.S&&(i?(i=id(i),od(i,this.S)):i=this.S),this.o!==null||this.N||(r.H=i,i=null),this.O)e:{for(var e=0,n=0;n<this.i.length;n++){t:{var s=this.i[n];if("__data__"in s.g&&(s=s.g.__data__,typeof s=="string")){s=s.length;break t}s=void 0}if(s===void 0)break;if(e+=s,4096<e){e=n;break e}if(e===4096||n===this.i.length-1){e=n+1;break e}}e=1e3}else e=1e3;e=Kd(this,r,e),n=wt(this.F),pe(n,"RID",t),pe(n,"CVER",22),this.D&&pe(n,"X-HTTP-Session-Id",this.D),Gs(this,n),i&&(this.N?e="headers="+encodeURIComponent(String(qd(i)))+"&"+e:this.o&&Da(n,this.o,i)),Sa(this.h,r),this.Ya&&pe(n,"TYPE","init"),this.O?(pe(n,"$req",e),pe(n,"SID","null"),r.Z=!0,Ro(r,n,null)):Ro(r,n,e),this.G=2}}else this.G==3&&(t?al(this,t):this.i.length==0||$d(this.h)||al(this))};function al(t,e){var n;e?n=e.m:n=t.U++;const s=wt(t.F);pe(s,"SID",t.I),pe(s,"RID",n),pe(s,"AID",t.T),Gs(t,s),t.o&&t.s&&Da(s,t.o,t.s),n=new qs(t,t.j,n,t.C+1),t.o===null&&(n.H=t.s),e&&(t.i=e.D.concat(t.i)),e=Kd(t,n,1e3),n.setTimeout(Math.round(.5*t.ta)+Math.round(.5*t.ta*Math.random())),Sa(t.h,n),Ro(n,s,e)}function Gs(t,e){t.ia&&ga(t.ia,function(n,s){pe(e,s,n)}),t.l&&Cd({},function(n,s){pe(e,s,n)})}function Kd(t,e,n){n=Math.min(t.i.length,n);var s=t.l?Fe(t.l.Ra,t.l,t):null;e:{var r=t.i;let i=-1;for(;;){const o=["count="+n];i==-1?0<n?(i=r[0].h,o.push("ofs="+i)):i=0:o.push("ofs="+i);let a=!0;for(let c=0;c<n;c++){let l=r[c].h;const u=r[c].g;if(l-=i,0>l)i=Math.max(0,r[c].h-100),a=!1;else try{Yw(u,o,"req"+l+"_")}catch{s&&s(u)}}if(a){s=o.join("&");break e}}}return t=t.i.splice(0,n),e.D=t,s}function Gd(t){t.g||t.u||(t.Z=1,fd(t.Ia,t),t.A=0)}function Na(t){return t.g||t.u||3<=t.A?!1:(t.Z++,t.u=Bs(Fe(t.Ia,t),Yd(t,t.A)),t.A++,!0)}F.Ia=function(){if(this.u=null,Wd(this),this.$&&!(this.K||this.g==null||0>=this.P)){var t=2*this.P;this.j.info("BP detection timer enabled: "+t),this.B=Bs(Fe(this.eb,this),t)}};F.eb=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.L=!1,this.K=!0,je(10),bi(this),Wd(this))};function Oa(t){t.B!=null&&(H.clearTimeout(t.B),t.B=null)}function Wd(t){t.g=new qs(t,t.j,"rpc",t.Z),t.o===null&&(t.g.H=t.s),t.g.N=0;var e=wt(t.sa);pe(e,"RID","rpc"),pe(e,"SID",t.I),pe(e,"CI",t.L?"0":"1"),pe(e,"AID",t.T),pe(e,"TYPE","xmlhttp"),Gs(t,e),t.o&&t.s&&Da(e,t.o,t.s),t.J&&t.g.setTimeout(t.J);var n=t.g;t=t.ka,n.K=1,n.v=_i(wt(e)),n.s=null,n.P=!0,Ed(n,t)}F.cb=function(){this.v!=null&&(this.v=null,bi(this),Na(this),je(19))};function Br(t){t.v!=null&&(H.clearTimeout(t.v),t.v=null)}function Qd(t,e){var n=null;if(t.g==e){Br(t),Oa(t),t.g=null;var s=2}else if(Oo(t.h,e))n=e.D,Ld(t.h,e),s=1;else return;if(t.G!=0){if(t.pa=e.Y,e.i)if(s==1){n=e.s?e.s.length:0,e=Date.now()-e.F;var r=t.C;s=pi(),Re(s,new wd(s,n)),Ii(t)}else Gd(t);else if(r=e.o,r==3||r==0&&0<t.pa||!(s==1&&n0(t,e)||s==2&&Na(t)))switch(n&&0<n.length&&(e=t.h,e.i=e.i.concat(n)),r){case 1:Kt(t,5);break;case 4:Kt(t,10);break;case 3:Kt(t,6);break;default:Kt(t,2)}}}function Yd(t,e){let n=t.Xa+Math.floor(Math.random()*t.bb);return t.l||(n*=2),n*e}function Kt(t,e){if(t.j.info("Error code "+e),e==2){var n=null;t.l&&(n=null);var s=Fe(t.kb,t);n||(n=new Qt("//www.google.com/images/cleardot.gif"),H.location&&H.location.protocol=="http"||xr(n,"https"),_i(n)),Xw(n.toString(),s)}else je(2);t.G=0,t.l&&t.l.va(e),Xd(t),Hd(t)}F.kb=function(t){t?(this.j.info("Successfully pinged google.com"),je(2)):(this.j.info("Failed to ping google.com"),je(1))};function Xd(t){if(t.G=0,t.la=[],t.l){const e=Ud(t.h);(e.length!=0||t.i.length!=0)&&(Yc(t.la,e),Yc(t.la,t.i),t.h.i.length=0,fa(t.i),t.i.length=0),t.l.ua()}}function Jd(t,e,n){var s=n instanceof Qt?wt(n):new Qt(n,void 0);if(s.g!="")e&&(s.g=e+"."+s.g),Vr(s,s.m);else{var r=H.location;s=r.protocol,e=e?e+"."+r.hostname:r.hostname,r=+r.port;var i=new Qt(null,void 0);s&&xr(i,s),e&&(i.g=e),r&&Vr(i,r),n&&(i.l=n),s=i}return n=t.D,e=t.za,n&&e&&pe(s,n,e),pe(s,"VER",t.ma),Gs(t,s),s}function Zd(t,e,n){if(e&&!t.H)throw Error("Can't create secondary domain capable XhrIo object.");return e=n&&t.Da&&!t.ra?new me(new Hs({jb:!0})):new me(t.ra),e.Ka(t.H),e}function ef(){}F=ef.prototype;F.xa=function(){};F.wa=function(){};F.va=function(){};F.ua=function(){};F.Ra=function(){};function jr(){if(Dn&&!(10<=Number(vw)))throw Error("Environmental error: no available transport.")}jr.prototype.g=function(t,e){return new He(t,e)};function He(t,e){Ce.call(this),this.g=new zd(e),this.l=t,this.h=e&&e.messageUrlParams||null,t=e&&e.messageHeaders||null,e&&e.clientProtocolHeaderRequired&&(t?t["X-Client-Protocol"]="webchannel":t={"X-Client-Protocol":"webchannel"}),this.g.s=t,t=e&&e.initMessageHeaders||null,e&&e.messageContentType&&(t?t["X-WebChannel-Content-Type"]=e.messageContentType:t={"X-WebChannel-Content-Type":e.messageContentType}),e&&e.ya&&(t?t["X-WebChannel-Client-Profile"]=e.ya:t={"X-WebChannel-Client-Profile":e.ya}),this.g.S=t,(t=e&&e.Yb)&&!Lr(t)&&(this.g.o=t),this.A=e&&e.supportsCrossDomainXhr||!1,this.v=e&&e.sendRawJson||!1,(e=e&&e.httpSessionIdParam)&&!Lr(e)&&(this.g.D=e,t=this.h,t!==null&&e in t&&(t=this.h,e in t&&delete t[e])),this.j=new Bn(this)}Ne(He,Ce);He.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.H=!0);var t=this.g,e=this.l,n=this.h||void 0;je(0),t.V=e,t.ia=n||{},t.L=t.Y,t.F=Jd(t,null,t.V),Ii(t)};He.prototype.close=function(){Ra(this.g)};He.prototype.u=function(t){var e=this.g;if(typeof t=="string"){var n={};n.__data__=t,t=n}else this.v&&(n={},n.__data__=wa(t),t=n);e.i.push(new Gw(e.ab++,t)),e.G==3&&Ii(e)};He.prototype.M=function(){this.g.l=null,delete this.j,Ra(this.g),delete this.g,He.X.M.call(this)};function tf(t){Ea.call(this);var e=t.__sm__;if(e){e:{for(const n in e){t=n;break e}t=void 0}(this.i=t)&&(t=this.i,e=e!==null&&t in e?e[t]:void 0),this.data=e}else this.data=t}Ne(tf,Ea);function nf(){ka.call(this),this.status=1}Ne(nf,ka);function Bn(t){this.g=t}Ne(Bn,ef);Bn.prototype.xa=function(){Re(this.g,"a")};Bn.prototype.wa=function(t){Re(this.g,new tf(t))};Bn.prototype.va=function(t){Re(this.g,new nf)};Bn.prototype.ua=function(){Re(this.g,"b")};jr.prototype.createWebChannel=jr.prototype.g;He.prototype.send=He.prototype.u;He.prototype.open=He.prototype.m;He.prototype.close=He.prototype.close;gi.NO_ERROR=0;gi.TIMEOUT=8;gi.HTTP_ERROR=6;bd.COMPLETE="complete";Id.EventType=js;js.OPEN="a";js.CLOSE="b";js.ERROR="c";js.MESSAGE="d";Ce.prototype.listen=Ce.prototype.N;me.prototype.listenOnce=me.prototype.O;me.prototype.getLastError=me.prototype.Oa;me.prototype.getLastErrorCode=me.prototype.Ea;me.prototype.getStatus=me.prototype.aa;me.prototype.getResponseJson=me.prototype.Sa;me.prototype.getResponseText=me.prototype.fa;me.prototype.send=me.prototype.da;me.prototype.setWithCredentials=me.prototype.Ka;var s0=function(){return new jr},r0=function(){return pi()},ro=gi,i0=bd,o0=un,cl={sb:0,vb:1,wb:2,Pb:3,Ub:4,Rb:5,Sb:6,Qb:7,Ob:8,Tb:9,PROXY:10,NOPROXY:11,Mb:12,Ib:13,Jb:14,Hb:15,Kb:16,Lb:17,ob:18,nb:19,pb:20},a0=Hs,ur=Id,c0=me;const ll="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const on=new ni("@firebase/firestore");function ul(){return on.logLevel}function V(t,...e){if(on.logLevel<=re.DEBUG){const n=e.map(Pa);on.debug(`Firestore (${jn}): ${t}`,...n)}}function bt(t,...e){if(on.logLevel<=re.ERROR){const n=e.map(Pa);on.error(`Firestore (${jn}): ${t}`,...n)}}function Po(t,...e){if(on.logLevel<=re.WARN){const n=e.map(Pa);on.warn(`Firestore (${jn}): ${t}`,...n)}}function Pa(t){if(typeof t=="string")return t;try{return e=t,JSON.stringify(e)}catch{return t}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function z(t="Unexpected state"){const e=`FIRESTORE (${jn}) INTERNAL ASSERTION FAILED: `+t;throw bt(e),new Error(e)}function le(t,e){t||z()}function X(t,e){return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const k={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};class M extends nt{constructor(e,n){super(e,n),this.code=e,this.message=n,this.toString=()=>`${this.name}: [code=${this.code}]: ${this.message}`}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sf{constructor(e,n){this.user=n,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class l0{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,n){e.enqueueRetryable(()=>n(Pe.UNAUTHENTICATED))}shutdown(){}}class u0{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,n){this.changeListener=n,e.enqueueRetryable(()=>n(this.token.user))}shutdown(){this.changeListener=null}}class h0{constructor(e){this.t=e,this.currentUser=Pe.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,n){let s=this.i;const r=c=>this.i!==s?(s=this.i,n(c)):Promise.resolve();let i=new Yt;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new Yt,e.enqueueRetryable(()=>r(this.currentUser))};const o=()=>{const c=i;e.enqueueRetryable(async()=>{await c.promise,await r(this.currentUser)})},a=c=>{V("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=c,this.auth.addAuthTokenListener(this.o),o()};this.t.onInit(c=>a(c)),setTimeout(()=>{if(!this.auth){const c=this.t.getImmediate({optional:!0});c?a(c):(V("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new Yt)}},0),o()}getToken(){const e=this.i,n=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(n).then(s=>this.i!==e?(V("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):s?(le(typeof s.accessToken=="string"),new sf(s.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.auth.removeAuthTokenListener(this.o)}u(){const e=this.auth&&this.auth.getUid();return le(e===null||typeof e=="string"),new Pe(e)}}class d0{constructor(e,n,s,r){this.h=e,this.l=n,this.m=s,this.g=r,this.type="FirstParty",this.user=Pe.FIRST_PARTY,this.p=new Map}I(){return this.g?this.g():(le(!(typeof this.h!="object"||this.h===null||!this.h.auth||!this.h.auth.getAuthHeaderValueForFirstParty)),this.h.auth.getAuthHeaderValueForFirstParty([]))}get headers(){this.p.set("X-Goog-AuthUser",this.l);const e=this.I();return e&&this.p.set("Authorization",e),this.m&&this.p.set("X-Goog-Iam-Authorization-Token",this.m),this.p}}class f0{constructor(e,n,s,r){this.h=e,this.l=n,this.m=s,this.g=r}getToken(){return Promise.resolve(new d0(this.h,this.l,this.m,this.g))}start(e,n){e.enqueueRetryable(()=>n(Pe.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class p0{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class g0{constructor(e){this.T=e,this.forceRefresh=!1,this.appCheck=null,this.A=null}start(e,n){const s=i=>{i.error!=null&&V("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const o=i.token!==this.A;return this.A=i.token,V("FirebaseAppCheckTokenProvider",`Received ${o?"new":"existing"} token.`),o?n(i.token):Promise.resolve()};this.o=i=>{e.enqueueRetryable(()=>s(i))};const r=i=>{V("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.appCheck.addTokenListener(this.o)};this.T.onInit(i=>r(i)),setTimeout(()=>{if(!this.appCheck){const i=this.T.getImmediate({optional:!0});i?r(i):V("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(n=>n?(le(typeof n.token=="string"),this.A=n.token,new p0(n.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.appCheck.removeTokenListener(this.o)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ie{constructor(e,n){if(this.seconds=e,this.nanoseconds=n,n<0)throw new M(k.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+n);if(n>=1e9)throw new M(k.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+n);if(e<-62135596800)throw new M(k.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e);if(e>=253402300800)throw new M(k.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e)}static now(){return Ie.fromMillis(Date.now())}static fromDate(e){return Ie.fromMillis(e.getTime())}static fromMillis(e){const n=Math.floor(e/1e3),s=Math.floor(1e6*(e-1e3*n));return new Ie(n,s)}toDate(){return new Date(this.toMillis())}toMillis(){return 1e3*this.seconds+this.nanoseconds/1e6}_compareTo(e){return this.seconds===e.seconds?ie(this.nanoseconds,e.nanoseconds):ie(this.seconds,e.seconds)}isEqual(e){return e.seconds===this.seconds&&e.nanoseconds===this.nanoseconds}toString(){return"Timestamp(seconds="+this.seconds+", nanoseconds="+this.nanoseconds+")"}toJSON(){return{seconds:this.seconds,nanoseconds:this.nanoseconds}}valueOf(){const e=this.seconds- -62135596800;return String(e).padStart(12,"0")+"."+String(this.nanoseconds).padStart(9,"0")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bs{constructor(e,n,s){n===void 0?n=0:n>e.length&&z(),s===void 0?s=e.length-n:s>e.length-n&&z(),this.segments=e,this.offset=n,this.len=s}get length(){return this.len}isEqual(e){return bs.comparator(this,e)===0}child(e){const n=this.segments.slice(this.offset,this.limit());return e instanceof bs?e.forEach(s=>{n.push(s)}):n.push(e),this.construct(n)}limit(){return this.offset+this.length}popFirst(e){return e=e===void 0?1:e,this.construct(this.segments,this.offset+e,this.length-e)}popLast(){return this.construct(this.segments,this.offset,this.length-1)}firstSegment(){return this.segments[this.offset]}lastSegment(){return this.get(this.length-1)}get(e){return this.segments[this.offset+e]}isEmpty(){return this.length===0}isPrefixOf(e){if(e.length<this.length)return!1;for(let n=0;n<this.length;n++)if(this.get(n)!==e.get(n))return!1;return!0}isImmediateParentOf(e){if(this.length+1!==e.length)return!1;for(let n=0;n<this.length;n++)if(this.get(n)!==e.get(n))return!1;return!0}forEach(e){for(let n=this.offset,s=this.limit();n<s;n++)e(this.segments[n])}toArray(){return this.segments.slice(this.offset,this.limit())}static comparator(e,n){const s=Math.min(e.length,n.length);for(let r=0;r<s;r++){const i=e.get(r),o=n.get(r);if(i<o)return-1;if(i>o)return 1}return e.length<n.length?-1:e.length>n.length?1:0}}class ue extends bs{construct(e,n,s){return new ue(e,n,s)}canonicalString(){return this.toArray().join("/")}toString(){return this.canonicalString()}static fromString(...e){const n=[];for(const s of e){if(s.indexOf("//")>=0)throw new M(k.INVALID_ARGUMENT,`Invalid segment (${s}). Paths must not contain // in them.`);n.push(...s.split("/").filter(r=>r.length>0))}return new ue(n)}static emptyPath(){return new ue([])}}const y0=/^[_a-zA-Z][_a-zA-Z0-9]*$/;class Le extends bs{construct(e,n,s){return new Le(e,n,s)}static isValidIdentifier(e){return y0.test(e)}canonicalString(){return this.toArray().map(e=>(e=e.replace(/\\/g,"\\\\").replace(/`/g,"\\`"),Le.isValidIdentifier(e)||(e="`"+e+"`"),e)).join(".")}toString(){return this.canonicalString()}isKeyField(){return this.length===1&&this.get(0)==="__name__"}static keyField(){return new Le(["__name__"])}static fromServerFormat(e){const n=[];let s="",r=0;const i=()=>{if(s.length===0)throw new M(k.INVALID_ARGUMENT,`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);n.push(s),s=""};let o=!1;for(;r<e.length;){const a=e[r];if(a==="\\"){if(r+1===e.length)throw new M(k.INVALID_ARGUMENT,"Path has trailing escape character: "+e);const c=e[r+1];if(c!=="\\"&&c!=="."&&c!=="`")throw new M(k.INVALID_ARGUMENT,"Path has invalid escape sequence: "+e);s+=c,r+=2}else a==="`"?(o=!o,r++):a!=="."||o?(s+=a,r++):(i(),r++)}if(i(),o)throw new M(k.INVALID_ARGUMENT,"Unterminated ` in path: "+e);return new Le(n)}static emptyPath(){return new Le([])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ws(t){if(t.code!==k.FAILED_PRECONDITION||t.message!==b0)throw t;V("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Be{constructor(e){this.binaryString=e}static fromBase64String(e){const n=function(s){try{return atob(s)}catch(r){throw r instanceof DOMException?new k0("Invalid base64 string: "+r):r}}(e);return new Be(n)}static fromUint8Array(e){const n=function(s){let r="";for(let i=0;i<s.length;++i)r+=String.fromCharCode(s[i]);return r}(e);return new Be(n)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return e=this.binaryString,btoa(e);var e}toUint8Array(){return function(e){const n=new Uint8Array(e.length);for(let s=0;s<e.length;s++)n[s]=e.charCodeAt(s);return n}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return ie(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}Be.EMPTY_BYTE_STRING=new Be("");const S0=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function $t(t){if(le(!!t),typeof t=="string"){let e=0;const n=S0.exec(t);if(le(!!n),n[1]){let r=n[1];r=(r+"000000000").substr(0,9),e=Number(r)}const s=new Date(t);return{seconds:Math.floor(s.getTime()/1e3),nanos:e}}return{seconds:we(t.seconds),nanos:we(t.nanos)}}function we(t){return typeof t=="number"?t:typeof t=="string"?Number(t):0}function Nn(t){return typeof t=="string"?Be.fromBase64String(t):Be.fromUint8Array(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function af(t){var e,n;return((n=(((e=t==null?void 0:t.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function cf(t){const e=t.mapValue.fields.__previous_value__;return af(e)?cf(e):e}function Ts(t){const e=$t(t.mapValue.fields.__local_write_time__.timestampValue);return new Ie(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lf{}class be extends lf{constructor(e,n,s){super(),this.field=e,this.op=n,this.value=s}static create(e,n,s){return e.isKeyField()?n==="in"||n==="not-in"?this.createKeyFieldInFilter(e,n,s):new D0(e,n,s):n==="array-contains"?new O0(e,s):n==="in"?new P0(e,s):n==="not-in"?new $0(e,s):n==="array-contains-any"?new M0(e,s):new be(e,n,s)}static createKeyFieldInFilter(e,n,s){return n==="in"?new R0(e,s):new N0(e,s)}matches(e){const n=e.data.field(this.field);return this.op==="!="?n!==null&&this.matchesComparison(On(n,this.value)):n!==null&&an(this.value)===an(n)&&this.matchesComparison(On(n,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return z()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}getFirstInequalityField(){return this.isInequality()?this.field:null}}class et extends lf{constructor(e,n){super(),this.filters=e,this.op=n,this.ft=null}static create(e,n){return new et(e,n)}matches(e){return uf(this)?this.filters.find(n=>!n.matches(e))===void 0:this.filters.find(n=>n.matches(e))!==void 0}getFlattenedFilters(){return this.ft!==null||(this.ft=this.filters.reduce((e,n)=>e.concat(n.getFlattenedFilters()),[])),this.ft}getFilters(){return Object.assign([],this.filters)}getFirstInequalityField(){const e=this.dt(n=>n.isInequality());return e!==null?e.field:null}dt(e){for(const n of this.getFlattenedFilters())if(e(n))return n;return null}}function uf(t){return t.op==="and"}function hf(t){return C0(t)&&uf(t)}function C0(t){for(const e of t.filters)if(e instanceof et)return!1;return!0}function Lo(t){if(t instanceof be)return t.field.canonicalString()+t.op.toString()+Pn(t.value);if(hf(t))return t.filters.map(e=>Lo(e)).join(",");{const e=t.filters.map(n=>Lo(n)).join(",");return`${t.op}(${e})`}}function df(t,e){return t instanceof be?function(n,s){return s instanceof be&&n.op===s.op&&n.field.isEqual(s.field)&&ut(n.value,s.value)}(t,e):t instanceof et?function(n,s){return s instanceof et&&n.op===s.op&&n.filters.length===s.filters.length?n.filters.reduce((r,i,o)=>r&&df(i,s.filters[o]),!0):!1}(t,e):void z()}function ff(t){return t instanceof be?function(e){return`${e.field.canonicalString()} ${e.op} ${Pn(e.value)}`}(t):t instanceof et?function(e){return e.op.toString()+" {"+e.getFilters().map(ff).join(" ,")+"}"}(t):"Filter"}class D0 extends be{constructor(e,n,s){super(e,n,s),this.key=j.fromName(s.referenceValue)}matches(e){const n=j.comparator(e.key,this.key);return this.matchesComparison(n)}}class R0 extends be{constructor(e,n){super(e,"in",n),this.keys=pf("in",n)}matches(e){return this.keys.some(n=>n.isEqual(e.key))}}class N0 extends be{constructor(e,n){super(e,"not-in",n),this.keys=pf("not-in",n)}matches(e){return!this.keys.some(n=>n.isEqual(e.key))}}function pf(t,e){var n;return(((n=e.arrayValue)===null||n===void 0?void 0:n.values)||[]).map(s=>j.fromName(s.referenceValue))}class O0 extends be{constructor(e,n){super(e,"array-contains",n)}matches(e){const n=e.data.field(this.field);return Ma(n)&&Es(n.arrayValue,this.value)}}class P0 extends be{constructor(e,n){super(e,"in",n)}matches(e){const n=e.data.field(this.field);return n!==null&&Es(this.value.arrayValue,n)}}class $0 extends be{constructor(e,n){super(e,"not-in",n)}matches(e){if(Es(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const n=e.data.field(this.field);return n!==null&&!Es(this.value.arrayValue,n)}}class M0 extends be{constructor(e,n){super(e,"array-contains-any",n)}matches(e){const n=e.data.field(this.field);return!(!Ma(n)||!n.arrayValue.values)&&n.arrayValue.values.some(s=>Es(this.value.arrayValue,s))}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $e{constructor(e,n,s,r,i,o,a){this.key=e,this.documentType=n,this.version=s,this.readTime=r,this.createTime=i,this.data=o,this.documentState=a}static newInvalidDocument(e){return new $e(e,0,Y.min(),Y.min(),Y.min(),Ke.empty(),0)}static newFoundDocument(e,n,s,r){return new $e(e,1,n,Y.min(),s,r,0)}static newNoDocument(e,n){return new $e(e,2,n,Y.min(),Y.min(),Ke.empty(),0)}static newUnknownDocument(e,n){return new $e(e,3,n,Y.min(),Y.min(),Ke.empty(),2)}convertToFoundDocument(e,n){return!this.createTime.isEqual(Y.min())||this.documentType!==2&&this.documentType!==0||(this.createTime=e),this.version=e,this.documentType=1,this.data=n,this.documentState=0,this}convertToNoDocument(e){return this.version=e,this.documentType=2,this.data=Ke.empty(),this.documentState=0,this}convertToUnknownDocument(e){return this.version=e,this.documentType=3,this.data=Ke.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=Y.min(),this}setReadTime(e){return this.readTime=e,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(e){return e instanceof $e&&this.key.isEqual(e.key)&&this.version.isEqual(e.version)&&this.documentType===e.documentType&&this.documentState===e.documentState&&this.data.isEqual(e.data)}mutableCopy(){return new $e(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const X0=new ke(j.comparator);function Tt(){return X0}const Df=new ke(j.comparator);function Zn(...t){let e=Df;for(const n of t)e=e.insert(n.key,n);return e}function Rf(t){let e=Df;return t.forEach((n,s)=>e=e.insert(n,s.overlayedDocument)),e}function Gt(){return cs()}function Nf(){return cs()}function cs(){return new zn(t=>t.toString(),(t,e)=>t.isEqual(e))}const J0=new ke(j.comparator),Z0=new Te(j.comparator);function Z(...t){let e=Z0;for(const n of t)e=e.add(n);return e}const eb=new Te(ie);function Of(){return eb}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ir{constructor(e,n,s,r){this.Et=e,this.removedTargetIds=n,this.key=s,this.At=r}}class Pf{constructor(e,n){this.targetId=e,this.Rt=n}}class $f{constructor(e,n,s=Be.EMPTY_BYTE_STRING,r=null){this.state=e,this.targetIds=n,this.resumeToken=s,this.cause=r}}class kl{constructor(){this.Pt=0,this.vt=Al(),this.bt=Be.EMPTY_BYTE_STRING,this.Vt=!1,this.St=!0}get current(){return this.Vt}get resumeToken(){return this.bt}get Dt(){return this.Pt!==0}get Ct(){return this.St}xt(e){e.approximateByteSize()>0&&(this.St=!0,this.bt=e)}Nt(){let e=Z(),n=Z(),s=Z();return this.vt.forEach((r,i)=>{switch(i){case 0:e=e.add(r);break;case 2:n=n.add(r);break;case 1:s=s.add(r);break;default:z()}}),new Js(this.bt,this.Vt,e,n,s)}kt(){this.St=!1,this.vt=Al()}$t(e,n){this.St=!0,this.vt=this.vt.insert(e,n)}Mt(e){this.St=!0,this.vt=this.vt.remove(e)}Ot(){this.Pt+=1}Ft(){this.Pt-=1}Bt(){this.St=!0,this.Vt=!0}}class tb{constructor(e){this.Lt=e,this.qt=new Map,this.Ut=Tt(),this.Kt=Sl(),this.Gt=new Te(ie)}Qt(e){for(const n of e.Et)e.At&&e.At.isFoundDocument()?this.jt(n,e.At):this.zt(n,e.key,e.At);for(const n of e.removedTargetIds)this.zt(n,e.key,e.At)}Wt(e){this.forEachTarget(e,n=>{const s=this.Ht(n);switch(e.state){case 0:this.Jt(n)&&s.xt(e.resumeToken);break;case 1:s.Ft(),s.Dt||s.kt(),s.xt(e.resumeToken);break;case 2:s.Ft(),s.Dt||this.removeTarget(n);break;case 3:this.Jt(n)&&(s.Bt(),s.xt(e.resumeToken));break;case 4:this.Jt(n)&&(this.Yt(n),s.xt(e.resumeToken));break;default:z()}})}forEachTarget(e,n){e.targetIds.length>0?e.targetIds.forEach(n):this.qt.forEach((s,r)=>{this.Jt(r)&&n(r)})}Zt(e){const n=e.targetId,s=e.Rt.count,r=this.Xt(n);if(r){const i=r.target;if(Uo(i))if(s===0){const o=new j(i.path);this.zt(n,o,$e.newNoDocument(o,Y.min()))}else le(s===1);else this.te(n)!==s&&(this.Yt(n),this.Gt=this.Gt.add(n))}}ee(e){const n=new Map;this.qt.forEach((i,o)=>{const a=this.Xt(o);if(a){if(i.current&&Uo(a.target)){const c=new j(a.target.path);this.Ut.get(c)!==null||this.ne(o,c)||this.zt(o,c,$e.newNoDocument(c,e))}i.Ct&&(n.set(o,i.Nt()),i.kt())}});let s=Z();this.Kt.forEach((i,o)=>{let a=!0;o.forEachWhile(c=>{const l=this.Xt(c);return!l||l.purpose===2||(a=!1,!1)}),a&&(s=s.add(i))}),this.Ut.forEach((i,o)=>o.setReadTime(e));const r=new Ci(e,n,this.Gt,this.Ut,s);return this.Ut=Tt(),this.Kt=Sl(),this.Gt=new Te(ie),r}jt(e,n){if(!this.Jt(e))return;const s=this.ne(e,n.key)?2:0;this.Ht(e).$t(n.key,s),this.Ut=this.Ut.insert(n.key,n),this.Kt=this.Kt.insert(n.key,this.se(n.key).add(e))}zt(e,n,s){if(!this.Jt(e))return;const r=this.Ht(e);this.ne(e,n)?r.$t(n,1):r.Mt(n),this.Kt=this.Kt.insert(n,this.se(n).delete(e)),s&&(this.Ut=this.Ut.insert(n,s))}removeTarget(e){this.qt.delete(e)}te(e){const n=this.Ht(e).Nt();return this.Lt.getRemoteKeysForTarget(e).size+n.addedDocuments.size-n.removedDocuments.size}Ot(e){this.Ht(e).Ot()}Ht(e){let n=this.qt.get(e);return n||(n=new kl,this.qt.set(e,n)),n}se(e){let n=this.Kt.get(e);return n||(n=new Te(ie),this.Kt=this.Kt.insert(e,n)),n}Jt(e){const n=this.Xt(e)!==null;return n||V("WatchChangeAggregator","Detected inactive target",e),n}Xt(e){const n=this.qt.get(e);return n&&n.Dt?null:this.Lt.ie(e)}Yt(e){this.qt.set(e,new kl),this.Lt.getRemoteKeysForTarget(e).forEach(n=>{this.zt(e,n,null)})}ne(e,n){return this.Lt.getRemoteKeysForTarget(e).has(n)}}function Sl(){return new ke(j.comparator)}function Al(){return new ke(j.comparator)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kb{constructor(){this.changes=new zn(e=>e.toString(),(e,n)=>e.isEqual(n)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,n){this.assertNotApplied(),this.changes.set(e,$e.newInvalidDocument(e).setReadTime(n))}getEntry(e,n){this.assertNotApplied();const s=this.changes.get(n);return s!==void 0?D.resolve(s):this.getFromCache(e,n)}getEntries(e,n){return this.getAllFromCache(e,n)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ab{constructor(e,n,s,r){this.remoteDocumentCache=e,this.mutationQueue=n,this.documentOverlayCache=s,this.indexManager=r}getDocument(e,n){let s=null;return this.documentOverlayCache.getOverlay(e,n).next(r=>(s=r,this.remoteDocumentCache.getEntry(e,n))).next(r=>(s!==null&&as(s.mutation,r,Je.empty(),Ie.now()),r))}getDocuments(e,n){return this.remoteDocumentCache.getEntries(e,n).next(s=>this.getLocalViewOfDocuments(e,s,Z()).next(()=>s))}getLocalViewOfDocuments(e,n,s=Z()){const r=Gt();return this.populateOverlays(e,r,n).next(()=>this.computeViews(e,n,r,s).next(i=>{let o=Zn();return i.forEach((a,c)=>{o=o.insert(a,c.overlayedDocument)}),o}))}getOverlayedDocuments(e,n){const s=Gt();return this.populateOverlays(e,s,n).next(()=>this.computeViews(e,n,s,Z()))}populateOverlays(e,n,s){const r=[];return s.forEach(i=>{n.has(i)||r.push(i)}),this.documentOverlayCache.getOverlays(e,r).next(i=>{i.forEach((o,a)=>{n.set(o,a)})})}computeViews(e,n,s,r){let i=Tt();const o=cs(),a=cs();return n.forEach((c,l)=>{const u=s.get(l.key);r.has(l.key)&&(u===void 0||u.mutation instanceof hn)?i=i.insert(l.key,l):u!==void 0?(o.set(l.key,u.mutation.getFieldMask()),as(u.mutation,l,u.mutation.getFieldMask(),Ie.now())):o.set(l.key,Je.empty())}),this.recalculateAndSaveOverlays(e,i).next(c=>(c.forEach((l,u)=>o.set(l,u)),n.forEach((l,u)=>{var h;return a.set(l,new Sb(u,(h=o.get(l))!==null&&h!==void 0?h:null))}),a))}recalculateAndSaveOverlays(e,n){const s=cs();let r=new ke((o,a)=>o-a),i=Z();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,n).next(o=>{for(const a of o)a.keys().forEach(c=>{const l=n.get(c);if(l===null)return;let u=s.get(c)||Je.empty();u=a.applyToLocalView(l,u),s.set(c,u);const h=(r.get(a.batchId)||Z()).add(c);r=r.insert(a.batchId,h)})}).next(()=>{const o=[],a=r.getReverseIterator();for(;a.hasNext();){const c=a.getNext(),l=c.key,u=c.value,h=Nf();u.forEach(d=>{if(!i.has(d)){const p=Sf(n.get(d),s.get(d));p!==null&&h.set(d,p),i=i.add(d)}}),o.push(this.documentOverlayCache.saveOverlays(e,l,h))}return D.waitFor(o)}).next(()=>s)}recalculateAndSaveOverlaysForDocumentKeys(e,n){return this.remoteDocumentCache.getEntries(e,n).next(s=>this.recalculateAndSaveOverlays(e,s))}getDocumentsMatchingQuery(e,n,s){return function(r){return j.isDocumentKey(r.path)&&r.collectionGroup===null&&r.filters.length===0}(n)?this.getDocumentsMatchingDocumentQuery(e,n.path):yf(n)?this.getDocumentsMatchingCollectionGroupQuery(e,n,s):this.getDocumentsMatchingCollectionQuery(e,n,s)}getNextDocuments(e,n,s,r){return this.remoteDocumentCache.getAllFromCollectionGroup(e,n,s,r).next(i=>{const o=r-i.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,n,s.largestBatchId,r-i.size):D.resolve(Gt());let a=-1,c=i;return o.next(l=>D.forEach(l,(u,h)=>(a<h.largestBatchId&&(a=h.largestBatchId),i.get(u)?D.resolve():this.remoteDocumentCache.getEntry(e,u).next(d=>{c=c.insert(u,d)}))).next(()=>this.populateOverlays(e,l,i)).next(()=>this.computeViews(e,c,l,Z())).next(u=>({batchId:a,changes:Rf(u)})))})}getDocumentsMatchingDocumentQuery(e,n){return this.getDocument(e,new j(n)).next(s=>{let r=Zn();return s.isFoundDocument()&&(r=r.insert(s.key,s)),r})}getDocumentsMatchingCollectionGroupQuery(e,n,s){const r=n.collectionGroup;let i=Zn();return this.indexManager.getCollectionParents(e,r).next(o=>D.forEach(o,a=>{const c=function(l,u){return new Ys(u,null,l.explicitOrderBy.slice(),l.filters.slice(),l.limit,l.limitType,l.startAt,l.endAt)}(n,a.child(r));return this.getDocumentsMatchingCollectionQuery(e,c,s).next(l=>{l.forEach((u,h)=>{i=i.insert(u,h)})})}).next(()=>i))}getDocumentsMatchingCollectionQuery(e,n,s){let r;return this.documentOverlayCache.getOverlaysForCollection(e,n.path,s.largestBatchId).next(i=>(r=i,this.remoteDocumentCache.getDocumentsMatchingQuery(e,n,s,r))).next(i=>{r.forEach((a,c)=>{const l=c.getKey();i.get(l)===null&&(i=i.insert(l,$e.newInvalidDocument(l)))});let o=Zn();return i.forEach((a,c)=>{const l=r.get(a);l!==void 0&&as(l.mutation,c,Je.empty(),Ie.now()),ki(n,c)&&(o=o.insert(a,c))}),o})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Db{constructor(){this.overlays=new ke(j.comparator),this.ss=new Map}getOverlay(e,n){return D.resolve(this.overlays.get(n))}getOverlays(e,n){const s=Gt();return D.forEach(n,r=>this.getOverlay(e,r).next(i=>{i!==null&&s.set(r,i)})).next(()=>s)}saveOverlays(e,n,s){return s.forEach((r,i)=>{this.ce(e,n,i)}),D.resolve()}removeOverlaysForBatchId(e,n,s){const r=this.ss.get(s);return r!==void 0&&(r.forEach(i=>this.overlays=this.overlays.remove(i)),this.ss.delete(s)),D.resolve()}getOverlaysForCollection(e,n,s){const r=Gt(),i=n.length+1,o=new j(n.child("")),a=this.overlays.getIteratorFrom(o);for(;a.hasNext();){const c=a.getNext().value,l=c.getKey();if(!n.isPrefixOf(l.path))break;l.path.length===i&&c.largestBatchId>s&&r.set(c.getKey(),c)}return D.resolve(r)}getOverlaysForCollectionGroup(e,n,s,r){let i=new ke((l,u)=>l-u);const o=this.overlays.getIterator();for(;o.hasNext();){const l=o.getNext().value;if(l.getKey().getCollectionGroup()===n&&l.largestBatchId>s){let u=i.get(l.largestBatchId);u===null&&(u=Gt(),i=i.insert(l.largestBatchId,u)),u.set(l.getKey(),l)}}const a=Gt(),c=i.getIterator();for(;c.hasNext()&&(c.getNext().value.forEach((l,u)=>a.set(l,u)),!(a.size()>=r)););return D.resolve(a)}ce(e,n,s){const r=this.overlays.get(s.key);if(r!==null){const o=this.ss.get(r.largestBatchId).delete(s.key);this.ss.set(r.largestBatchId,o)}this.overlays=this.overlays.insert(s.key,new wb(n,s));let i=this.ss.get(n);i===void 0&&(i=Z(),this.ss.set(n,i)),this.ss.set(n,i.add(s.key))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qa{constructor(){this.rs=new Te(Ae.os),this.us=new Te(Ae.cs)}isEmpty(){return this.rs.isEmpty()}addReference(e,n){const s=new Ae(e,n);this.rs=this.rs.add(s),this.us=this.us.add(s)}hs(e,n){e.forEach(s=>this.addReference(s,n))}removeReference(e,n){this.ls(new Ae(e,n))}fs(e,n){e.forEach(s=>this.removeReference(s,n))}ds(e){const n=new j(new ue([])),s=new Ae(n,e),r=new Ae(n,e+1),i=[];return this.us.forEachInRange([s,r],o=>{this.ls(o),i.push(o.key)}),i}_s(){this.rs.forEach(e=>this.ls(e))}ls(e){this.rs=this.rs.delete(e),this.us=this.us.delete(e)}ws(e){const n=new j(new ue([])),s=new Ae(n,e),r=new Ae(n,e+1);let i=Z();return this.us.forEachInRange([s,r],o=>{i=i.add(o.key)}),i}containsKey(e){const n=new Ae(e,0),s=this.rs.firstAfterOrEqual(n);return s!==null&&e.isEqual(s.key)}}class Ae{constructor(e,n){this.key=e,this.gs=n}static os(e,n){return j.comparator(e.key,n.key)||ie(e.gs,n.gs)}static cs(e,n){return ie(e.gs,n.gs)||j.comparator(e.key,n.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rb{constructor(e,n){this.indexManager=e,this.referenceDelegate=n,this.mutationQueue=[],this.ys=1,this.ps=new Te(Ae.os)}checkEmpty(e){return D.resolve(this.mutationQueue.length===0)}addMutationBatch(e,n,s,r){const i=this.ys;this.ys++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const o=new vb(i,n,s,r);this.mutationQueue.push(o);for(const a of r)this.ps=this.ps.add(new Ae(a.key,i)),this.indexManager.addToCollectionParentIndex(e,a.key.path.popLast());return D.resolve(o)}lookupMutationBatch(e,n){return D.resolve(this.Is(n))}getNextMutationBatchAfterBatchId(e,n){const s=n+1,r=this.Ts(s),i=r<0?0:r;return D.resolve(this.mutationQueue.length>i?this.mutationQueue[i]:null)}getHighestUnacknowledgedBatchId(){return D.resolve(this.mutationQueue.length===0?-1:this.ys-1)}getAllMutationBatches(e){return D.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,n){const s=new Ae(n,0),r=new Ae(n,Number.POSITIVE_INFINITY),i=[];return this.ps.forEachInRange([s,r],o=>{const a=this.Is(o.gs);i.push(a)}),D.resolve(i)}getAllMutationBatchesAffectingDocumentKeys(e,n){let s=new Te(ie);return n.forEach(r=>{const i=new Ae(r,0),o=new Ae(r,Number.POSITIVE_INFINITY);this.ps.forEachInRange([i,o],a=>{s=s.add(a.gs)})}),D.resolve(this.Es(s))}getAllMutationBatchesAffectingQuery(e,n){const s=n.path,r=s.length+1;let i=s;j.isDocumentKey(i)||(i=i.child(""));const o=new Ae(new j(i),0);let a=new Te(ie);return this.ps.forEachWhile(c=>{const l=c.key.path;return!!s.isPrefixOf(l)&&(l.length===r&&(a=a.add(c.gs)),!0)},o),D.resolve(this.Es(a))}Es(e){const n=[];return e.forEach(s=>{const r=this.Is(s);r!==null&&n.push(r)}),n}removeMutationBatch(e,n){le(this.As(n.batchId,"removed")===0),this.mutationQueue.shift();let s=this.ps;return D.forEach(n.mutations,r=>{const i=new Ae(r.key,n.batchId);return s=s.delete(i),this.referenceDelegate.markPotentiallyOrphaned(e,r.key)}).next(()=>{this.ps=s})}Pn(e){}containsKey(e,n){const s=new Ae(n,0),r=this.ps.firstAfterOrEqual(s);return D.resolve(n.isEqual(r&&r.key))}performConsistencyCheck(e){return this.mutationQueue.length,D.resolve()}As(e,n){return this.Ts(e)}Ts(e){return this.mutationQueue.length===0?0:e-this.mutationQueue[0].batchId}Is(e){const n=this.Ts(e);return n<0||n>=this.mutationQueue.length?null:this.mutationQueue[n]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ha{constructor(e,n,s,r){this.targetId=e,this.fromCache=n,this.Ci=s,this.xi=r}static Ni(e,n){let s=Z(),r=Z();for(const i of n.docChanges)switch(i.type){case 0:s=s.add(i.doc.key);break;case 1:r=r.add(i.doc.key)}return new Ha(e,n.fromCache,s,r)}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lb{constructor(){this.ki=!1}initialize(e,n){this.$i=e,this.indexManager=n,this.ki=!0}getDocumentsMatchingQuery(e,n,s,r){return this.Mi(e,n).next(i=>i||this.Oi(e,n,r,s)).next(i=>i||this.Fi(e,n))}Mi(e,n){if(wl(n))return D.resolve(null);let s=It(n);return this.indexManager.getIndexType(e,s).next(r=>r===0?null:(n.limit!==null&&r===1&&(n=xo(n,null,"F"),s=It(n)),this.indexManager.getDocumentsMatchingTarget(e,s).next(i=>{const o=Z(...i);return this.$i.getDocuments(e,o).next(a=>this.indexManager.getMinOffset(e,s).next(c=>{const l=this.Bi(n,a);return this.Li(n,l,o,c.readTime)?this.Mi(e,xo(n,null,"F")):this.qi(e,l,n,c)}))})))}Oi(e,n,s,r){return wl(n)||r.isEqual(Y.min())?this.Fi(e,n):this.$i.getDocuments(e,s).next(i=>{const o=this.Bi(n,i);return this.Li(n,o,s,r)?this.Fi(e,n):(ul()<=re.DEBUG&&V("QueryEngine","Re-using previous result from %s to execute query: %s",r.toString(),Vo(n)),this.qi(e,o,n,_0(r,-1)))})}Bi(e,n){let s=new Te(vf(e));return n.forEach((r,i)=>{ki(e,i)&&(s=s.add(i))}),s}Li(e,n,s,r){if(e.limit===null)return!1;if(s.size!==n.size)return!0;const i=e.limitType==="F"?n.last():n.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(r)>0)}Fi(e,n){return ul()<=re.DEBUG&&V("QueryEngine","Using full collection scan to execute query:",Vo(n)),this.$i.getDocumentsMatchingQuery(e,n,Pt.min())}qi(e,n,s,r){return this.$i.getDocumentsMatchingQuery(e,s,r).next(i=>(n.forEach(o=>{i=i.insert(o.key,o)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ub{constructor(e,n,s,r){this.persistence=e,this.Ui=n,this.Tt=r,this.Ki=new ke(ie),this.Gi=new zn(i=>La(i),Ua),this.Qi=new Map,this.ji=e.getRemoteDocumentCache(),this.Ns=e.getTargetCache(),this.$s=e.getBundleCache(),this.zi(s)}zi(e){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(e),this.indexManager=this.persistence.getIndexManager(e),this.mutationQueue=this.persistence.getMutationQueue(e,this.indexManager),this.localDocuments=new Ab(this.ji,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.ji.setIndexManager(this.indexManager),this.Ui.initialize(this.localDocuments,this.indexManager)}collectGarbage(e){return this.persistence.runTransaction("Collect garbage","readwrite-primary",n=>e.collect(n,this.Ki))}}function Fb(t,e,n,s){return new Ub(t,e,n,s)}async function Bf(t,e){const n=X(t);return await n.persistence.runTransaction("Handle user change","readonly",s=>{let r;return n.mutationQueue.getAllMutationBatches(s).next(i=>(r=i,n.zi(e),n.mutationQueue.getAllMutationBatches(s))).next(i=>{const o=[],a=[];let c=Z();for(const l of r){o.push(l.batchId);for(const u of l.mutations)c=c.add(u.key)}for(const l of i){a.push(l.batchId);for(const u of l.mutations)c=c.add(u.key)}return n.localDocuments.getDocuments(s,c).next(l=>({Wi:l,removedBatchIds:o,addedBatchIds:a}))})})}function xb(t,e){const n=X(t);return n.persistence.runTransaction("Acknowledge batch","readwrite-primary",s=>{const r=e.batch.keys(),i=n.ji.newChangeBuffer({trackRemovals:!0});return function(o,a,c,l){const u=c.batch,h=u.keys();let d=D.resolve();return h.forEach(p=>{d=d.next(()=>l.getEntry(a,p)).next(m=>{const g=c.docVersions.get(p);le(g!==null),m.version.compareTo(g)<0&&(u.applyToRemoteDocument(m,c),m.isValidDocument()&&(m.setReadTime(c.commitVersion),l.addEntry(m)))})}),d.next(()=>o.mutationQueue.removeMutationBatch(a,u))}(n,s,e,i).next(()=>i.apply(s)).next(()=>n.mutationQueue.performConsistencyCheck(s)).next(()=>n.documentOverlayCache.removeOverlaysForBatchId(s,r,e.batch.batchId)).next(()=>n.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(s,function(o){let a=Z();for(let c=0;c<o.mutationResults.length;++c)o.mutationResults[c].transformResults.length>0&&(a=a.add(o.batch.mutations[c].key));return a}(e))).next(()=>n.localDocuments.getDocuments(s,r))})}function jf(t){const e=X(t);return e.persistence.runTransaction("Get last remote snapshot version","readonly",n=>e.Ns.getLastRemoteSnapshotVersion(n))}function Vb(t,e){const n=X(t),s=e.snapshotVersion;let r=n.Ki;return n.persistence.runTransaction("Apply remote event","readwrite-primary",i=>{const o=n.ji.newChangeBuffer({trackRemovals:!0});r=n.Ki;const a=[];e.targetChanges.forEach((u,h)=>{const d=r.get(h);if(!d)return;a.push(n.Ns.removeMatchingKeys(i,u.removedDocuments,h).next(()=>n.Ns.addMatchingKeys(i,u.addedDocuments,h)));let p=d.withSequenceNumber(i.currentSequenceNumber);e.targetMismatches.has(h)?p=p.withResumeToken(Be.EMPTY_BYTE_STRING,Y.min()).withLastLimboFreeSnapshotVersion(Y.min()):u.resumeToken.approximateByteSize()>0&&(p=p.withResumeToken(u.resumeToken,s)),r=r.insert(h,p),function(m,g,y){return m.resumeToken.approximateByteSize()===0||g.snapshotVersion.toMicroseconds()-m.snapshotVersion.toMicroseconds()>=3e8?!0:y.addedDocuments.size+y.modifiedDocuments.size+y.removedDocuments.size>0}(d,p,u)&&a.push(n.Ns.updateTargetData(i,p))});let c=Tt(),l=Z();if(e.documentUpdates.forEach(u=>{e.resolvedLimboDocuments.has(u)&&a.push(n.persistence.referenceDelegate.updateLimboDocument(i,u))}),a.push(Bb(i,o,e.documentUpdates).next(u=>{c=u.Hi,l=u.Ji})),!s.isEqual(Y.min())){const u=n.Ns.getLastRemoteSnapshotVersion(i).next(h=>n.Ns.setTargetsMetadata(i,i.currentSequenceNumber,s));a.push(u)}return D.waitFor(a).next(()=>o.apply(i)).next(()=>n.localDocuments.getLocalViewOfDocuments(i,c,l)).next(()=>c)}).then(i=>(n.Ki=r,i))}function Bb(t,e,n){let s=Z(),r=Z();return n.forEach(i=>s=s.add(i)),e.getEntries(t,s).next(i=>{let o=Tt();return n.forEach((a,c)=>{const l=i.get(a);c.isFoundDocument()!==l.isFoundDocument()&&(r=r.add(a)),c.isNoDocument()&&c.version.isEqual(Y.min())?(e.removeEntry(a,c.readTime),o=o.insert(a,c)):!l.isValidDocument()||c.version.compareTo(l.version)>0||c.version.compareTo(l.version)===0&&l.hasPendingWrites?(e.addEntry(c),o=o.insert(a,c)):V("LocalStore","Ignoring outdated watch update for ",a,". Current version:",l.version," Watch version:",c.version)}),{Hi:o,Ji:r}})}function jb(t,e){const n=X(t);return n.persistence.runTransaction("Get next mutation batch","readonly",s=>(e===void 0&&(e=-1),n.mutationQueue.getNextMutationBatchAfterBatchId(s,e)))}function qb(t,e){const n=X(t);return n.persistence.runTransaction("Allocate target","readwrite",s=>{let r;return n.Ns.getTargetData(s,e).next(i=>i?(r=i,D.resolve(r)):n.Ns.allocateTargetId(s).next(o=>(r=new Xt(e,o,0,s.currentSequenceNumber),n.Ns.addTargetData(s,r).next(()=>r))))}).then(s=>{const r=n.Ki.get(s.targetId);return(r===null||s.snapshotVersion.compareTo(r.snapshotVersion)>0)&&(n.Ki=n.Ki.insert(s.targetId,s),n.Gi.set(e,s.targetId)),s})}async function zo(t,e,n){const s=X(t),r=s.Ki.get(e),i=n?"readwrite":"readwrite-primary";try{n||await s.persistence.runTransaction("Release target",i,o=>s.persistence.referenceDelegate.removeTarget(o,r))}catch(o){if(!Qs(o))throw o;V("LocalStore",`Failed to update sequence numbers for target ${e}: ${o}`)}s.Ki=s.Ki.remove(e),s.Gi.delete(r.target)}function Dl(t,e,n){const s=X(t);let r=Y.min(),i=Z();return s.persistence.runTransaction("Execute query","readonly",o=>function(a,c,l){const u=X(a),h=u.Gi.get(l);return h!==void 0?D.resolve(u.Ki.get(h)):u.Ns.getTargetData(c,l)}(s,o,It(e)).next(a=>{if(a)return r=a.lastLimboFreeSnapshotVersion,s.Ns.getMatchingKeysForTargetId(o,a.targetId).next(c=>{i=c})}).next(()=>s.Ui.getDocumentsMatchingQuery(o,e,n?r:Y.min(),n?i:Z())).next(a=>(zb(s,x0(e),a),{documents:a,Yi:i})))}function zb(t,e,n){let s=t.Qi.get(e)||Y.min();n.forEach((r,i)=>{i.readTime.compareTo(s)>0&&(s=i.readTime)}),t.Qi.set(e,s)}class Rl{constructor(){this.activeTargetIds=Of()}sr(e){this.activeTargetIds=this.activeTargetIds.add(e)}ir(e){this.activeTargetIds=this.activeTargetIds.delete(e)}nr(){const e={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(e)}}class Hb{constructor(){this.Ur=new Rl,this.Kr={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(e){}updateMutationState(e,n,s){}addLocalQueryTarget(e){return this.Ur.sr(e),this.Kr[e]||"not-current"}updateQueryState(e,n,s){this.Kr[e]=n}removeLocalQueryTarget(e){this.Ur.ir(e)}isLocalQueryTarget(e){return this.Ur.activeTargetIds.has(e)}clearQueryState(e){delete this.Kr[e]}getAllActiveQueryTargets(){return this.Ur.activeTargetIds}isActiveQueryTarget(e){return this.Ur.activeTargetIds.has(e)}start(){return this.Ur=new Rl,Promise.resolve()}handleUserChange(e,n,s){}setOnlineState(e){}shutdown(){}writeSequenceNumber(e){}notifyBundleLoaded(e){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oe="WebChannelConnection";class Qb extends class{constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const n=e.ssl?"https":"http";this.co=n+"://"+e.host,this.ao="projects/"+this.databaseId.projectId+"/databases/"+this.databaseId.database+"/documents"}get ho(){return!1}lo(e,n,s,r,i){const o=oo(),a=this.fo(e,n);V("RestConnection",`Sending RPC '${e}' ${o}:`,a,s);const c={};return this._o(c,r,i),this.wo(e,a,c,s).then(l=>(V("RestConnection",`Received RPC '${e}' ${o}: `,l),l),l=>{throw Po("RestConnection",`RPC '${e}' ${o} failed with error: `,l,"url: ",a,"request:",s),l})}mo(e,n,s,r,i,o){return this.lo(e,n,s,r,i)}_o(e,n,s){e["X-Goog-Api-Client"]="gl-js/ fire/"+jn,e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),n&&n.headers.forEach((r,i)=>e[i]=r),s&&s.headers.forEach((r,i)=>e[i]=r)}fo(e,n){const s=Gb[e];return`${this.co}/v1/${n}:${s}`}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams}wo(e,n,s,r){const i=oo();return new Promise((o,a)=>{const c=new c0;c.setWithCredentials(!0),c.listenOnce(i0.COMPLETE,()=>{try{switch(c.getLastErrorCode()){case ro.NO_ERROR:const u=c.getResponseJson();V(Oe,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(u)),o(u);break;case ro.TIMEOUT:V(Oe,`RPC '${e}' ${i} timed out`),a(new M(k.DEADLINE_EXCEEDED,"Request time out"));break;case ro.HTTP_ERROR:const h=c.getStatus();if(V(Oe,`RPC '${e}' ${i} failed with status:`,h,"response text:",c.getResponseText()),h>0){let d=c.getResponseJson();Array.isArray(d)&&(d=d[0]);const p=d==null?void 0:d.error;if(p&&p.status&&p.message){const m=function(g){const y=g.toLowerCase().replace(/_/g,"-");return Object.values(k).indexOf(y)>=0?y:k.UNKNOWN}(p.status);a(new M(m,p.message))}else a(new M(k.UNKNOWN,"Server responded with status "+c.getStatus()))}else a(new M(k.UNAVAILABLE,"Connection failed."));break;default:z()}}finally{V(Oe,`RPC '${e}' ${i} completed.`)}});const l=JSON.stringify(r);V(Oe,`RPC '${e}' ${i} sending request:`,r),c.send(n,"POST",l,s,15)})}yo(e,n,s){const r=oo(),i=[this.co,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=s0(),a=r0(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling};this.useFetchStreams&&(c.xmlHttpFactory=new a0({})),this._o(c.initMessageHeaders,n,s),c.encodeInitMessageHeaders=!0;const l=i.join("");V(Oe,`Creating RPC '${e}' stream ${r}: ${l}`,c);const u=o.createWebChannel(l,c);let h=!1,d=!1;const p=new Wb({Yr:g=>{d?V(Oe,`Not sending because RPC '${e}' stream ${r} is closed:`,g):(h||(V(Oe,`Opening RPC '${e}' stream ${r} transport.`),u.open(),h=!0),V(Oe,`RPC '${e}' stream ${r} sending:`,g),u.send(g))},Zr:()=>u.close()}),m=(g,y,_)=>{g.listen(y,I=>{try{_(I)}catch(E){setTimeout(()=>{throw E},0)}})};return m(u,ur.EventType.OPEN,()=>{d||V(Oe,`RPC '${e}' stream ${r} transport opened.`)}),m(u,ur.EventType.CLOSE,()=>{d||(d=!0,V(Oe,`RPC '${e}' stream ${r} transport closed`),p.oo())}),m(u,ur.EventType.ERROR,g=>{d||(d=!0,Po(Oe,`RPC '${e}' stream ${r} transport errored:`,g),p.oo(new M(k.UNAVAILABLE,"The operation could not be completed")))}),m(u,ur.EventType.MESSAGE,g=>{var y;if(!d){const _=g.data[0];le(!!_);const I=_,E=I.error||((y=I[0])===null||y===void 0?void 0:y.error);if(E){V(Oe,`RPC '${e}' stream ${r} received error:`,E);const N=E.status;let O=function(Q){const $=ve[Q];if($!==void 0)return Cf($)}(N),R=E.message;O===void 0&&(O=k.INTERNAL,R="Unknown error status: "+N+" with message "+E.message),d=!0,p.oo(new M(O,R)),u.close()}else V(Oe,`RPC '${e}' stream ${r} received:`,_),p.uo(_)}}),m(a,o0.STAT_EVENT,g=>{g.stat===cl.PROXY?V(Oe,`RPC '${e}' stream ${r} detected buffering proxy`):g.stat===cl.NOPROXY&&V(Oe,`RPC '${e}' stream ${r} detected no buffering proxy`)}),setTimeout(()=>{p.ro()},0),p}}function ao(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jb extends class{}{constructor(e,n,s,r){super(),this.authCredentials=e,this.appCheckCredentials=n,this.connection=s,this.Tt=r,this.iu=!1}ru(){if(this.iu)throw new M(k.FAILED_PRECONDITION,"The client has already been terminated.")}lo(e,n,s){return this.ru(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([r,i])=>this.connection.lo(e,n,s,r,i)).catch(r=>{throw r.name==="FirebaseError"?(r.code===k.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),r):new M(k.UNKNOWN,r.toString())})}mo(e,n,s,r){return this.ru(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([i,o])=>this.connection.mo(e,n,s,i,o,r)).catch(i=>{throw i.name==="FirebaseError"?(i.code===k.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),i):new M(k.UNKNOWN,i.toString())})}terminate(){this.iu=!0}}class Zb{constructor(e,n){this.asyncQueue=e,this.onlineStateHandler=n,this.state="Unknown",this.ou=0,this.uu=null,this.cu=!0}au(){this.ou===0&&(this.hu("Unknown"),this.uu=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this.uu=null,this.lu("Backend didn't respond within 10 seconds."),this.hu("Offline"),Promise.resolve())))}fu(e){this.state==="Online"?this.hu("Unknown"):(this.ou++,this.ou>=1&&(this.du(),this.lu(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.hu("Offline")))}set(e){this.du(),this.ou=0,e==="Online"&&(this.cu=!1),this.hu(e)}hu(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}lu(e){const n=`Could not reach Cloud Firestore backend. ${e}
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this.cu?(bt(n),this.cu=!1):V("OnlineStateTracker",n)}du(){this.uu!==null&&(this.uu.cancel(),this.uu=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eI{constructor(e,n,s,r,i){this.localStore=e,this.datastore=n,this.asyncQueue=s,this.remoteSyncer={},this._u=[],this.wu=new Map,this.mu=new Set,this.gu=[],this.yu=i,this.yu.Gr(o=>{s.enqueueAndForget(async()=>{dn(this)&&(V("RemoteStore","Restarting streams for network reachability change."),await async function(a){const c=X(a);c.mu.add(4),await Zs(c),c.pu.set("Unknown"),c.mu.delete(4),await Ri(c)}(this))})}),this.pu=new Zb(s,r)}}async function Ri(t){if(dn(t))for(const e of t.gu)await e(!0)}async function Zs(t){for(const e of t.gu)await e(!1)}function Hf(t,e){const n=X(t);n.wu.has(e.targetId)||(n.wu.set(e.targetId,e),Wa(n)?Ga(n):Hn(n).Mo()&&Ka(n,e))}function Kf(t,e){const n=X(t),s=Hn(n);n.wu.delete(e),s.Mo()&&Gf(n,e),n.wu.size===0&&(s.Mo()?s.Bo():dn(n)&&n.pu.set("Unknown"))}function Ka(t,e){t.Iu.Ot(e.targetId),Hn(t).Jo(e)}function Gf(t,e){t.Iu.Ot(e),Hn(t).Yo(e)}function Ga(t){t.Iu=new tb({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),ie:e=>t.wu.get(e)||null}),Hn(t).start(),t.pu.au()}function Wa(t){return dn(t)&&!Hn(t).$o()&&t.wu.size>0}function dn(t){return X(t).mu.size===0}function Wf(t){t.Iu=void 0}async function tI(t){t.wu.forEach((e,n)=>{Ka(t,e)})}async function nI(t,e){Wf(t),Wa(t)?(t.pu.fu(e),Ga(t)):t.pu.set("Unknown")}async function sI(t,e,n){if(t.pu.set("Online"),e instanceof $f&&e.state===2&&e.cause)try{await async function(s,r){const i=r.cause;for(const o of r.targetIds)s.wu.has(o)&&(await s.remoteSyncer.rejectListen(o,i),s.wu.delete(o),s.Iu.removeTarget(o))}(t,e)}catch(s){V("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),s),await Wr(t,s)}else if(e instanceof Ir?t.Iu.Qt(e):e instanceof Pf?t.Iu.Zt(e):t.Iu.Wt(e),!n.isEqual(Y.min()))try{const s=await jf(t.localStore);n.compareTo(s)>=0&&await function(r,i){const o=r.Iu.ee(i);return o.targetChanges.forEach((a,c)=>{if(a.resumeToken.approximateByteSize()>0){const l=r.wu.get(c);l&&r.wu.set(c,l.withResumeToken(a.resumeToken,i))}}),o.targetMismatches.forEach(a=>{const c=r.wu.get(a);if(!c)return;r.wu.set(a,c.withResumeToken(Be.EMPTY_BYTE_STRING,c.snapshotVersion)),Gf(r,a);const l=new Xt(c.target,a,1,c.sequenceNumber);Ka(r,l)}),r.remoteSyncer.applyRemoteEvent(o)}(t,n)}catch(s){V("RemoteStore","Failed to raise snapshot:",s),await Wr(t,s)}}async function Wr(t,e,n){if(!Qs(e))throw e;t.mu.add(1),await Zs(t),t.pu.set("Offline"),n||(n=()=>jf(t.localStore)),t.asyncQueue.enqueueRetryable(async()=>{V("RemoteStore","Retrying IndexedDB access"),await n(),t.mu.delete(1),await Ri(t)})}function Qf(t,e){return e().catch(n=>Wr(t,n,e))}async function Ni(t){const e=X(t),n=Mt(e);let s=e._u.length>0?e._u[e._u.length-1].batchId:-1;for(;rI(e);)try{const r=await jb(e.localStore,s);if(r===null){e._u.length===0&&n.Bo();break}s=r.batchId,iI(e,r)}catch(r){await Wr(e,r)}Yf(e)&&Xf(e)}function rI(t){return dn(t)&&t._u.length<10}function iI(t,e){t._u.push(e);const n=Mt(t);n.Mo()&&n.Xo&&n.tu(e.mutations)}function Yf(t){return dn(t)&&!Mt(t).$o()&&t._u.length>0}function Xf(t){Mt(t).start()}async function oI(t){Mt(t).su()}async function aI(t){const e=Mt(t);for(const n of t._u)e.tu(n.mutations)}async function cI(t,e,n){const s=t._u.shift(),r=ja.from(s,e,n);await Qf(t,()=>t.remoteSyncer.applySuccessfulWrite(r)),await Ni(t)}async function lI(t,e){e&&Mt(t).Xo&&await async function(n,s){if(r=s.code,Y0(r)&&r!==k.ABORTED){const i=n._u.shift();Mt(n).Fo(),await Qf(n,()=>n.remoteSyncer.rejectFailedWrite(i.batchId,s)),await Ni(n)}var r}(t,e),Yf(t)&&Xf(t)}async function Ol(t,e){const n=X(t);n.asyncQueue.verifyOperationInProgress(),V("RemoteStore","RemoteStore received new credentials");const s=dn(n);n.mu.add(3),await Zs(n),s&&n.pu.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.mu.delete(3),await Ri(n)}async function uI(t,e){const n=X(t);e?(n.mu.delete(2),await Ri(n)):e||(n.mu.add(2),await Zs(n),n.pu.set("Unknown"))}function Hn(t){return t.Tu||(t.Tu=function(e,n,s){const r=X(e);return r.ru(),new Yb(n,r.connection,r.authCredentials,r.appCheckCredentials,r.Tt,s)}(t.datastore,t.asyncQueue,{Xr:tI.bind(null,t),no:nI.bind(null,t),Ho:sI.bind(null,t)}),t.gu.push(async e=>{e?(t.Tu.Fo(),Wa(t)?Ga(t):t.pu.set("Unknown")):(await t.Tu.stop(),Wf(t))})),t.Tu}function Mt(t){return t.Eu||(t.Eu=function(e,n,s){const r=X(e);return r.ru(),new Xb(n,r.connection,r.authCredentials,r.appCheckCredentials,r.Tt,s)}(t.datastore,t.asyncQueue,{Xr:oI.bind(null,t),no:lI.bind(null,t),nu:aI.bind(null,t),eu:cI.bind(null,t)}),t.gu.push(async e=>{e?(t.Eu.Fo(),await Ni(t)):(await t.Eu.stop(),t._u.length>0&&(V("RemoteStore",`Stopping write stream with ${t._u.length} pending writes`),t._u=[]))})),t.Eu}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jf{constructor(e){this.key=e}}class Zf{constructor(e){this.key=e}}class _I{constructor(e,n){this.query=e,this.Ku=n,this.Gu=null,this.hasCachedResults=!1,this.current=!1,this.Qu=Z(),this.mutatedKeys=Z(),this.ju=vf(e),this.zu=new Cn(this.ju)}get Wu(){return this.Ku}Hu(e,n){const s=n?n.Ju:new Pl,r=n?n.zu:this.zu;let i=n?n.mutatedKeys:this.mutatedKeys,o=r,a=!1;const c=this.query.limitType==="F"&&r.size===this.query.limit?r.last():null,l=this.query.limitType==="L"&&r.size===this.query.limit?r.first():null;if(e.inorderTraversal((u,h)=>{const d=r.get(u),p=ki(this.query,h)?h:null,m=!!d&&this.mutatedKeys.has(d.key),g=!!p&&(p.hasLocalMutations||this.mutatedKeys.has(p.key)&&p.hasCommittedMutations);let y=!1;d&&p?d.data.isEqual(p.data)?m!==g&&(s.track({type:3,doc:p}),y=!0):this.Yu(d,p)||(s.track({type:2,doc:p}),y=!0,(c&&this.ju(p,c)>0||l&&this.ju(p,l)<0)&&(a=!0)):!d&&p?(s.track({type:0,doc:p}),y=!0):d&&!p&&(s.track({type:1,doc:d}),y=!0,(c||l)&&(a=!0)),y&&(p?(o=o.add(p),i=g?i.add(u):i.delete(u)):(o=o.delete(u),i=i.delete(u)))}),this.query.limit!==null)for(;o.size>this.query.limit;){const u=this.query.limitType==="F"?o.last():o.first();o=o.delete(u.key),i=i.delete(u.key),s.track({type:1,doc:u})}return{zu:o,Ju:s,Li:a,mutatedKeys:i}}Yu(e,n){return e.hasLocalMutations&&n.hasCommittedMutations&&!n.hasLocalMutations}applyChanges(e,n,s){const r=this.zu;this.zu=e.zu,this.mutatedKeys=e.mutatedKeys;const i=e.Ju.Ru();i.sort((l,u)=>function(h,d){const p=m=>{switch(m){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return z()}};return p(h)-p(d)}(l.type,u.type)||this.ju(l.doc,u.doc)),this.Zu(s);const o=n?this.Xu():[],a=this.Qu.size===0&&this.current?1:0,c=a!==this.Gu;return this.Gu=a,i.length!==0||c?{snapshot:new Mn(this.query,e.zu,r,i,e.mutatedKeys,a===0,c,!1,!!s&&s.resumeToken.approximateByteSize()>0),tc:o}:{tc:o}}bu(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({zu:this.zu,Ju:new Pl,mutatedKeys:this.mutatedKeys,Li:!1},!1)):{tc:[]}}ec(e){return!this.Ku.has(e)&&!!this.zu.has(e)&&!this.zu.get(e).hasLocalMutations}Zu(e){e&&(e.addedDocuments.forEach(n=>this.Ku=this.Ku.add(n)),e.modifiedDocuments.forEach(n=>{}),e.removedDocuments.forEach(n=>this.Ku=this.Ku.delete(n)),this.current=e.current)}Xu(){if(!this.current)return[];const e=this.Qu;this.Qu=Z(),this.zu.forEach(s=>{this.ec(s.key)&&(this.Qu=this.Qu.add(s.key))});const n=[];return e.forEach(s=>{this.Qu.has(s)||n.push(new Zf(s))}),this.Qu.forEach(s=>{e.has(s)||n.push(new Jf(s))}),n}nc(e){this.Ku=e.Yi,this.Qu=Z();const n=this.Hu(e.documents);return this.applyChanges(n,!0)}sc(){return Mn.fromInitialDocuments(this.query,this.zu,this.mutatedKeys,this.Gu===0,this.hasCachedResults)}}class vI{constructor(e,n,s){this.query=e,this.targetId=n,this.view=s}}class wI{constructor(e){this.key=e,this.ic=!1}}class bI{constructor(e,n,s,r,i,o){this.localStore=e,this.remoteStore=n,this.eventManager=s,this.sharedClientState=r,this.currentUser=i,this.maxConcurrentLimboResolutions=o,this.rc={},this.oc=new zn(a=>_f(a),Ei),this.uc=new Map,this.cc=new Set,this.ac=new ke(j.comparator),this.hc=new Map,this.lc=new qa,this.fc={},this.dc=new Map,this._c=$n.Sn(),this.onlineState="Unknown",this.wc=void 0}get isPrimaryClient(){return this.wc===!0}}async function II(t,e){const n=OI(t);let s,r;const i=n.oc.get(e);if(i)s=i.targetId,n.sharedClientState.addLocalQueryTarget(s),r=i.view.sc();else{const o=await qb(n.localStore,It(e));n.isPrimaryClient&&Hf(n.remoteStore,o);const a=n.sharedClientState.addLocalQueryTarget(o.targetId);s=o.targetId,r=await TI(n,e,s,a==="current",o.resumeToken)}return r}async function TI(t,e,n,s,r){t.mc=(h,d,p)=>async function(m,g,y,_){let I=g.view.Hu(y);I.Li&&(I=await Dl(m.localStore,g.query,!1).then(({documents:O})=>g.view.Hu(O,I)));const E=_&&_.targetChanges.get(g.targetId),N=g.view.applyChanges(I,m.isPrimaryClient,E);return Ml(m,g.targetId,N.tc),N.snapshot}(t,h,d,p);const i=await Dl(t.localStore,e,!0),o=new _I(e,i.Yi),a=o.Hu(i.documents),c=Js.createSynthesizedTargetChangeForCurrentChange(n,s&&t.onlineState!=="Offline",r),l=o.applyChanges(a,t.isPrimaryClient,c);Ml(t,n,l.tc);const u=new vI(e,n,o);return t.oc.set(e,u),t.uc.has(n)?t.uc.get(n).push(e):t.uc.set(n,[e]),l.snapshot}async function EI(t,e){const n=X(t),s=n.oc.get(e),r=n.uc.get(s.targetId);if(r.length>1)return n.uc.set(s.targetId,r.filter(i=>!Ei(i,e))),void n.oc.delete(e);n.isPrimaryClient?(n.sharedClientState.removeLocalQueryTarget(s.targetId),n.sharedClientState.isActiveQueryTarget(s.targetId)||await zo(n.localStore,s.targetId,!1).then(()=>{n.sharedClientState.clearQueryState(s.targetId),Kf(n.remoteStore,s.targetId),Ho(n,s.targetId)}).catch(Ws)):(Ho(n,s.targetId),await zo(n.localStore,s.targetId,!0))}async function kI(t,e,n){const s=PI(t);try{const r=await function(i,o){const a=X(i),c=Ie.now(),l=o.reduce((d,p)=>d.add(p.key),Z());let u,h;return a.persistence.runTransaction("Locally write mutations","readwrite",d=>{let p=Tt(),m=Z();return a.ji.getEntries(d,l).next(g=>{p=g,p.forEach((y,_)=>{_.isValidDocument()||(m=m.add(y))})}).next(()=>a.localDocuments.getOverlayedDocuments(d,p)).next(g=>{u=g;const y=[];for(const _ of o){const I=G0(_,u.get(_.key).overlayedDocument);I!=null&&y.push(new hn(_.key,I,gf(I.value.mapValue),at.exists(!0)))}return a.mutationQueue.addMutationBatch(d,c,y,o)}).next(g=>{h=g;const y=g.applyToLocalDocumentSet(u,m);return a.documentOverlayCache.saveOverlays(d,g.batchId,y)})}).then(()=>({batchId:h.batchId,changes:Rf(u)}))}(s.localStore,e);s.sharedClientState.addPendingMutation(r.batchId),function(i,o,a){let c=i.fc[i.currentUser.toKey()];c||(c=new ke(ie)),c=c.insert(o,a),i.fc[i.currentUser.toKey()]=c}(s,r.batchId,n),await er(s,r.changes),await Ni(s.remoteStore)}catch(r){const i=Ya(r,"Failed to persist write");n.reject(i)}}async function ep(t,e){const n=X(t);try{const s=await Vb(n.localStore,e);e.targetChanges.forEach((r,i)=>{const o=n.hc.get(i);o&&(le(r.addedDocuments.size+r.modifiedDocuments.size+r.removedDocuments.size<=1),r.addedDocuments.size>0?o.ic=!0:r.modifiedDocuments.size>0?le(o.ic):r.removedDocuments.size>0&&(le(o.ic),o.ic=!1))}),await er(n,s,e)}catch(s){await Ws(s)}}function $l(t,e,n){const s=X(t);if(s.isPrimaryClient&&n===0||!s.isPrimaryClient&&n===1){const r=[];s.oc.forEach((i,o)=>{const a=o.view.bu(e);a.snapshot&&r.push(a.snapshot)}),function(i,o){const a=X(i);a.onlineState=o;let c=!1;a.queries.forEach((l,u)=>{for(const h of u.listeners)h.bu(o)&&(c=!0)}),c&&Xa(a)}(s.eventManager,e),r.length&&s.rc.Ho(r),s.onlineState=e,s.isPrimaryClient&&s.sharedClientState.setOnlineState(e)}}async function SI(t,e,n){const s=X(t);s.sharedClientState.updateQueryState(e,"rejected",n);const r=s.hc.get(e),i=r&&r.key;if(i){let o=new ke(j.comparator);o=o.insert(i,$e.newNoDocument(i,Y.min()));const a=Z().add(i),c=new Ci(Y.min(),new Map,new Te(ie),o,a);await ep(s,c),s.ac=s.ac.remove(i),s.hc.delete(e),Ja(s)}else await zo(s.localStore,e,!1).then(()=>Ho(s,e,n)).catch(Ws)}async function AI(t,e){const n=X(t),s=e.batch.batchId;try{const r=await xb(n.localStore,e);np(n,s,null),tp(n,s),n.sharedClientState.updateMutationState(s,"acknowledged"),await er(n,r)}catch(r){await Ws(r)}}async function CI(t,e,n){const s=X(t);try{const r=await function(i,o){const a=X(i);return a.persistence.runTransaction("Reject batch","readwrite-primary",c=>{let l;return a.mutationQueue.lookupMutationBatch(c,o).next(u=>(le(u!==null),l=u.keys(),a.mutationQueue.removeMutationBatch(c,u))).next(()=>a.mutationQueue.performConsistencyCheck(c)).next(()=>a.documentOverlayCache.removeOverlaysForBatchId(c,l,o)).next(()=>a.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(c,l)).next(()=>a.localDocuments.getDocuments(c,l))})}(s.localStore,e);np(s,e,n),tp(s,e),s.sharedClientState.updateMutationState(e,"rejected",n),await er(s,r)}catch(r){await Ws(r)}}function tp(t,e){(t.dc.get(e)||[]).forEach(n=>{n.resolve()}),t.dc.delete(e)}function np(t,e,n){const s=X(t);let r=s.fc[s.currentUser.toKey()];if(r){const i=r.get(e);i&&(n?i.reject(n):i.resolve(),r=r.remove(e)),s.fc[s.currentUser.toKey()]=r}}function Ho(t,e,n=null){t.sharedClientState.removeLocalQueryTarget(e);for(const s of t.uc.get(e))t.oc.delete(s),n&&t.rc.gc(s,n);t.uc.delete(e),t.isPrimaryClient&&t.lc.ds(e).forEach(s=>{t.lc.containsKey(s)||sp(t,s)})}function sp(t,e){t.cc.delete(e.path.canonicalString());const n=t.ac.get(e);n!==null&&(Kf(t.remoteStore,n),t.ac=t.ac.remove(e),t.hc.delete(n),Ja(t))}function Ml(t,e,n){for(const s of n)s instanceof Jf?(t.lc.addReference(s.key,e),DI(t,s)):s instanceof Zf?(V("SyncEngine","Document no longer in limbo: "+s.key),t.lc.removeReference(s.key,e),t.lc.containsKey(s.key)||sp(t,s.key)):z()}function DI(t,e){const n=e.key,s=n.path.canonicalString();t.ac.get(n)||t.cc.has(s)||(V("SyncEngine","New document in limbo: "+n),t.cc.add(s),Ja(t))}function Ja(t){for(;t.cc.size>0&&t.ac.size<t.maxConcurrentLimboResolutions;){const e=t.cc.values().next().value;t.cc.delete(e);const n=new j(ue.fromString(e)),s=t._c.next();t.hc.set(s,new wI(n)),t.ac=t.ac.insert(n,s),Hf(t.remoteStore,new Xt(It(Fa(n.path)),s,2,$a.at))}}async function er(t,e,n){const s=X(t),r=[],i=[],o=[];s.oc.isEmpty()||(s.oc.forEach((a,c)=>{o.push(s.mc(c,e,n).then(l=>{if((l||n)&&s.isPrimaryClient&&s.sharedClientState.updateQueryState(c.targetId,l!=null&&l.fromCache?"not-current":"current"),l){r.push(l);const u=Ha.Ni(c.targetId,l);i.push(u)}}))}),await Promise.all(o),s.rc.Ho(r),await async function(a,c){const l=X(a);try{await l.persistence.runTransaction("notifyLocalViewChanges","readwrite",u=>D.forEach(c,h=>D.forEach(h.Ci,d=>l.persistence.referenceDelegate.addReference(u,h.targetId,d)).next(()=>D.forEach(h.xi,d=>l.persistence.referenceDelegate.removeReference(u,h.targetId,d)))))}catch(u){if(!Qs(u))throw u;V("LocalStore","Failed to update sequence numbers: "+u)}for(const u of c){const h=u.targetId;if(!u.fromCache){const d=l.Ki.get(h),p=d.snapshotVersion,m=d.withLastLimboFreeSnapshotVersion(p);l.Ki=l.Ki.insert(h,m)}}}(s.localStore,i))}async function RI(t,e){const n=X(t);if(!n.currentUser.isEqual(e)){V("SyncEngine","User change. New user:",e.toKey());const s=await Bf(n.localStore,e);n.currentUser=e,function(r,i){r.dc.forEach(o=>{o.forEach(a=>{a.reject(new M(k.CANCELLED,i))})}),r.dc.clear()}(n,"'waitForPendingWrites' promise is rejected due to a user change."),n.sharedClientState.handleUserChange(e,s.removedBatchIds,s.addedBatchIds),await er(n,s.Wi)}}function NI(t,e){const n=X(t),s=n.hc.get(e);if(s&&s.ic)return Z().add(s.key);{let r=Z();const i=n.uc.get(e);if(!i)return r;for(const o of i){const a=n.oc.get(o);r=r.unionWith(a.view.Wu)}return r}}function OI(t){const e=X(t);return e.remoteStore.remoteSyncer.applyRemoteEvent=ep.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=NI.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=SI.bind(null,e),e.rc.Ho=gI.bind(null,e.eventManager),e.rc.gc=mI.bind(null,e.eventManager),e}function PI(t){const e=X(t);return e.remoteStore.remoteSyncer.applySuccessfulWrite=AI.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=CI.bind(null,e),e}class $I{constructor(){this.synchronizeTabs=!1}async initialize(e){this.Tt=Di(e.databaseInfo.databaseId),this.sharedClientState=this.Ic(e),this.persistence=this.Tc(e),await this.persistence.start(),this.localStore=this.Ec(e),this.gcScheduler=this.Ac(e,this.localStore),this.indexBackfillerScheduler=this.Rc(e,this.localStore)}Ac(e,n){return null}Rc(e,n){return null}Ec(e){return Fb(this.persistence,new Lb,e.initialUser,this.Tt)}Tc(e){return new $b(za.qs,this.Tt)}Ic(e){return new Hb}async terminate(){this.gcScheduler&&this.gcScheduler.stop(),await this.sharedClientState.shutdown(),await this.persistence.shutdown()}}class MI{async initialize(e,n){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(n),this.remoteStore=this.createRemoteStore(n),this.eventManager=this.createEventManager(n),this.syncEngine=this.createSyncEngine(n,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=s=>$l(this.syncEngine,s,1),this.remoteStore.remoteSyncer.handleCredentialChange=RI.bind(null,this.syncEngine),await uI(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return new dI}createDatastore(e){const n=Di(e.databaseInfo.databaseId),s=(r=e.databaseInfo,new Qb(r));var r;return function(i,o,a,c){return new Jb(i,o,a,c)}(e.authCredentials,e.appCheckCredentials,s,n)}createRemoteStore(e){return n=this.localStore,s=this.datastore,r=e.asyncQueue,i=a=>$l(this.syncEngine,a,0),o=Nl.C()?new Nl:new Kb,new eI(n,s,r,i,o);var n,s,r,i,o}createSyncEngine(e,n){return function(s,r,i,o,a,c,l){const u=new bI(s,r,i,o,a,c);return l&&(u.wc=!0),u}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,n)}terminate(){return async function(e){const n=X(e);V("RemoteStore","RemoteStore shutting down."),n.mu.add(5),await Zs(n),n.yu.shutdown(),n.pu.set("Unknown")}(this.remoteStore)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class LI{constructor(e){this.observer=e,this.muted=!1}next(e){this.observer.next&&this.vc(this.observer.next,e)}error(e){this.observer.error?this.vc(this.observer.error,e):bt("Uncaught Error in snapshot listener:",e.toString())}bc(){this.muted=!0}vc(e,n){this.muted||setTimeout(()=>{this.muted||e(n)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ip(t,e,n){if(!n)throw new M(k.INVALID_ARGUMENT,`Function ${t}() cannot be called with an empty ${e}.`)}function jI(t,e,n,s){if(e===!0&&s===!0)throw new M(k.INVALID_ARGUMENT,`${t} and ${n} cannot be used together.`)}function Fl(t){if(!j.isDocumentKey(t))throw new M(k.INVALID_ARGUMENT,`Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`)}function xl(t){if(j.isDocumentKey(t))throw new M(k.INVALID_ARGUMENT,`Invalid collection reference. Collection references must have an odd number of segments, but ${t} has ${t.length}.`)}function Oi(t){if(t===void 0)return"undefined";if(t===null)return"null";if(typeof t=="string")return t.length>20&&(t=`${t.substring(0,20)}...`),JSON.stringify(t);if(typeof t=="number"||typeof t=="boolean")return""+t;if(typeof t=="object"){if(t instanceof Array)return"an array";{const e=function(n){return n.constructor?n.constructor.name:null}(t);return e?`a custom ${e} object`:"an object"}}return typeof t=="function"?"a function":z()}function Jt(t,e){if("_delegate"in t&&(t=t._delegate),!(t instanceof e)){if(e.name===t.constructor.name)throw new M(k.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{const n=Oi(t);throw new M(k.INVALID_ARGUMENT,`Expected type '${e.name}', but it was: ${n}`)}}return t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qe{constructor(e,n,s){this.converter=n,this._key=s,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Ot(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new qe(this.firestore,e,this._key)}}class Kn{constructor(e,n,s){this.converter=n,this._query=s,this.type="query",this.firestore=e}withConverter(e){return new Kn(this.firestore,e,this._query)}}class Ot extends Kn{constructor(e,n,s){super(e,n,Fa(s)),this._path=s,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new qe(this.firestore,null,new j(e))}withConverter(e){return new Ot(this.firestore,e,this._path)}}function zI(t,e,...n){if(t=Ee(t),ip("collection","path",e),t instanceof Pi){const s=ue.fromString(e,...n);return xl(s),new Ot(t,null,s)}{if(!(t instanceof qe||t instanceof Ot))throw new M(k.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=t._path.child(ue.fromString(e,...n));return xl(s),new Ot(t.firestore,null,s)}}function pr(t,e,...n){if(t=Ee(t),arguments.length===1&&(e=rf.R()),ip("doc","path",e),t instanceof Pi){const s=ue.fromString(e,...n);return Fl(s),new qe(t,null,new j(s))}{if(!(t instanceof qe||t instanceof Ot))throw new M(k.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=t._path.child(ue.fromString(e,...n));return Fl(s),new qe(t.firestore,t instanceof Ot?t.converter:null,new j(s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class HI{constructor(){this.qc=Promise.resolve(),this.Uc=[],this.Kc=!1,this.Gc=[],this.Qc=null,this.jc=!1,this.zc=!1,this.Wc=[],this.ko=new qf(this,"async_queue_retry"),this.Hc=()=>{const n=ao();n&&V("AsyncQueue","Visibility state changed to "+n.visibilityState),this.ko.Vo()};const e=ao();e&&typeof e.addEventListener=="function"&&e.addEventListener("visibilitychange",this.Hc)}get isShuttingDown(){return this.Kc}enqueueAndForget(e){this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.Jc(),this.Yc(e)}enterRestrictedMode(e){if(!this.Kc){this.Kc=!0,this.zc=e||!1;const n=ao();n&&typeof n.removeEventListener=="function"&&n.removeEventListener("visibilitychange",this.Hc)}}enqueue(e){if(this.Jc(),this.Kc)return new Promise(()=>{});const n=new Yt;return this.Yc(()=>this.Kc&&this.zc?Promise.resolve():(e().then(n.resolve,n.reject),n.promise)).then(()=>n.promise)}enqueueRetryable(e){this.enqueueAndForget(()=>(this.Uc.push(e),this.Zc()))}async Zc(){if(this.Uc.length!==0){try{await this.Uc[0](),this.Uc.shift(),this.ko.reset()}catch(e){if(!Qs(e))throw e;V("AsyncQueue","Operation failed with retryable error: "+e)}this.Uc.length>0&&this.ko.vo(()=>this.Zc())}}Yc(e){const n=this.qc.then(()=>(this.jc=!0,e().catch(s=>{this.Qc=s,this.jc=!1;const r=function(i){let o=i.message||"";return i.stack&&(o=i.stack.includes(i.message)?i.stack:i.message+`
`+i.stack),o}(s);throw bt("INTERNAL UNHANDLED ERROR: ",r),s}).then(s=>(this.jc=!1,s))));return this.qc=n,n}enqueueAfterDelay(e,n,s){this.Jc(),this.Wc.indexOf(e)>-1&&(n=0);const r=Qa.createAndSchedule(this,e,n,s,i=>this.Xc(i));return this.Gc.push(r),r}Jc(){this.Qc&&z()}verifyOperationInProgress(){}async ta(){let e;do e=this.qc,await e;while(e!==this.qc)}ea(e){for(const n of this.Gc)if(n.timerId===e)return!0;return!1}na(e){return this.ta().then(()=>{this.Gc.sort((n,s)=>n.targetTimeMs-s.targetTimeMs);for(const n of this.Gc)if(n.skipDelay(),e!=="all"&&n.timerId===e)break;return this.ta()})}sa(e){this.Wc.push(e)}Xc(e){const n=this.Gc.indexOf(e);this.Gc.splice(n,1)}}function Bl(t){return function(e,n){if(typeof e!="object"||e===null)return!1;const s=e;for(const r of n)if(r in s&&typeof s[r]=="function")return!0;return!1}(t,["next","error","complete"])}class As extends Pi{constructor(e,n,s,r){super(e,n,s,r),this.type="firestore",this._queue=new HI,this._persistenceKey=(r==null?void 0:r.name)||"[DEFAULT]"}_terminate(){return this._firestoreClient||ap(this),this._firestoreClient.terminate()}}function KI(t,e){const n=typeof t=="object"?t:Xo(),s=typeof t=="string"?t:e||"(default)",r=ln(n,"firestore").getImmediate({identifier:s});if(!r._initialized){const i=gg("firestore");i&&qI(r,...i)}return r}function op(t){return t._firestoreClient||ap(t),t._firestoreClient.verifyNotTerminated(),t._firestoreClient}function ap(t){var e;const n=t._freezeSettings(),s=function(r,i,o,a){return new T0(r,i,o,a.host,a.ssl,a.experimentalForceLongPolling,a.experimentalAutoDetectLongPolling,a.useFetchStreams)}(t._databaseId,((e=t._app)===null||e===void 0?void 0:e.options.appId)||"",t._persistenceKey,n);t._firestoreClient=new UI(t._authCredentials,t._appCheckCredentials,t._queue,s)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ln{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Ln(Be.fromBase64String(e))}catch(n){throw new M(k.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+n)}}static fromUint8Array(e){return new Ln(Be.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Za{constructor(...e){for(let n=0;n<e.length;++n)if(e[n].length===0)throw new M(k.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Le(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ec{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new M(k.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new M(k.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return ie(this._lat,e._lat)||ie(this._long,e._long)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nT(t){if(t.limitType==="L"&&t.explicitOrderBy.length===0)throw new M(k.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class sc{}class sT extends sc{}function rT(t,e,...n){let s=[];e instanceof sc&&s.push(e),s=s.concat(n),function(r){const i=r.filter(a=>a instanceof ic).length,o=r.filter(a=>a instanceof rc).length;if(i>1||i>0&&o>0)throw new M(k.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(s);for(const r of s)t=r._apply(t);return t}class rc extends sT{constructor(e,n,s){super(),this._field=e,this._op=n,this._value=s,this.type="where"}static _create(e,n,s){return new rc(e,n,s)}_apply(e){const n=this._parse(e);return yp(e._query,n),new Kn(e.firestore,e.converter,Fo(e._query,n))}_parse(e){const n=up(e.firestore);return function(r,i,o,a,c,l,u){let h;if(c.isKeyField()){if(l==="array-contains"||l==="array-contains-any")throw new M(k.INVALID_ARGUMENT,`Invalid Query. You can't perform '${l}' queries on documentId().`);if(l==="in"||l==="not-in"){ql(u,l);const d=[];for(const p of u)d.push(jl(a,r,p));h={arrayValue:{values:d}}}else h=jl(a,r,u)}else l!=="in"&&l!=="not-in"&&l!=="array-contains-any"||ql(u,l),h=XI(o,i,u,l==="in"||l==="not-in");return be.create(c,l,h)}(e._query,"where",n,e.firestore._databaseId,this._field,this._op,this._value)}}class ic extends sc{constructor(e,n){super(),this.type=e,this._queryConstraints=n}static _create(e,n){return new ic(e,n)}_parse(e){const n=this._queryConstraints.map(s=>s._parse(e)).filter(s=>s.getFilters().length>0);return n.length===1?n[0]:et.create(n,this._getOperator())}_apply(e){const n=this._parse(e);return n.getFilters().length===0?e:(function(s,r){let i=s;const o=r.getFlattenedFilters();for(const a of o)yp(i,a),i=Fo(i,a)}(e._query,n),new Kn(e.firestore,e.converter,Fo(e._query,n)))}_getQueryConstraints(){return this._queryConstraints}_getOperator(){return this.type==="and"?"and":"or"}}function jl(t,e,n){if(typeof(n=Ee(n))=="string"){if(n==="")throw new M(k.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!yf(e)&&n.indexOf("/")!==-1)throw new M(k.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);const s=e.path.child(ue.fromString(n));if(!j.isDocumentKey(s))throw new M(k.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);return fl(t,new j(s))}if(n instanceof qe)return fl(t,n._key);throw new M(k.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${Oi(n)}.`)}function ql(t,e){if(!Array.isArray(t)||t.length===0)throw new M(k.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${e.toString()}' filters.`)}function yp(t,e){if(e.isInequality()){const s=xa(t),r=e.field;if(s!==null&&!s.isEqual(r))throw new M(k.INVALID_ARGUMENT,`Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${s.toString()}' and '${r.toString()}'`);const i=mf(t);i!==null&&iT(t,r,i)}const n=function(s,r){for(const i of s)for(const o of i.getFlattenedFilters())if(r.indexOf(o.op)>=0)return o.op;return null}(t.filters,function(s){switch(s){case"!=":return["!=","not-in"];case"array-contains-any":case"in":return["not-in"];case"not-in":return["array-contains-any","in","not-in","!="];default:return[]}}(e.op));if(n!==null)throw n===e.op?new M(k.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${e.op.toString()}' filter.`):new M(k.INVALID_ARGUMENT,`Invalid query. You cannot use '${e.op.toString()}' filters with '${n.toString()}' filters.`)}function iT(t,e,n){if(!n.isEqual(e))throw new M(k.INVALID_ARGUMENT,`Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '${e.toString()}' and so you must also use '${e.toString()}' as your first argument to orderBy(), but your first orderBy() is on field '${n.toString()}' instead.`)}class oT{convertValue(e,n="none"){switch(an(e)){case 0:return null;case 1:return e.booleanValue;case 2:return we(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,n);case 5:return e.stringValue;case 6:return this.convertBytes(Nn(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,n);case 10:return this.convertObject(e.mapValue,n);default:throw z()}}convertObject(e,n){const s={};return qn(e.fields,(r,i)=>{s[r]=this.convertValue(i,n)}),s}convertGeoPoint(e){return new ec(we(e.latitude),we(e.longitude))}convertArray(e,n){return(e.values||[]).map(s=>this.convertValue(s,n))}convertServerTimestamp(e,n){switch(n){case"previous":const s=cf(e);return s==null?null:this.convertValue(s,n);case"estimate":return this.convertTimestamp(Ts(e));default:return null}}convertTimestamp(e){const n=$t(e);return new Ie(n.seconds,n.nanos)}convertDocumentKey(e,n){const s=ue.fromString(e);le(Vf(s));const r=new Is(s.get(1),s.get(3)),i=new j(s.popFirst(5));return r.isEqual(n)||bt(`Document ${i} contains a document reference within a different database (${r.projectId}/${r.database}) which is not supported. It will be treated as a reference in the current database (${n.projectId}/${n.database}) instead.`),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class es{constructor(e,n){this.hasPendingWrites=e,this.fromCache=n}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class _p extends gp{constructor(e,n,s,r,i,o){super(e,n,s,r,o),this._firestore=e,this._firestoreImpl=e,this.metadata=i}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const n=new Tr(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(n,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,n={}){if(this._document){const s=this._document.data.field(mp("DocumentSnapshot.get",e));if(s!==null)return this._userDataWriter.convertValue(s,n.serverTimestamps)}}}class Tr extends _p{data(e={}){return super.data(e)}}class cT{constructor(e,n,s,r){this._firestore=e,this._userDataWriter=n,this._snapshot=r,this.metadata=new es(r.hasPendingWrites,r.fromCache),this.query=s}get docs(){const e=[];return this.forEach(n=>e.push(n)),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,n){this._snapshot.docs.forEach(s=>{e.call(n,new Tr(this._firestore,this._userDataWriter,s.key,s,new es(this._snapshot.mutatedKeys.has(s.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){const n=!!e.includeMetadataChanges;if(n&&this._snapshot.excludesMetadataChanges)throw new M(k.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===n||(this._cachedChanges=function(s,r){if(s._snapshot.oldDocs.isEmpty()){let i=0;return s._snapshot.docChanges.map(o=>{const a=new Tr(s._firestore,s._userDataWriter,o.doc.key,o.doc,new es(s._snapshot.mutatedKeys.has(o.doc.key),s._snapshot.fromCache),s.query.converter);return o.doc,{type:"added",doc:a,oldIndex:-1,newIndex:i++}})}{let i=s._snapshot.oldDocs;return s._snapshot.docChanges.filter(o=>r||o.type!==3).map(o=>{const a=new Tr(s._firestore,s._userDataWriter,o.doc.key,o.doc,new es(s._snapshot.mutatedKeys.has(o.doc.key),s._snapshot.fromCache),s.query.converter);let c=-1,l=-1;return o.type!==0&&(c=i.indexOf(o.doc.key),i=i.delete(o.doc.key)),o.type!==1&&(i=i.add(o.doc),l=i.indexOf(o.doc.key)),{type:lT(o.type),doc:a,oldIndex:c,newIndex:l}})}}(this,n),this._cachedChangesIncludeMetadataChanges=n),this._cachedChanges}}function lT(t){switch(t){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return z()}}class vp extends oT{constructor(e){super(),this.firestore=e}convertBytes(e){return new Ln(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new qe(this.firestore,null,n)}}function zl(t,e,n){t=Jt(t,qe);const s=Jt(t.firestore,As),r=aT(t.converter,e,n);return wp(s,[YI(up(s),"setDoc",t._key,r,t.converter!==null,n).toMutation(t._key,at.none())])}function uT(t){return wp(Jt(t.firestore,As),[new Va(t._key,at.none())])}function Hl(t,...e){var n,s,r;t=Ee(t);let i={includeMetadataChanges:!1},o=0;typeof e[o]!="object"||Bl(e[o])||(i=e[o],o++);const a={includeMetadataChanges:i.includeMetadataChanges};if(Bl(e[o])){const h=e[o];e[o]=(n=h.next)===null||n===void 0?void 0:n.bind(h),e[o+1]=(s=h.error)===null||s===void 0?void 0:s.bind(h),e[o+2]=(r=h.complete)===null||r===void 0?void 0:r.bind(h)}let c,l,u;if(t instanceof qe)l=Jt(t.firestore,As),u=Fa(t._key.path),c={next:h=>{e[o]&&e[o](hT(l,t,h))},error:e[o+1],complete:e[o+2]};else{const h=Jt(t,Kn);l=Jt(h.firestore,As),u=h._query;const d=new vp(l);c={next:p=>{e[o]&&e[o](new cT(l,d,h,p))},error:e[o+1],complete:e[o+2]},nT(t._query)}return function(h,d,p,m){const g=new LI(m),y=new yI(d,g,p);return h.asyncQueue.enqueueAndForget(async()=>fI(await Ll(h),y)),()=>{g.bc(),h.asyncQueue.enqueueAndForget(async()=>pI(await Ll(h),y))}}(op(l),u,a,c)}function wp(t,e){return function(n,s){const r=new Yt;return n.asyncQueue.enqueueAndForget(async()=>kI(await BI(n),s,r)),r.promise}(op(t),e)}function hT(t,e,n){const s=n.docs.get(e._key),r=new vp(t);return new _p(t,r,e._key,s,new es(n.hasPendingWrites,n.fromCache),e.converter)}(function(t,e=!0){(function(n){jn=n})(Os),lt(new Ze("firestore",(n,{instanceIdentifier:s,options:r})=>{const i=n.getProvider("app").getImmediate(),o=new As(new h0(n.getProvider("auth-internal")),new g0(n.getProvider("app-check-internal")),function(a,c){if(!Object.prototype.hasOwnProperty.apply(a.options,["projectId"]))throw new M(k.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Is(a.options.projectId,c)}(i,s),i);return r=Object.assign({useFetchStreams:e},r),o._setSettings(r),o},"PUBLIC").setMultipleInstances(!0)),Ge(ll,"3.9.0",t),Ge(ll,"3.9.0","esm2017")})();const dT={apiKey:"AIzaSyBHdepwE7M4Byu2lFtX2s__9COcMdvXu7Q",authDomain:"r34-react.firebaseapp.com",databaseURL:"https://r34-react.firebaseio.com",projectId:"r34-react",storageBucket:"r34-react.appspot.com",messagingSenderId:"844749417844",appId:"1:844749417844:web:3d1a590b58568e472dd021",measurementId:"G-H9MD9SS1LS"},bp=Xu(dT),Bt=B_(bp);ky(Bt,Ih);const Wn=KI(bp);tw();const fT=new ht,pT=()=>{const t={loggedIn:!1,user:null},{subscribe:e,set:n}=Rs(t);class s extends Error{constructor(i,o){super(o),this.code=i}}return vh(Bt,r=>{n(r?{loggedIn:!0,user:r}:t)}),{subscribe:e,async signUpWithEmail(r,i){if((i==null?void 0:i.length)<8)throw new s("auth/password-too-short");return Ty(Bt,r,i)},async signInWithEmail(r,i){return Ey(Bt,r,i)},async signInWithGoogle(){return Xy(Bt,fT)},async signOut(){return Cy(Bt)}}},Ip=pT(),Kl="/assets/default-user-a40c52dd.png";function gT(t){let e;return{c(){e=b("i"),f(e,"class","codicon codicon-account")},m(n,s){A(n,e,s)},p:C,d(n){n&&S(e)}}}function mT(t){let e,n;return{c(){e=b("img"),f(e,"class","profile-picture svelte-1m717b8"),Zt(e.src,n=t[0].user.photoURL??Kl)||f(e,"src",n),f(e,"alt","Account")},m(s,r){A(s,e,r)},p(s,r){r&1&&!Zt(e.src,n=s[0].user.photoURL??Kl)&&f(e,"src",n)},d(s){s&&S(e)}}}function yT(t){let e,n,s,r,i,o,a,c,l,u,h,d,p,m,g,y,_,I;o=new ag({});function E(R,Q){return R[0].loggedIn?mT:gT}let N=E(t),O=N(t);return{c(){e=b("header"),n=b("div"),s=b("a"),s.innerHTML='<i class="codicon codicon-heart"></i>',r=P(),i=b("a"),x(o.$$.fragment),a=P(),c=b("button"),c.innerHTML='<i class="codicon codicon-book"></i>',l=P(),u=b("nav"),h=b("button"),h.innerHTML='<i class="codicon codicon-search"></i>',d=P(),p=b("button"),p.innerHTML='<i class="codicon codicon-settings-gear"></i>',m=P(),g=b("button"),O.c(),f(s,"title","Sponsor"),f(s,"href","https://ko-fi.com/kurozenzen"),f(s,"target","_newtab"),f(s,"class","svelte-1m717b8"),f(i,"title","Discord Server"),f(i,"href","https://discord.gg/yyJFG5PVBZ"),f(i,"target","_newtab"),f(i,"class","svelte-1m717b8"),f(c,"title","Documentation"),f(c,"class","svelte-1m717b8"),f(n,"class","svelte-1m717b8"),f(h,"title","Search"),f(h,"class","svelte-1m717b8"),f(p,"title","Settings"),f(p,"id","settings-gear"),f(p,"class","svelte-1m717b8"),f(g,"title","Account"),f(g,"class","svelte-1m717b8"),f(u,"class","svelte-1m717b8"),f(e,"role","navigation"),f(e,"class","svelte-1m717b8")},m(R,Q){A(R,e,Q),v(e,n),v(n,s),v(n,r),v(n,i),L(o,i,null),v(n,a),v(n,c),v(e,l),v(e,u),v(u,h),v(u,d),v(u,p),v(u,m),v(u,g),O.m(g,null),y=!0,_||(I=[B(c,"click",t[1]),B(h,"click",t[2]),B(p,"click",t[3]),B(g,"click",t[4])],_=!0)},p(R,[Q]){N===(N=E(R))&&O?O.p(R,Q):(O.d(1),O=N(R),O&&(O.c(),O.m(g,null)))},i(R){y||(w(o.$$.fragment,R),y=!0)},o(R){T(o.$$.fragment,R),y=!1},d(R){R&&S(e),U(o),O.d(),_=!1,_e(I)}}}function _T(t,e,n){let s;return Me(t,Ip,c=>n(0,s=c)),[s,()=>In.navigateTo("help"),()=>In.navigateTo("search"),()=>In.navigateTo("settings"),()=>In.navigateTo("account")]}class vT extends W{constructor(e){super(),G(this,e,_T,yT,K,{})}}const wT="modulepreload",bT=function(t){return"/"+t},Gl={},$i=function(e,n,s){if(!n||n.length===0)return e();const r=document.getElementsByTagName("link");return Promise.all(n.map(i=>{if(i=bT(i),i in Gl)return;Gl[i]=!0;const o=i.endsWith(".css"),a=o?'[rel="stylesheet"]':"";if(!!s)for(let u=r.length-1;u>=0;u--){const h=r[u];if(h.href===i&&(!o||h.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${i}"]${a}`))return;const l=document.createElement("link");if(l.rel=o?"stylesheet":wT,o||(l.as="script",l.crossOrigin=""),l.href=i,document.head.appendChild(l),o)return new Promise((u,h)=>{l.addEventListener("load",u),l.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${i}`)))})})).then(()=>e())},Er=Object.freeze(["+","-","~"]),Mi=t=>Er.includes(t),IT=t=>{if(!Mi(t))throw new TypeError("Invalid modifier passed to getNextModifier");const n=(Er.indexOf(t)+1)%Er.length;return Er[n]},TT=Object.freeze({"+":"","-":"-","~":""}),ET=t=>{if(!Mi(t))throw TypeError("Invalid modifier passed to serializeModifier");return TT[t]},tr=t=>typeof t=="string"&&t!=="",Li=t=>typeof t=="number";class Ui{constructor(e,n){if(!Mi(e))throw TypeError("Invalid modifier passed to SearchableTag constructor");if(!tr(n))throw TypeError("Invalid name passed to SearchableTag constructor");this.modifier=e,this.name=n,Object.freeze(this)}serialize(){return`${ET(this.modifier)}${encodeURIComponent(this.name.replaceAll(" ","_"))}`}}const Tp=Object.freeze(["artist","character","copyright","source","metadata","rating","tag","general","ambiguous","supertag"]),Ep=t=>Tp.includes(t),Wl=t=>{const e=Tp.indexOf(t);return e>=0?e:99},kT=Object.freeze(["artist","character","copyright","source","metadata","rating"]),ST=t=>kT.includes(t);let Fi=class{constructor(e,n,s,r){if(!Mi(e))throw TypeError("Invalid modifier passed to ActiveTag constructor");if(!tr(n))throw TypeError("Invalid name passed to ActiveTag constructor");if(!Li(s))throw TypeError("Invalid count passed to ActiveTag constructor");if(!Ep(r))throw TypeError("Invalid type passed to ActiveTag constructor");this.modifier=e,this.name=n,this.count=s,this.type=r,Object.freeze(this)}};const kp=t=>new Ui(t.modifier,t.name);class Sp{constructor(e,n,s){if(!tr(e))throw new TypeError("Invalid name passed to Supertag");if(!AT(s))throw new TypeError("Invalid description passed to Supertag");this.name=e,this.description=n,this.tags=Object.freeze([...s]),Object.freeze(this)}}const AT=t=>Array.isArray(t)&&t.every(e=>e instanceof Ui),CT=()=>{const t={preferences:{},supertags:[]},{subscribe:e,update:n}=Rs(t);let s,r=null,i=null;return vh(Bt,async o=>{s=o,o?r=Hl(pr(Wn,"users",o.uid),async a=>{const c=a.data();n(c===void 0?u=>(u.preferences={},u):u=>(u.preferences=c.preferences,u));const l=rT(zI(Wn,`users/${o.uid}/supertags`));i==null||i(),i=Hl(l,u=>{const h=[];u.forEach(d=>{const p=d.data();h.push(new Sp(d.id,p.description,Object.entries(p.tags).map(m=>new Ui(m[1],m[0]))))}),n(d=>(d.supertags=h,d))})}):(r==null||r(),i==null||i(),r=null,i=null)}),{subscribe:e,async addSupertag(o){if(!s)throw new Error("No user");return zl(pr(Wn,`users/${s.uid}/supertags`,o.name),{description:o.description,tags:Object.fromEntries(o.tags.map(a=>[a.name,a.modifier]))})},async deleteSupertag(o){if(!s)throw new Error("No user");return uT(pr(Wn,`users/${s.uid}/supertags`,o.name))},async setTheme(o){if(s)return zl(pr(Wn,"users",s.uid),{preferences:{theme:o}},{merge:!0})}}},Cs=CT();function DT(t){let e,n,s,r;return{c(){e=b("button"),n=oe(t[0]),f(e,"title",t[1]),e.disabled=t[2],f(e,"class","svelte-1nifcn1")},m(i,o){A(i,e,o),v(e,n),s||(r=B(e,"click",t[4]),s=!0)},p(i,[o]){o&1&&ge(n,i[0]),o&2&&f(e,"title",i[1]),o&4&&(e.disabled=i[2])},i:C,o:C,d(i){i&&S(e),s=!1,r()}}}function RT(t,e,n){let{text:s}=e,{title:r}=e,{disabled:i=!1}=e;const o=Xe(),a=()=>o("click");return t.$$set=c=>{"text"in c&&n(0,s=c.text),"title"in c&&n(1,r=c.title),"disabled"in c&&n(2,i=c.disabled)},[s,r,i,o,a]}class oc extends W{constructor(e){super(),G(this,e,RT,DT,K,{text:0,title:1,disabled:2})}}const kt=t=>e=>{(ac(e)||NT(e))&&(e.preventDefault(),e.stopPropagation(),t(e))},NT=t=>t.code==="Space",ac=t=>t.code==="Enter"||t.key==="Enter",OT=Intl.NumberFormat("en",{notation:"compact"}),Et=t=>{if(!Li(t))throw new TypeError(`Invalid value passed to formatCount: ${t}`);return OT.format(t)};function Un(t){return t.replace(/_/g," ").replace(/source:/g,"").replace(/rating:/g,"")}const PT=Object.freeze({"+":"codicon codicon-plus","-":"codicon codicon-circle-slash","~":"codicon codicon-record"}),Ql=Object.freeze({"+":"include","-":"exclude","~":"optional"});function Yl(t){let e,n=Et(t[0].count)+"",s,r;return{c(){e=oe("("),s=oe(n),r=oe(")")},m(i,o){A(i,e,o),A(i,s,o),A(i,r,o)},p(i,o){o&1&&n!==(n=Et(i[0].count)+"")&&ge(s,n)},d(i){i&&S(e),i&&S(s),i&&S(r)}}}function $T(t){let e,n=Un(t[0].name)+"",s,r,i,o,a,c=t[0].count&&Yl(t);return{c(){e=b("li"),s=oe(n),r=P(),c&&c.c(),f(e,"class",i=Qe(Ql[t[0].modifier])+" svelte-13vl0re"),f(e,"tabindex","0"),f(e,"role","button"),f(e,"title","Click to remove tag"),ce(e,"no-icon",t[0].type!=="supertag")},m(l,u){A(l,e,u),v(e,s),v(e,r),c&&c.m(e,null),o||(a=[B(e,"click",t[2]),B(e,"contextmenu",Fu(t[3]))],o=!0)},p(l,[u]){u&1&&n!==(n=Un(l[0].name)+"")&&ge(s,n),l[0].count?c?c.p(l,u):(c=Yl(l),c.c(),c.m(e,null)):c&&(c.d(1),c=null),u&1&&i!==(i=Qe(Ql[l[0].modifier])+" svelte-13vl0re")&&f(e,"class",i),u&1&&ce(e,"no-icon",l[0].type!=="supertag")},i:C,o:C,d(l){l&&S(e),c&&c.d(),o=!1,_e(a)}}}function MT(t,e,n){let{tag:s}=e;const r=Xe(),i=()=>r("click"),o=()=>r("contextmenu");return t.$$set=a=>{"tag"in a&&n(0,s=a.tag)},[s,r,i,o]}class Ap extends W{constructor(e){super(),G(this,e,MT,$T,K,{tag:0})}}function LT(t){let e,n,s,r,i;const o=t[2].default,a=Pu(o,t,t[1],null);return{c(){e=b("div"),n=b("div"),a&&a.c(),f(n,"class","dialog svelte-upm3o"),f(e,"class","backdrop svelte-upm3o")},m(c,l){A(c,e,l),v(e,n),a&&a.m(n,null),s=!0,r||(i=[B(n,"click",Ko(UT)),B(e,"click",t[0]),B(e,"keyup",t[3])],r=!0)},p(c,[l]){a&&a.p&&(!s||l&2)&&Lu(a,o,c,c[1],s?Mu(o,c[1],l,null):Uu(c[1]),null)},i(c){s||(w(a,c),s=!0)},o(c){T(a,c),s=!1},d(c){c&&S(e),a&&a.d(c),r=!1,_e(i)}}}const UT=()=>{};function FT(t,e,n){let{$$slots:s={},$$scope:r}=e;const i=Xe(),o=()=>i("close"),a=c=>{c.code==="Escape"&&o()};return t.$$set=c=>{"$$scope"in c&&n(1,r=c.$$scope)},[o,r,s,a]}class Cp extends W{constructor(e){super(),G(this,e,FT,LT,K,{})}}function Xl(t,e,n){const s=t.slice();return s[9]=e[n],s}function Jl(t){let e,n;return e=new Ap({props:{tag:t[9]}}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p(s,r){const i={};r&4&&(i.tag=s[9]),e.$set(i)},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function xT(t){let e,n,s,r,i,o,a,c,l,u,h,d,p,m,g,y,_,I,E,N,O,R,Q,$,ne,Se=t[2],ae=[];for(let te=0;te<Se.length;te+=1)ae[te]=Jl(Xl(t,Se,te));const fn=te=>T(ae[te],1,1,()=>{ae[te]=null});return R=new oc({props:{title:t[3]?"Click to create supertag":"Enter a valid name to continue",text:"Create supertag",disabled:!t[3]}}),R.$on("click",t[8]),{c(){e=b("section"),n=b("h3"),n.textContent="Create Supertag",s=P(),r=b("i"),i=P(),o=b("div"),a=b("label"),a.textContent="Name",c=P(),l=b("input"),u=P(),h=b("div"),d=b("label"),d.textContent="Description",p=P(),m=b("input"),g=P(),y=b("div"),_=b("span"),_.textContent="Tags",I=P(),E=b("ol");for(let te=0;te<ae.length;te+=1)ae[te].c();N=P(),O=b("div"),x(R.$$.fragment),f(r,"tabindex","0"),f(r,"role","button"),f(r,"class",Qe("codicon codicon-close")+" svelte-1nylv2m"),f(a,"for","supertag-name"),f(a,"class","svelte-1nylv2m"),f(l,"type","text"),f(l,"placeholder","Descriptive name"),f(l,"id","supertag-name"),f(l,"class","svelte-1nylv2m"),f(o,"class","svelte-1nylv2m"),f(d,"for","supertag-description"),f(d,"class","svelte-1nylv2m"),f(m,"type","text"),f(m,"placeholder","Short description"),f(m,"id","supertag-description"),f(m,"class","svelte-1nylv2m"),f(h,"class","svelte-1nylv2m"),f(_,"class","svelte-1nylv2m"),f(E,"class","svelte-1nylv2m"),f(y,"class","svelte-1nylv2m"),f(O,"class","last svelte-1nylv2m"),f(e,"class","svelte-1nylv2m")},m(te,ye){A(te,e,ye),v(e,n),v(e,s),v(e,r),v(e,i),v(e,o),v(o,a),v(o,c),v(o,l),rt(l,t[0]),v(e,u),v(e,h),v(h,d),v(h,p),v(h,m),rt(m,t[1]),v(e,g),v(e,y),v(y,_),v(y,I),v(y,E);for(let J=0;J<ae.length;J+=1)ae[J]&&ae[J].m(E,null);v(e,N),v(e,O),L(R,O,null),Q=!0,$||(ne=[B(r,"click",t[5]),B(r,"keyup",kt(t[5])),B(l,"input",t[6]),B(m,"input",t[7])],$=!0)},p(te,ye){if(ye&1&&l.value!==te[0]&&rt(l,te[0]),ye&2&&m.value!==te[1]&&rt(m,te[1]),ye&4){Se=te[2];let fe;for(fe=0;fe<Se.length;fe+=1){const xt=Xl(te,Se,fe);ae[fe]?(ae[fe].p(xt,ye),w(ae[fe],1)):(ae[fe]=Jl(xt),ae[fe].c(),w(ae[fe],1),ae[fe].m(E,null))}for(he(),fe=Se.length;fe<ae.length;fe+=1)fn(fe);de()}const J={};ye&8&&(J.title=te[3]?"Click to create supertag":"Enter a valid name to continue"),ye&8&&(J.disabled=!te[3]),R.$set(J)},i(te){if(!Q){for(let ye=0;ye<Se.length;ye+=1)w(ae[ye]);w(R.$$.fragment,te),Q=!0}},o(te){ae=ae.filter(Boolean);for(let ye=0;ye<ae.length;ye+=1)T(ae[ye]);T(R.$$.fragment,te),Q=!1},d(te){te&&S(e),Lt(ae,te),U(R),$=!1,_e(ne)}}}function VT(t){let e,n;return e=new Cp({props:{$$slots:{default:[xT]},$$scope:{ctx:t}}}),e.$on("close",t[5]),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p(s,[r]){const i={};r&4111&&(i.$$scope={dirty:r,ctx:s}),e.$set(i)},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function BT(t,e,n){let s,{name:r=""}=e,{description:i=""}=e,{tags:o}=e;const a=Xe(),c=()=>a("close");function l(){r=this.value,n(0,r)}function u(){i=this.value,n(1,i)}const h=()=>{a("submit",new Sp(r,i,o.map(kp))),c()};return t.$$set=d=>{"name"in d&&n(0,r=d.name),"description"in d&&n(1,i=d.description),"tags"in d&&n(2,o=d.tags)},t.$$.update=()=>{t.$$.dirty&1&&n(3,s=tr(r))},[r,i,o,s,a,c,l,u,h]}class jT extends W{constructor(e){super(),G(this,e,BT,VT,K,{name:0,description:1,tags:2})}}function qT(t){let e,n,s,r;return{c(){e=b("button"),f(e,"class",n=Qe(t[0])+" svelte-17m158f")},m(i,o){A(i,e,o),s||(r=[B(e,"click",t[1]),B(e,"keyup",kt(t[1]))],s=!0)},p(i,[o]){o&1&&n!==(n=Qe(i[0])+" svelte-17m158f")&&f(e,"class",n)},i:C,o:C,d(i){i&&S(e),s=!1,_e(r)}}}function zT(t,e,n){let s,r,{options:i}=e,{value:o}=e,a=Object.keys(i).indexOf(o);const c=()=>{n(4,a=(a+1)%s.length),n(2,o=s[a][0])};return t.$$set=l=>{"options"in l&&n(3,i=l.options),"value"in l&&n(2,o=l.value)},t.$$.update=()=>{t.$$.dirty&8&&n(5,s=Object.entries(i)),t.$$.dirty&48&&n(0,r=s[a][1])},[r,c,o,i,a,s]}class Dp extends W{constructor(e){super(),G(this,e,zT,qT,K,{options:3,value:2})}}function HT(t){let e,n,s;function r(o){t[1](o)}let i={options:PT};return t[0]!==void 0&&(i.value=t[0]),e=new Dp({props:i}),Ue.push(()=>yt(e,"value",r)),{c(){x(e.$$.fragment)},m(o,a){L(e,o,a),s=!0},p(o,[a]){const c={};!n&&a&1&&(n=!0,c.value=o[0],mt(()=>n=!1)),e.$set(c)},i(o){s||(w(e.$$.fragment,o),s=!0)},o(o){T(e.$$.fragment,o),s=!1},d(o){U(e,o)}}}function KT(t,e,n){let{modifier:s}=e;function r(i){s=i,n(0,s)}return t.$$set=i=>{"modifier"in i&&n(0,s=i.modifier)},[s,r]}class GT extends W{constructor(e){super(),G(this,e,KT,HT,K,{modifier:0})}}function WT(t){let e;return{c(){e=b("div"),e.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 20" enable-background="new 0 0 0 0" class="svelte-166gq1d"><circle fill="currentcolor" stroke="none" cx="6" cy="10" r="6"><animate attributeName="opacity" dur="1s" values="0;1;0" repeatCount="indefinite" begin="0.1"></animate></circle><circle fill="currentcolor" stroke="none" cx="25" cy="10" r="6"><animate attributeName="opacity" dur="1s" values="0;1;0" repeatCount="indefinite" begin="0.2"></animate></circle><circle fill="currentcolor" stroke="none" cx="44" cy="10" r="6"><animate attributeName="opacity" dur="1s" values="0;1;0" repeatCount="indefinite" begin="0.3"></animate></circle></svg>'},m(n,s){A(n,e,s)},p:C,i:C,o:C,d(n){n&&S(e)}}}class cc extends W{constructor(e){super(),G(this,e,null,WT,K,{})}}let QT=class{constructor(e,n,s,r,i,o,a,c,l,u,h,d,p,m,g,y,_){this.preview_url=e,this.sample_url=n,this.file_url=s,this.comment_count=r,this.height=i,this.id=o,this.change=a,this.parent_id=c,this.rating=l,this.sample_height=u,this.sample_width=h,this.score=d,this.source=p,this.status=m,this.tags=g,this.width=y,this.type=_,Object.freeze(this)}};const lc=(t,e)=>{if(!Rp(t))throw new TypeError("Invalid URL passed to fetchAbortPrevious");if(!YT(e))throw new TypeError("Invalid AbortController passed to fetchAbortPrevious");return e&&e.abort(),e=new AbortController,fetch(t,{signal:e.signal})},Rp=t=>{try{return new URL(t),!0}catch{return!1}},YT=t=>t===null||t instanceof AbortController;class Yr{constructor(e,n,s){if(!tr(e))throw TypeError("Invalid name passed to Tag constructor");if(!Li(n))throw TypeError("Invalid count passed to Tag constructor");if(!Ep(s))throw TypeError("Invalid type passed to Tag constructor");this.name=e,this.count=n,this.type=s,Object.freeze(this)}}const XT=(t,e)=>new Fi(e,t.name,t.count,t.type);let JT=null;const ZT=async t=>{const e="https://api.rule34.xxx/autocomplete.php?q=",n=t.replaceAll(" ","_"),s=await lc(`${e}${n}`,JT);if(s.ok){const r=await s.json();if(Array.isArray(r)){if(r.length===0)throw new Error("No tags found");return r.map(i=>new Yr(Np(i.value),Number(i.label.substring(i.label.lastIndexOf("(")+1,i.label.length-1)),"ambiguous"))}else throw r.message?new Error(r.message):new Error("Invalid tag suggestions received")}else throw new Error("Failed to get tag suggestions")},Np=t=>t.replaceAll("&#034;",'"').replaceAll("&#038;","&").replaceAll("&#039;","'").replaceAll("&eacute;","é"),Op=20;let Pp=null;const $p=t=>{if(!t.ok)throw new Error(`getPage failed with http status ${t.status}`)},eE=async(t,e)=>{const n=await lc(rE(t,e),Pp);$p(n);try{return(await n.json()).map(nE)}catch{return[]}},tE=async t=>{const e=await lc(iE(t),Pp);$p(e);const n=await e.text(),r=new DOMParser().parseFromString(n,"text/xml"),i=Number(r.getElementsByTagName("posts")[0].getAttribute("count"));return oE(i),i},nE=t=>{const e=t.height,n=t.score,s=t.preview_url,r=t.file_url,i=t.parent_id,o=t.sample_url,a=t.sample_width,c=t.sample_height,l=t.rating,u=t.tag_info,h=t.id,d=t.width,p=t.change,m=t.comment_count,g=t.status,y=t.source;return new QT(s,o,r,Number(m),Number(e),Number(h),Number(p)*1e3,i?Number(i):null,l,Number(c),Number(a),Number(n),y,g,sE(u),Number(d),r.endsWith(".webm")||r.endsWith(".mp4")?"video":r.includes(".gif")?"gif":"image")},sE=t=>t.map(e=>new Yr(Np(e.tag),e.count,e.type)).sort((e,n)=>Wl(e.type)-Wl(n.type)),rE=(t,e)=>{const s=`https://api.rule34.xxx/index.php?page=dapi&s=post&q=index&fields=tag_info&json=1&limit=${Op}&pid=${t}`;return e===""?s:`${s}&tags=${e}`},iE=t=>{const e="https://api.rule34.xxx/index.php?page=dapi&s=post&q=index&limit=0";return t===""?e:`${e}&tags=${t}`},oE=t=>{if(!Li(t))throw new Error("Unexpected response received in getPage")};let aE=class{constructor(e,n,s){cE(e),uE(n),lE(s),this.author=e,this.createdAt=n,this.content=s,Object.freeze(this)}};const cE=t=>{if(typeof t!="string")throw new TypeError("Invalid author in comment")},lE=t=>{if(typeof t!="string")throw new TypeError("Invalid content in comment")},uE=t=>{if(typeof t!="string")throw new TypeError("Invalid creation date in comment")},Zl="https://api.rule34.xxx/index.php?page=dapi&s=comment&q=index&json=1",eu=async(t=void 0)=>{if(typeof t!="number"&&t!==void 0)throw new TypeError("Invalid postId");const e=t===void 0?Zl:`${Zl}&post_id=${t}`,n=await fetch(e);if(!n.ok)throw new Error("Failed to get tag suggestions");const s=await n.text(),i=new DOMParser().parseFromString(s,"text/xml"),o=[];for(const a of i.getElementsByTagName("comment"))o.push(hE(a.attributes));return o},hE=t=>{const e=t.getNamedItem("creator"),n=t.getNamedItem("created_at"),s=t.getNamedItem("body");if(e==null||n==null||s==null)throw new Error(`Failed to parse comment, attribute was null. ${e}, ${n}, ${s}`);return new aE(e.value,n.value,s.value)};function dE(t){let e,n,s=Un(t[0].name)+"",r,i,o,a=Et(t[0].count)+"",c,l,u,h;return{c(){e=b("li"),n=b("span"),r=oe(s),i=P(),o=b("span"),c=oe(a),f(n,"class","tag-name svelte-1gc0x48"),f(o,"class","tag-count"),f(e,"tabindex","0"),f(e,"title",l=t[0].name),f(e,"class","svelte-1gc0x48"),ce(e,"selected",t[1])},m(d,p){A(d,e,p),v(e,n),v(n,r),v(e,i),v(e,o),v(o,c),u||(h=[B(e,"click",t[2]),B(e,"keypress",kt(t[2]))],u=!0)},p(d,[p]){p&1&&s!==(s=Un(d[0].name)+"")&&ge(r,s),p&1&&a!==(a=Et(d[0].count)+"")&&ge(c,a),p&1&&l!==(l=d[0].name)&&f(e,"title",l),p&2&&ce(e,"selected",d[1])},i:C,o:C,d(d){d&&S(e),u=!1,_e(h)}}}function fE(t,e,n){let{tag:s}=e,{selected:r=!1}=e;const i=Xe(),o=()=>i("click",s);return t.$$set=a=>{"tag"in a&&n(0,s=a.tag),"selected"in a&&n(1,r=a.selected)},[s,r,o]}class pE extends W{constructor(e){super(),G(this,e,fE,dE,K,{tag:0,selected:1})}}function gE(t){let e,n,s;return{c(){e=b("i"),f(e,"tabindex","0"),f(e,"role","button"),f(e,"class","codicon codicon-question spaced svelte-akp9se")},m(r,i){A(r,e,i),n||(s=[B(e,"click",t[0]),B(e,"keyup",kt(t[0]))],n=!0)},p:C,i:C,o:C,d(r){r&&S(e),n=!1,_e(s)}}}function mE(t){return[()=>In.navigateTo("help")]}class yE extends W{constructor(e){super(),G(this,e,mE,gE,K,{})}}function tu(t,e,n){const s=t.slice();return s[17]=e[n],s[19]=n,s}function _E(t){let e,n,s,r,i=t[20].message+"",o;return{c(){e=b("div"),n=b("i"),s=P(),r=b("span"),o=oe(i),f(n,"class",Qe("codicon codicon-error")+" svelte-9l8t0y"),f(e,"class","suggestion-footer svelte-9l8t0y")},m(a,c){A(a,e,c),v(e,n),v(e,s),v(e,r),v(r,o)},p(a,c){c&2&&i!==(i=a[20].message+"")&&ge(o,i)},i:C,o:C,d(a){a&&S(e)}}}function vE(t){let e,n,s,r=t[5],i=[];for(let a=0;a<r.length;a+=1)i[a]=nu(tu(t,r,a));const o=a=>T(i[a],1,1,()=>{i[a]=null});return{c(){for(let a=0;a<i.length;a+=1)i[a].c();e=P(),n=b("div"),f(n,"class","suggestion-footer svelte-9l8t0y")},m(a,c){for(let l=0;l<i.length;l+=1)i[l]&&i[l].m(a,c);A(a,e,c),A(a,n,c),s=!0},p(a,c){if(c&100){r=a[5];let l;for(l=0;l<r.length;l+=1){const u=tu(a,r,l);i[l]?(i[l].p(u,c),w(i[l],1)):(i[l]=nu(u),i[l].c(),w(i[l],1),i[l].m(e.parentNode,e))}for(he(),l=r.length;l<i.length;l+=1)o(l);de()}},i(a){if(!s){for(let c=0;c<r.length;c+=1)w(i[c]);s=!0}},o(a){i=i.filter(Boolean);for(let c=0;c<i.length;c+=1)T(i[c]);s=!1},d(a){Lt(i,a),a&&S(e),a&&S(n)}}}function nu(t){let e,n;return e=new pE({props:{tag:t[17],selected:t[19]===t[2]}}),e.$on("click",function(){Zr(t[6](t[17]))&&t[6](t[17]).apply(this,arguments)}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p(s,r){t=s;const i={};r&32&&(i.tag=t[17]),r&4&&(i.selected=t[19]===t[2]),e.$set(i)},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function wE(t){let e,n,s;return n=new cc({}),{c(){e=b("div"),x(n.$$.fragment),f(e,"class","suggestion-footer svelte-9l8t0y")},m(r,i){A(r,e,i),L(n,e,null),s=!0},p:C,i(r){s||(w(n.$$.fragment,r),s=!0)},o(r){T(n.$$.fragment,r),s=!1},d(r){r&&S(e),U(n)}}}function bE(t){let e,n,s,r,i,o,a,c,l,u,h,d,p,m,g;function y(E){t[11](E)}let _={};t[3]!==void 0&&(_.modifier=t[3]),o=new GT({props:_}),Ue.push(()=>yt(o,"modifier",y)),l=new yE({});let I={ctx:t,current:null,token:null,hasCatch:!0,pending:wE,then:vE,catch:_E,error:20,blocks:[,,,]};return Sr(d=t[1],I),{c(){e=b("div"),n=b("i"),s=P(),r=b("input"),i=P(),x(o.$$.fragment),c=P(),x(l.$$.fragment),u=P(),h=b("ol"),I.block.c(),f(n,"class","codicon codicon-search spaced svelte-9l8t0y"),f(r,"type","text"),f(r,"aria-label","Search for tags."),f(r,"class","svelte-9l8t0y"),f(h,"class","svelte-9l8t0y"),ce(h,"open",t[4]),f(e,"class","searchbar svelte-9l8t0y"),ce(e,"open",t[4])},m(E,N){A(E,e,N),v(e,n),v(e,s),v(e,r),rt(r,t[0]),v(e,i),L(o,e,null),v(e,c),L(l,e,null),v(e,u),v(e,h),I.block.m(h,I.anchor=null),I.mount=()=>h,I.anchor=null,p=!0,m||(g=[B(r,"input",t[7]),B(r,"focus",t[8]),B(r,"blur",t[9]),B(r,"keyup",t[10]),B(e,"blur",t[12])],m=!0)},p(E,[N]){t=E,N&1&&r.value!==t[0]&&rt(r,t[0]);const O={};!a&&N&8&&(a=!0,O.modifier=t[3],mt(()=>a=!1)),o.$set(O),I.ctx=t,N&2&&d!==(d=t[1])&&Sr(d,I)||xu(I,t,N),(!p||N&16)&&ce(h,"open",t[4]),(!p||N&16)&&ce(e,"open",t[4])},i(E){p||(w(o.$$.fragment,E),w(l.$$.fragment,E),w(I.block),p=!0)},o(E){T(o.$$.fragment,E),T(l.$$.fragment,E);for(let N=0;N<3;N+=1){const O=I.blocks[N];T(O)}p=!1},d(E){E&&S(e),U(o),U(l),I.block.d(),I.token=null,I=null,m=!1,_e(g)}}}function IE(t,e,n){let s;Me(t,Cs,N=>n(13,s=N));const r=Xe();let i,o="",a=0,c="+",l=!1,u=[];const h=N=>()=>{r("pick",XT(N,c)),p()};async function d(N){n(4,l=!0),n(5,u=[...s.supertags.filter(O=>O.name.toLowerCase().includes(N.toLowerCase())).map(O=>new Yr(O.name,Object.keys(O.tags).length,"supertag")),...await ZT(N)])}const p=()=>{n(0,o=""),n(5,u=[]),n(4,l=!1)};function m(){o=this.value,n(0,o)}const g=()=>{document.getElementById("title").scrollIntoView()},y=N=>{(!N.relatedTarget||!N.target.parentNode.contains(N.relatedTarget))&&n(4,l=!1)},_=N=>{ac(N)?h(u.length>a?u[a]:new Yr(o,0,"ambiguous"))():N.code==="ArrowUp"&&u.length>0?n(2,a=(a+u.length-1)%u.length):N.code==="ArrowDown"&&u.length>0&&n(2,a=(a+1)%u.length)};function I(N){c=N,n(3,c)}const E=()=>{n(4,l=!1)};return t.$$.update=()=>{t.$$.dirty&1&&(n(5,u=[]),n(2,a=0),o!==""&&n(1,i=d(o)))},[o,i,a,c,l,u,h,m,g,y,_,I,E]}class TE extends W{constructor(e){super(),G(this,e,IE,bE,K,{})}}const Mp=JSON.parse,Lp=JSON.stringify,Up=(t,e,n=Lp,s=Mp)=>{const r=Fp(t,s,e),i=Rs(r??e);return i.subscribe(o=>localStorage.setItem(t,n(o))),i},xi=(t,e,n=Lp,s=Mp)=>{const i=localStorage.getItem("isPersistedLocally")==="true"?Fp(t,s):null,o=Rs(i??e);return o.subscribe(a=>localStorage.setItem(t,n(a))),o},Fp=(t,e,n)=>{try{const s=e(localStorage.getItem(t));return typeof s=="object"&&typeof n=="object"?{...n,...s}:s}catch{return null}};function EE(){const t=[],{subscribe:e,update:n,set:s}=xi("activeTags",t);return{subscribe:e,set:s,addOrReplace:r=>n(i=>{const o=i.findIndex(a=>a.name===r.name);return o===-1?i.push(r):i[o]=r,i}),addByName:async r=>{n(i=>(i.push(new Fi("+",r,0,"general")),i))},removeByIndex:r=>n(i=>(i.splice(r,1),i))}}const _t=EE(),kE=Object.freeze({artist:"codicon codicon-edit",character:"codicon codicon-person",copyright:"codicon codicon-folder",metadata:"codicon codicon-info",rating:"codicon codicon-unverified",source:"codicon codicon-link",supertag:"codicon codicon-star-full"}),su=t=>kE[t]??"";function SE(t){let e,n=Un(t[0].name)+"",s,r,i,o;return{c(){e=b("button"),s=oe(n),f(e,"tabindex","0"),f(e,"title","Click to add tag"),f(e,"class",r=Qe(su(t[0].type))+" svelte-d6seti"),ce(e,"active",t[3]),ce(e,"icon",t[2]),ce(e,"supertag",t[4])},m(a,c){A(a,e,c),v(e,s),i||(o=B(e,"click",function(){Zr(t[4]?ru:t[8])&&(t[4]?ru:t[8]).apply(this,arguments)}),i=!0)},p(a,[c]){t=a,c&1&&n!==(n=Un(t[0].name)+"")&&ge(s,n),c&1&&r!==(r=Qe(su(t[0].type))+" svelte-d6seti")&&f(e,"class",r),c&9&&ce(e,"active",t[3]),c&5&&ce(e,"icon",t[2]),c&17&&ce(e,"supertag",t[4])},i:C,o:C,d(a){a&&S(e),i=!1,o()}}}const ru=()=>{};function AE(t,e,n){let s,r,i,o,a,c,l;Me(t,_t,d=>n(6,c=d)),Me(t,Cs,d=>n(7,l=d));let{tag:u}=e;const h=()=>o?_t.removeByIndex(r):_t.addByName(u.name);return t.$$set=d=>{"tag"in d&&n(0,u=d.tag)},t.$$.update=()=>{t.$$.dirty&192&&n(5,s=l.supertags.filter(d=>c.find(p=>d.name===p.name)).flatMap(d=>d.tags)),t.$$.dirty&65&&n(1,r=c.findIndex(d=>d.name===u.name)),t.$$.dirty&33&&n(4,i=s.find(d=>d.name===u.name)!==void 0),t.$$.dirty&2&&n(3,o=r>=0),t.$$.dirty&1&&n(2,a=ST(u.type))},[u,r,a,o,i,s,c,l,h]}class CE extends W{constructor(e){super(),G(this,e,AE,SE,K,{tag:0})}}function DE(t){let e,n,s,r,i;return{c(){e=b("i"),n=P(),s=b("a"),r=oe(t[1]),f(e,"class","codicon codicon-link"),f(s,"href",i=t[0].toString()),f(s,"target","_newtab"),f(s,"class","svelte-wfhmk4")},m(o,a){A(o,e,a),A(o,n,a),A(o,s,a),v(s,r)},p(o,[a]){a&2&&ge(r,o[1]),a&1&&i!==(i=o[0].toString())&&f(s,"href",i)},i:C,o:C,d(o){o&&S(e),o&&S(n),o&&S(s)}}}function RE(t,e,n){let s,{url:r}=e;return t.$$set=i=>{"url"in i&&n(0,r=i.url)},t.$$.update=()=>{t.$$.dirty&1&&n(1,s=r.hostname.replace(/^www./,""))},[r,s]}class NE extends W{constructor(e){super(),G(this,e,RE,DE,K,{url:0})}}function OE(t){let e,n,s,r;return{c(){e=b("i"),n=P(),s=b("span"),r=oe(t[0]),f(e,"class","codicon codicon-link")},m(i,o){A(i,e,o),A(i,n,o),A(i,s,o),v(s,r)},p(i,o){o&1&&ge(r,i[0])},i:C,o:C,d(i){i&&S(e),i&&S(n),i&&S(s)}}}function PE(t){let e,n;return e=new NE({props:{url:t[1]}}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p(s,r){const i={};r&2&&(i.url=s[1]),e.$set(i)},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function $E(t){let e,n,s,r;const i=[PE,OE],o=[];function a(c,l){return c[1]?0:1}return e=a(t),n=o[e]=i[e](t),{c(){n.c(),s=tt()},m(c,l){o[e].m(c,l),A(c,s,l),r=!0},p(c,[l]){let u=e;e=a(c),e===u?o[e].p(c,l):(he(),T(o[u],1,1,()=>{o[u]=null}),de(),n=o[e],n?n.p(c,l):(n=o[e]=i[e](c),n.c()),w(n,1),n.m(s.parentNode,s))},i(c){r||(w(n),r=!0)},o(c){T(n),r=!1},d(c){o[e].d(c),c&&S(s)}}}function ME(t,e,n){let s,{source:r}=e;return t.$$set=i=>{"source"in i&&n(0,r=i.source)},t.$$.update=()=>{t.$$.dirty&1&&n(1,s=Rp(r)?new URL(r):null)},[r,s]}class LE extends W{constructor(e){super(),G(this,e,ME,$E,K,{source:0})}}function UE(t){let e,n;const s=t[1].default,r=Pu(s,t,t[0],null);return{c(){e=b("div"),r&&r.c(),f(e,"class","svelte-11wqnx2")},m(i,o){A(i,e,o),r&&r.m(e,null),n=!0},p(i,[o]){r&&r.p&&(!n||o&1)&&Lu(r,s,i,i[0],n?Mu(s,i[0],o,null):Uu(i[0]),null)},i(i){n||(w(r,i),n=!0)},o(i){T(r,i),n=!1},d(i){i&&S(e),r&&r.d(i)}}}function FE(t,e,n){let{$$slots:s={},$$scope:r}=e;return t.$$set=i=>{"$$scope"in i&&n(0,r=i.$$scope)},[r,s]}class kr extends W{constructor(e){super(),G(this,e,FE,UE,K,{})}}const iu=6e4,Xr=t=>{if(!xE(t))throw new TypeError("Invalid createdAt passed to formatCreatedAt");const e=new Date(t).getTime()/iu,s=new Date().getTime()/iu-e;if(s<1)return"just now";if(s<60)return yn(s,"minute");const r=s/60;if(r<24)return yn(r,"hour");const i=r/24;if(i<7)return yn(i,"day");if(i<30.5)return yn(i/7,"week");if(i<365.25)return yn(i/30.5,"month");const o=i/365.25;return yn(o,"year")},xE=t=>["number","string"].includes(typeof t)&&new Date(t).toString()!=="Invalid Date",yn=(t,e)=>{const n=t.toFixed();return`${n} ${e}${n==="1"?"":"s"} ago`};function VE(t){let e,n,s,r=Xr(t[0])+"",i;return{c(){e=b("i"),n=P(),s=b("span"),i=oe(r),f(e,"class","codicon codicon-calendar"),f(s,"class","svelte-1vg7vp7")},m(o,a){A(o,e,a),A(o,n,a),A(o,s,a),v(s,i)},p(o,[a]){a&1&&r!==(r=Xr(o[0])+"")&&ge(i,r)},i:C,o:C,d(o){o&&S(e),o&&S(n),o&&S(s)}}}function BE(t,e,n){let{value:s}=e;return t.$$set=r=>{"value"in r&&n(0,s=r.value)},[s]}class jE extends W{constructor(e){super(),G(this,e,BE,VE,K,{value:0})}}function qE(t){let e,n,s,r=Et(t[0])+"",i;return{c(){e=b("i"),n=P(),s=b("span"),i=oe(r),f(e,"class","codicon codicon-heart"),f(s,"class","svelte-1vg7vp7")},m(o,a){A(o,e,a),A(o,n,a),A(o,s,a),v(s,i)},p(o,[a]){a&1&&r!==(r=Et(o[0])+"")&&ge(i,r)},i:C,o:C,d(o){o&&S(e),o&&S(n),o&&S(s)}}}function zE(t,e,n){let{value:s}=e;return t.$$set=r=>{"value"in r&&n(0,s=r.value)},[s]}class HE extends W{constructor(e){super(),G(this,e,zE,qE,K,{value:0})}}function KE(t){let e,n,s=t[0].author+"",r,i,o,a=Xr(t[0].createdAt)+"",c,l,u,h=t[0].content+"",d;return{c(){e=b("div"),n=b("span"),r=oe(s),i=P(),o=b("span"),c=oe(a),l=P(),u=b("span"),d=oe(h),f(n,"class","author svelte-18d2c69"),f(o,"class","created-at svelte-18d2c69"),f(u,"class","content svelte-18d2c69"),f(e,"class","svelte-18d2c69")},m(p,m){A(p,e,m),v(e,n),v(n,r),v(e,i),v(e,o),v(o,c),v(e,l),v(e,u),v(u,d)},p(p,[m]){m&1&&s!==(s=p[0].author+"")&&ge(r,s),m&1&&a!==(a=Xr(p[0].createdAt)+"")&&ge(c,a),m&1&&h!==(h=p[0].content+"")&&ge(d,h)},i:C,o:C,d(p){p&&S(e)}}}function GE(t,e,n){let{comment:s}=e;return t.$$set=r=>{"comment"in r&&n(0,s=r.comment)},[s]}class WE extends W{constructor(e){super(),G(this,e,GE,KE,K,{comment:0})}}function QE(t){let e,n,s,r;return{c(){e=b("i"),n=P(),s=b("a"),r=oe("rule34.xxx"),f(e,"class","codicon codicon-link-external"),f(s,"href",t[0]),f(s,"target","_newtab"),f(s,"class","svelte-wfhmk4")},m(i,o){A(i,e,o),A(i,n,o),A(i,s,o),v(s,r)},p(i,[o]){o&1&&f(s,"href",i[0])},i:C,o:C,d(i){i&&S(e),i&&S(n),i&&S(s)}}}function YE(t,e,n){let{url:s}=e;return t.$$set=r=>{"url"in r&&n(0,s=r.url)},[s]}class XE extends W{constructor(e){super(),G(this,e,YE,QE,K,{url:0})}}function ou(t,e,n){const s=t.slice();return s[8]=e[n],s}function au(t,e,n){const s=t.slice();return s[4]=e[n],s}function cu(t){let e,n,s,r,i;return{c(){e=b("i"),n=P(),s=b("i"),f(e,"class","codicon codicon-tag svelte-1mq2skj"),ce(e,"active",t[1]==="tags"),f(s,"class","codicon codicon-comment-discussion svelte-1mq2skj"),ce(s,"active",t[1]==="comments")},m(o,a){A(o,e,a),A(o,n,a),A(o,s,a),r||(i=[B(e,"click",t[2]),B(s,"click",t[3])],r=!0)},p(o,a){a&2&&ce(e,"active",o[1]==="tags"),a&2&&ce(s,"active",o[1]==="comments")},d(o){o&&S(e),o&&S(n),o&&S(s),r=!1,_e(i)}}}function JE(t){let e,n;return e=new jE({props:{value:t[0].change}}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p(s,r){const i={};r&1&&(i.value=s[0].change),e.$set(i)},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function ZE(t){let e,n;return e=new HE({props:{value:t[0].score}}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p(s,r){const i={};r&1&&(i.value=s[0].score),e.$set(i)},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function e1(t){let e,n;return e=new XE({props:{url:t[0].file_url}}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p(s,r){const i={};r&1&&(i.url=s[0].file_url),e.$set(i)},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function lu(t){let e,n;return e=new kr({props:{$$slots:{default:[t1]},$$scope:{ctx:t}}}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p(s,r){const i={};r&2049&&(i.$$scope={dirty:r,ctx:s}),e.$set(i)},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function t1(t){let e,n;return e=new LE({props:{source:t[0].source}}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p(s,r){const i={};r&1&&(i.source=s[0].source),e.$set(i)},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function n1(t){let e,n,s,r={ctx:t,current:null,token:null,hasCatch:!1,pending:c1,then:i1,catch:r1,value:7,blocks:[,,,]};return Sr(n=eu(t[0].id),r),{c(){e=tt(),r.block.c()},m(i,o){A(i,e,o),r.block.m(i,r.anchor=o),r.mount=()=>e.parentNode,r.anchor=e,s=!0},p(i,o){t=i,r.ctx=t,o&1&&n!==(n=eu(t[0].id))&&Sr(n,r)||xu(r,t,o)},i(i){s||(w(r.block),s=!0)},o(i){for(let o=0;o<3;o+=1){const a=r.blocks[o];T(a)}s=!1},d(i){i&&S(e),r.block.d(i),r.token=null,r=null}}}function s1(t){let e,n,s=t[0].tags,r=[];for(let o=0;o<s.length;o+=1)r[o]=hu(au(t,s,o));const i=o=>T(r[o],1,1,()=>{r[o]=null});return{c(){e=b("ul");for(let o=0;o<r.length;o+=1)r[o].c();f(e,"class","tags svelte-1mq2skj")},m(o,a){A(o,e,a);for(let c=0;c<r.length;c+=1)r[c]&&r[c].m(e,null);n=!0},p(o,a){if(a&1){s=o[0].tags;let c;for(c=0;c<s.length;c+=1){const l=au(o,s,c);r[c]?(r[c].p(l,a),w(r[c],1)):(r[c]=hu(l),r[c].c(),w(r[c],1),r[c].m(e,null))}for(he(),c=s.length;c<r.length;c+=1)i(c);de()}},i(o){if(!n){for(let a=0;a<s.length;a+=1)w(r[a]);n=!0}},o(o){r=r.filter(Boolean);for(let a=0;a<r.length;a+=1)T(r[a]);n=!1},d(o){o&&S(e),Lt(r,o)}}}function r1(t){return{c:C,m:C,p:C,i:C,o:C,d:C}}function i1(t){let e,n,s,r;const i=[a1,o1],o=[];function a(c,l){return c[7].length>0?0:1}return e=a(t),n=o[e]=i[e](t),{c(){n.c(),s=tt()},m(c,l){o[e].m(c,l),A(c,s,l),r=!0},p(c,l){let u=e;e=a(c),e===u?o[e].p(c,l):(he(),T(o[u],1,1,()=>{o[u]=null}),de(),n=o[e],n?n.p(c,l):(n=o[e]=i[e](c),n.c()),w(n,1),n.m(s.parentNode,s))},i(c){r||(w(n),r=!0)},o(c){T(n),r=!1},d(c){o[e].d(c),c&&S(s)}}}function o1(t){let e;return{c(){e=b("span"),e.textContent="Comments for this post are no longer available",f(e,"class","no-comments svelte-1mq2skj")},m(n,s){A(n,e,s)},p:C,i:C,o:C,d(n){n&&S(e)}}}function a1(t){let e,n,s=t[7],r=[];for(let o=0;o<s.length;o+=1)r[o]=uu(ou(t,s,o));const i=o=>T(r[o],1,1,()=>{r[o]=null});return{c(){e=b("ul");for(let o=0;o<r.length;o+=1)r[o].c();f(e,"class","comments svelte-1mq2skj")},m(o,a){A(o,e,a);for(let c=0;c<r.length;c+=1)r[c]&&r[c].m(e,null);n=!0},p(o,a){if(a&1){s=o[7];let c;for(c=0;c<s.length;c+=1){const l=ou(o,s,c);r[c]?(r[c].p(l,a),w(r[c],1)):(r[c]=uu(l),r[c].c(),w(r[c],1),r[c].m(e,null))}for(he(),c=s.length;c<r.length;c+=1)i(c);de()}},i(o){if(!n){for(let a=0;a<s.length;a+=1)w(r[a]);n=!0}},o(o){r=r.filter(Boolean);for(let a=0;a<r.length;a+=1)T(r[a]);n=!1},d(o){o&&S(e),Lt(r,o)}}}function uu(t){let e,n;return e=new WE({props:{comment:t[8]}}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p(s,r){const i={};r&1&&(i.comment=s[8]),e.$set(i)},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function c1(t){let e,n;return e=new cc({}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p:C,i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function hu(t){let e,n;return e=new CE({props:{tag:t[4]}}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p(s,r){const i={};r&1&&(i.tag=s[4]),e.$set(i)},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function l1(t){let e,n,s,r,i,o,a,c,l,u,h,d,p,m=t[0].comment_count>0&&cu(t);r=new kr({props:{$$slots:{default:[JE]},$$scope:{ctx:t}}}),o=new kr({props:{$$slots:{default:[ZE]},$$scope:{ctx:t}}}),c=new kr({props:{$$slots:{default:[e1]},$$scope:{ctx:t}}});let g=t[0].source&&lu(t);const y=[s1,n1],_=[];function I(E,N){return E[1]==="tags"?0:1}return h=I(t),d=_[h]=y[h](t),{c(){e=b("div"),n=b("div"),m&&m.c(),s=P(),x(r.$$.fragment),i=P(),x(o.$$.fragment),a=P(),x(c.$$.fragment),l=P(),g&&g.c(),u=P(),d.c(),f(n,"class","summary svelte-1mq2skj"),f(e,"class","details svelte-1mq2skj")},m(E,N){A(E,e,N),v(e,n),m&&m.m(n,null),v(n,s),L(r,n,null),v(n,i),L(o,n,null),v(n,a),L(c,n,null),v(n,l),g&&g.m(n,null),v(e,u),_[h].m(e,null),p=!0},p(E,[N]){E[0].comment_count>0?m?m.p(E,N):(m=cu(E),m.c(),m.m(n,s)):m&&(m.d(1),m=null);const O={};N&2049&&(O.$$scope={dirty:N,ctx:E}),r.$set(O);const R={};N&2049&&(R.$$scope={dirty:N,ctx:E}),o.$set(R);const Q={};N&2049&&(Q.$$scope={dirty:N,ctx:E}),c.$set(Q),E[0].source?g?(g.p(E,N),N&1&&w(g,1)):(g=lu(E),g.c(),w(g,1),g.m(n,null)):g&&(he(),T(g,1,1,()=>{g=null}),de());let $=h;h=I(E),h===$?_[h].p(E,N):(he(),T(_[$],1,1,()=>{_[$]=null}),de(),d=_[h],d?d.p(E,N):(d=_[h]=y[h](E),d.c()),w(d,1),d.m(e,null))},i(E){p||(w(r.$$.fragment,E),w(o.$$.fragment,E),w(c.$$.fragment,E),w(g),w(d),p=!0)},o(E){T(r.$$.fragment,E),T(o.$$.fragment,E),T(c.$$.fragment,E),T(g),T(d),p=!1},d(E){E&&S(e),m&&m.d(),U(r),U(o),U(c),g&&g.d(),_[h].d()}}}function u1(t,e,n){let{post:s}=e,r="tags";const i=()=>{n(1,r="tags")},o=()=>{n(1,r="comments")};return t.$$set=a=>{"post"in a&&n(0,s=a.post)},[s,r,i,o]}class h1 extends W{constructor(e){super(),G(this,e,u1,l1,K,{post:0})}}const Jr=new IntersectionObserver(t=>{for(const e of t){const n=e.isIntersecting?e.target.getAttribute("data-src"):"";e.target.setAttribute("src",n)}},{rootMargin:"1250px"});function d1(t){let e,n,s,r,i,o,a,c;return{c(){e=b("img"),f(e,"loading","lazy"),f(e,"data-src",n=t[0].sample_url),f(e,"alt",s=t[0].id.toString()),f(e,"style",r=`aspect-ratio: ${t[0].width} / ${t[0].height}`),f(e,"width",i=t[0].width),f(e,"height",o=t[0].height),f(e,"tabindex","0"),f(e,"class","svelte-4xosj1")},m(l,u){A(l,e,u),t[3](e),a||(c=[B(e,"click",t[4]),B(e,"keyup",kt(t[5]))],a=!0)},p(l,[u]){u&1&&n!==(n=l[0].sample_url)&&f(e,"data-src",n),u&1&&s!==(s=l[0].id.toString())&&f(e,"alt",s),u&1&&r!==(r=`aspect-ratio: ${l[0].width} / ${l[0].height}`)&&f(e,"style",r),u&1&&i!==(i=l[0].width)&&f(e,"width",i),u&1&&o!==(o=l[0].height)&&f(e,"height",o)},i:C,o:C,d(l){l&&S(e),t[3](null),a=!1,_e(c)}}}function f1(t,e,n){let{post:s}=e;const r=Xe();let i;Ds(()=>Jr.observe(i)),ti(()=>Jr.unobserve(i));function o(l){Ue[l?"unshift":"push"](()=>{i=l,n(1,i)})}const a=()=>r("click"),c=()=>r("click");return t.$$set=l=>{"post"in l&&n(0,s=l.post)},[s,i,r,o,a,c]}let p1=class extends W{constructor(e){super(),G(this,e,f1,d1,K,{post:0})}};const g1="/assets/play-f2f6faca.svg",m1="/assets/load-8440afed.svg",y1="/assets/pause-6f7851a2.svg";function _1(t){let e,n;return{c(){e=b("img"),Zt(e.src,n=g1)||f(e,"src",n),f(e,"alt","Start GIF"),f(e,"width","16"),f(e,"height","32"),Qp(e,"margin-left","4px")},m(s,r){A(s,e,r)},p:C,d(s){s&&S(e)}}}function v1(t){let e,n;return{c(){e=b("img"),Zt(e.src,n=y1)||f(e,"src",n),f(e,"alt","Stop GIF"),f(e,"width","16"),f(e,"height","32")},m(s,r){A(s,e,r)},p:C,d(s){s&&S(e)}}}function w1(t){let e,n;return{c(){e=b("img"),Zt(e.src,n=m1)||f(e,"src",n),f(e,"alt","Loading GIF"),f(e,"width","16"),f(e,"height","32")},m(s,r){A(s,e,r)},p:C,d(s){s&&S(e)}}}function b1(t){let e,n,s,r,i;function o(l,u){return l[1]?w1:l[0]?v1:_1}let a=o(t),c=a(t);return{c(){e=b("button"),n=b("div"),c.c(),f(n,"class","circle svelte-142dl5p"),f(e,"class",s=Qe(t[3].class)+" svelte-142dl5p"),ce(e,"play",t[0]&&!t[1])},m(l,u){A(l,e,u),v(e,n),c.m(n,null),r||(i=B(e,"click",Ko(t[2])),r=!0)},p(l,[u]){a===(a=o(l))&&c?c.p(l,u):(c.d(1),c=a(l),c&&(c.c(),c.m(n,null))),u&8&&s!==(s=Qe(l[3].class)+" svelte-142dl5p")&&f(e,"class",s),u&11&&ce(e,"play",l[0]&&!l[1])},i:C,o:C,d(l){l&&S(e),c.d(),r=!1,i()}}}function I1(t,e,n){let{playing:s}=e,{loading:r}=e;const i=()=>{n(1,r=!0),n(0,s=!s)};return t.$$set=o=>{n(3,e=uo(uo({},e),fc(o))),"playing"in o&&n(0,s=o.playing),"loading"in o&&n(1,r=o.loading)},e=fc(e),[s,r,i,e]}class xp extends W{constructor(e){super(),G(this,e,I1,b1,K,{playing:0,loading:1})}}function T1(t){let e,n,s,r,i,o,a,c,l,u,h,d,p;function m(_){t[12](_)}function g(_){t[13](_)}let y={class:"center"};return t[2]!==void 0&&(y.playing=t[2]),t[3]!==void 0&&(y.loading=t[3]),c=new xp({props:y}),Ue.push(()=>yt(c,"playing",m)),Ue.push(()=>yt(c,"loading",g)),{c(){e=b("div"),n=b("img"),a=P(),x(c.$$.fragment),f(n,"class","media-img svelte-1itvuez"),f(n,"loading","lazy"),f(n,"data-src",t[4]),f(n,"alt",s=t[0].id.toString()),f(n,"style",r=`aspect-ratio: ${t[0].width} / ${t[0].height}`),f(n,"width",i=t[0].width),f(n,"height",o=t[0].height),f(n,"tabindex","0"),f(e,"class","container svelte-1itvuez")},m(_,I){A(_,e,I),v(e,n),t[8](n),v(e,a),L(c,e,null),h=!0,d||(p=[B(n,"click",t[9]),B(n,"keyup",kt(t[10])),B(n,"load",t[11])],d=!0)},p(_,[I]){(!h||I&16)&&f(n,"data-src",_[4]),(!h||I&1&&s!==(s=_[0].id.toString()))&&f(n,"alt",s),(!h||I&1&&r!==(r=`aspect-ratio: ${_[0].width} / ${_[0].height}`))&&f(n,"style",r),(!h||I&1&&i!==(i=_[0].width))&&f(n,"width",i),(!h||I&1&&o!==(o=_[0].height))&&f(n,"height",o);const E={};!l&&I&4&&(l=!0,E.playing=_[2],mt(()=>l=!1)),!u&&I&8&&(u=!0,E.loading=_[3],mt(()=>u=!1)),c.$set(E)},i(_){h||(w(c.$$.fragment,_),h=!0)},o(_){T(c.$$.fragment,_),h=!1},d(_){_&&S(e),t[8](null),U(c),d=!1,_e(p)}}}function E1(t,e,n){let s,r,i,{post:o}=e;const a=Xe();let c,l=!1,u=!1;Ds(()=>Jr.observe(c)),ti(()=>Jr.unobserve(c));function h(_){Ue[_?"unshift":"push"](()=>{c=_,n(1,c),n(2,l),n(7,r),n(6,s),n(0,o)})}const d=()=>a("click"),p=()=>a("click"),m=()=>n(3,u=!1);function g(_){l=_,n(2,l)}function y(_){u=_,n(3,u)}return t.$$set=_=>{"post"in _&&n(0,o=_.post)},t.$$.update=()=>{t.$$.dirty&1&&n(6,s=o.sample_url.endsWith(".gif")?o.preview_url:o.sample_url),t.$$.dirty&1&&n(7,r=o.sample_url.endsWith(".gif")?o.sample_url:o.file_url),t.$$.dirty&196&&n(4,i=l?r:s),t.$$.dirty&198&&c&&n(1,c.src=l?r:s,c)},[o,c,l,u,i,a,s,r,h,d,p,m,g,y]}class k1 extends W{constructor(e){super(),G(this,e,E1,T1,K,{post:0})}}function du(t){let e,n,s=!0,r=!1,i,o,a,c=t[16](t[13])+"",l,u,h,d,p,m,g,y,_,I,E;function N(){cancelAnimationFrame(i),e.paused||(i=Gp(N),r=!0),t[24].call(e)}function O($){t[27]($)}function R($){t[28]($)}let Q={class:"center"};return t[4]!==void 0&&(Q.playing=t[4]),t[10]!==void 0&&(Q.loading=t[10]),m=new xp({props:Q}),Ue.push(()=>yt(m,"playing",O)),Ue.push(()=>yt(m,"loading",R)),{c(){e=b("video"),o=P(),a=b("span"),l=oe(c),u=P(),h=b("input"),p=P(),x(m.$$.fragment),f(e,"preload","metadata"),f(e,"poster",t[0]),f(e,"style",n=`aspect-ratio: ${t[1]} / ${t[2]}`),e.loop=t[3],f(e,"class","svelte-5zif18"),t[6]===void 0&&us(()=>t[25].call(e)),f(a,"class","svelte-5zif18"),ce(a,"play",t[4]),f(h,"type","range"),f(h,"min",0),f(h,"step",.0166666),f(h,"max",t[6]),f(h,"style",d=`background-image: linear-gradient(90deg, var(--accent) ${t[11]}%, var(--background-2) ${t[11]}%);}`),f(h,"class","svelte-5zif18"),ce(h,"play",t[4]&&!t[10])},m($,ne){A($,e,ne),t[18](e),A($,o,ne),A($,a,ne),v(a,l),A($,u,ne),A($,h,ne),rt(h,t[5]),A($,p,ne),L(m,$,ne),_=!0,I||(E=[B(e,"waiting",t[19]),B(e,"playing",t[20]),B(e,"pause",t[21]),B(e,"ended",t[22]),B(e,"play",t[23]),B(e,"pause",t[23]),B(e,"timeupdate",N),B(e,"durationchange",t[25]),B(h,"change",t[26]),B(h,"input",t[26]),B(h,"click",Ko(A1))],I=!0)},p($,ne){(!_||ne[0]&1)&&f(e,"poster",$[0]),(!_||ne[0]&6&&n!==(n=`aspect-ratio: ${$[1]} / ${$[2]}`))&&f(e,"style",n),(!_||ne[0]&8)&&(e.loop=$[3]),ne[0]&4096&&s!==(s=$[12])&&e[s?"pause":"play"](),!r&&ne[0]&32&&!isNaN($[5])&&(e.currentTime=$[5]),r=!1,(!_||ne[0]&8192)&&c!==(c=$[16]($[13])+"")&&ge(l,c),(!_||ne[0]&16)&&ce(a,"play",$[4]),(!_||ne[0]&64)&&f(h,"max",$[6]),(!_||ne[0]&2048&&d!==(d=`background-image: linear-gradient(90deg, var(--accent) ${$[11]}%, var(--background-2) ${$[11]}%);}`))&&f(h,"style",d),ne[0]&32&&rt(h,$[5]),(!_||ne[0]&1040)&&ce(h,"play",$[4]&&!$[10]);const Se={};!g&&ne[0]&16&&(g=!0,Se.playing=$[4],mt(()=>g=!1)),!y&&ne[0]&1024&&(y=!0,Se.loading=$[10],mt(()=>y=!1)),m.$set(Se)},i($){_||(w(m.$$.fragment,$),_=!0)},o($){T(m.$$.fragment,$),_=!1},d($){$&&S(e),t[18](null),$&&S(o),$&&S(a),$&&S(u),$&&S(h),$&&S(p),U(m,$),I=!1,_e(E)}}}function S1(t){let e,n,s,r,i,o=t[8]&&du(t);return{c(){e=b("div"),o&&o.c(),f(e,"class","player svelte-5zif18"),f(e,"tabindex","0"),f(e,"style",n=`aspect-ratio: ${t[1]} / ${t[2]}`)},m(a,c){A(a,e,c),o&&o.m(e,null),t[29](e),s=!0,r||(i=[B(e,"click",t[14]),B(e,"keydown",Fu(t[15]))],r=!0)},p(a,c){a[8]?o?(o.p(a,c),c[0]&256&&w(o,1)):(o=du(a),o.c(),w(o,1),o.m(e,null)):o&&(he(),T(o,1,1,()=>{o=null}),de()),(!s||c[0]&6&&n!==(n=`aspect-ratio: ${a[1]} / ${a[2]}`))&&f(e,"style",n)},i(a){s||(w(o),s=!0)},o(a){T(o),s=!1},d(a){a&&S(e),o&&o.d(),t[29](null),r=!1,_e(i)}}}const fu=5,A1=()=>{};function C1(t,e,n){let s,r,i,{src:o}=e,{poster:a}=e,{width:c}=e,{height:l}=e,{loop:u}=e,h,d=!1,p=!1,m=0,g=0,y,_=!1;const I=Xe(),E=()=>I("click"),N=se=>{ac(se)?E():se.key===" "?n(4,d=!d):se.key==="ArrowLeft"?n(5,m=Math.max(0,m-fu)):se.key==="ArrowRight"&&n(5,m=Math.min(g,m+fu))},O=new IntersectionObserver(se=>{for(const rr of se)rr.isIntersecting?n(8,_=!0):y&&(n(7,y.src="",y),n(4,d=!1),n(10,p=!1),y.addEventListener("error",()=>n(8,_=!1),{once:!0}))},{rootMargin:"0px"});Ds(()=>O.observe(h)),ti(()=>O.unobserve(h));const R=se=>{const rr=Math.floor(se),Bp=rr%60,jp=Math.floor(rr/60);return`${Q(jp)}:${Q(Bp)}`},Q=se=>`${se<10?"0":""}${se}`;function $(se){Ue[se?"unshift":"push"](()=>{y=se,n(7,y),n(8,_),n(17,o)})}const ne=()=>n(10,p=!0),Se=()=>n(10,p=!1),ae=()=>n(10,p=!1),fn=()=>{u||(n(10,p=!1),n(4,d=!1))};function te(){r=this.paused,n(12,r),n(4,d),n(8,_)}function ye(){m=this.currentTime,n(5,m)}function J(){g=this.duration,n(6,g)}function fe(){m=Go(this.value),n(5,m)}function xt(se){d=se,n(4,d),n(8,_)}function nr(se){p=se,n(10,p)}function sr(se){Ue[se?"unshift":"push"](()=>{h=se,n(9,h)})}return t.$$set=se=>{"src"in se&&n(17,o=se.src),"poster"in se&&n(0,a=se.poster),"width"in se&&n(1,c=se.width),"height"in se&&n(2,l=se.height),"loop"in se&&n(3,u=se.loop)},t.$$.update=()=>{t.$$.dirty[0]&96&&n(13,s=g-m),t.$$.dirty[0]&272&&n(4,d=_&&d),t.$$.dirty[0]&16&&n(12,r=!d),t.$$.dirty[0]&96&&n(11,i=m/g*98+1),t.$$.dirty[0]&131456&&y&&_&&n(7,y.src=o,y)},[a,c,l,u,d,m,g,y,_,h,p,i,r,s,E,N,R,o,$,ne,Se,ae,fn,te,ye,J,fe,xt,nr,sr]}class D1 extends W{constructor(e){super(),G(this,e,C1,S1,K,{src:17,poster:0,width:1,height:2,loop:3},null,[-1,-1])}}function R1(t){let e,n;return e=new k1({props:{post:t[0]}}),e.$on("click",t[2]),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p(s,r){const i={};r&1&&(i.post=s[0]),e.$set(i)},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function N1(t){let e,n;return e=new D1({props:{src:t[0].file_url,poster:t[0].sample_url,width:t[0].width,height:t[0].height,loop:t[0].tags.some(gu)}}),e.$on("click",t[2]),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p(s,r){const i={};r&1&&(i.src=s[0].file_url),r&1&&(i.poster=s[0].sample_url),r&1&&(i.width=s[0].width),r&1&&(i.height=s[0].height),r&1&&(i.loop=s[0].tags.some(gu)),e.$set(i)},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function O1(t){let e,n;return e=new p1({props:{post:t[0]}}),e.$on("click",t[2]),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p(s,r){const i={};r&1&&(i.post=s[0]),e.$set(i)},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function pu(t){let e,n;return e=new h1({props:{post:t[0]}}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p(s,r){const i={};r&1&&(i.post=s[0]),e.$set(i)},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function P1(t){let e,n,s,r,i;const o=[O1,N1,R1],a=[];function c(u,h){return u[0].type==="image"?0:u[0].type==="video"?1:2}n=c(t),s=a[n]=o[n](t);let l=t[1]&&pu(t);return{c(){e=b("div"),s.c(),r=P(),l&&l.c(),f(e,"class","post svelte-1b8286y")},m(u,h){A(u,e,h),a[n].m(e,null),v(e,r),l&&l.m(e,null),i=!0},p(u,[h]){let d=n;n=c(u),n===d?a[n].p(u,h):(he(),T(a[d],1,1,()=>{a[d]=null}),de(),s=a[n],s?s.p(u,h):(s=a[n]=o[n](u),s.c()),w(s,1),s.m(e,r)),u[1]?l?(l.p(u,h),h&2&&w(l,1)):(l=pu(u),l.c(),w(l,1),l.m(e,null)):l&&(he(),T(l,1,1,()=>{l=null}),de())},i(u){i||(w(s),w(l),i=!0)},o(u){T(s),T(l),i=!1},d(u){u&&S(e),a[n].d(),l&&l.d()}}}const gu=t=>t.name=="loop";function $1(t,e,n){let{post:s}=e,r=!1;const i=()=>{n(1,r=!r)};return t.$$set=o=>{"post"in o&&n(0,s=o.post)},[s,r,i]}class M1 extends W{constructor(e){super(),G(this,e,$1,P1,K,{post:0})}}function mu(t,e,n){const s=t.slice();return s[1]=e[n],s}function yu(t){let e,n;return e=new M1({props:{post:t[1]}}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p(s,r){const i={};r&1&&(i.post=s[1]),e.$set(i)},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function L1(t){let e,n,s=t[0],r=[];for(let o=0;o<s.length;o+=1)r[o]=yu(mu(t,s,o));const i=o=>T(r[o],1,1,()=>{r[o]=null});return{c(){e=b("ol");for(let o=0;o<r.length;o+=1)r[o].c();f(e,"class","page svelte-vcm6im")},m(o,a){A(o,e,a);for(let c=0;c<r.length;c+=1)r[c]&&r[c].m(e,null);n=!0},p(o,[a]){if(a&1){s=o[0];let c;for(c=0;c<s.length;c+=1){const l=mu(o,s,c);r[c]?(r[c].p(l,a),w(r[c],1)):(r[c]=yu(l),r[c].c(),w(r[c],1),r[c].m(e,null))}for(he(),c=s.length;c<r.length;c+=1)i(c);de()}},i(o){if(!n){for(let a=0;a<s.length;a+=1)w(r[a]);n=!0}},o(o){r=r.filter(Boolean);for(let a=0;a<r.length;a+=1)T(r[a]);n=!1},d(o){o&&S(e),Lt(r,o)}}}function U1(t,e,n){let{posts:s}=e;return t.$$set=r=>{"posts"in r&&n(0,s=r.posts)},[s]}class F1 extends W{constructor(e){super(),G(this,e,U1,L1,K,{posts:0})}}function x1(t){let e;return{c(){e=b("div")},m(n,s){A(n,e,s),t[1](e)},p:C,i:C,o:C,d(n){n&&S(e),t[1](null)}}}function V1(t,e,n){const s=Xe(),r=new IntersectionObserver(a=>{a[0].isIntersecting&&s("visible")},{rootMargin:"1250px"});let i;function o(a){Ue[a?"unshift":"push"](()=>{i=a,n(0,i)})}return t.$$.update=()=>{t.$$.dirty&1&&(r.disconnect(),i&&r.observe(i))},[i,o]}class B1 extends W{constructor(e){super(),G(this,e,V1,x1,K,{})}}const j1="/assets/shironeko-x-c28cad00.png";function q1(t){let e,n,s,r,i;return{c(){e=b("div"),n=b("img"),r=P(),i=b("span"),i.textContent="You have reached the end",Zt(n.src,s=j1)||f(n,"src",s),f(n,"alt","No results."),f(i,"class","svelte-1rtbqa7"),f(e,"class","svelte-1rtbqa7")},m(o,a){A(o,e,a),v(e,n),v(e,r),v(e,i)},p:C,i:C,o:C,d(o){o&&S(e)}}}class z1 extends W{constructor(e){super(),G(this,e,null,q1,K,{})}}const H1="/assets/shironeko-confused-4071d5b2.png";function K1(t){let e,n,s,r,i;return{c(){e=b("div"),n=b("img"),r=P(),i=b("span"),i.textContent="No results found",Zt(n.src,s=H1)||f(n,"src",s),f(n,"alt","No results"),f(i,"class","svelte-10fem3h"),f(e,"class","svelte-10fem3h")},m(o,a){A(o,e,a),v(e,n),v(e,r),v(e,i)},p:C,i:C,o:C,d(o){o&&S(e)}}}class G1 extends W{constructor(e){super(),G(this,e,null,K1,K,{})}}const _u=()=>({pages:[],nextPage:0,ids:new Set}),W1=t=>{const e={pages:t.pages,nextPage:t.nextPage,ids:[...t.ids.values()]};return JSON.stringify(e)},Q1=t=>{const e=JSON.parse(t);return{pages:e.pages,nextPage:e.nextPage,ids:new Set(e.ids)}},Y1=()=>{const{subscribe:t,update:e,set:n}=xi("results",_u(),W1,Q1);return{subscribe:t,addPage(s){e(r=>{const i=s.filter(o=>!r.ids.has(o.id));return i.forEach(o=>r.ids.add(o.id)),{pages:[...r.pages,i],nextPage:r.nextPage+1,ids:r.ids}})},reset(){n(_u())}}},ts=Y1(),X1=()=>{const{subscribe:t,set:e}=xi("count",null);return{subscribe:t,set:e,reset(){e(0)}}},uc=X1(),J1={sortProperty:"id",scoreValue:0,scoreComparator:">=",sortDirection:"desc"},Z1=()=>{const{subscribe:t,set:e}=Up("sort",J1);return{subscribe:t,set:e}},bn=Z1();function vu(t,e,n){const s=t.slice();return s[0]=e[n][0],s[3]=e[n][1],s}function wu(t){let e,n=t[3]+"",s,r;return{c(){e=b("option"),s=oe(n),e.__value=r=t[0],e.value=e.__value,f(e,"class","svelte-q7wjrm")},m(i,o){A(i,e,o),v(e,s)},p(i,o){o&2&&n!==(n=i[3]+"")&&ge(s,n),o&2&&r!==(r=i[0])&&(e.__value=r,e.value=e.__value)},d(i){i&&S(e)}}}function ek(t){let e,n,s,r=Object.entries(t[1]),i=[];for(let o=0;o<r.length;o+=1)i[o]=wu(vu(t,r,o));return{c(){e=b("select");for(let o=0;o<i.length;o+=1)i[o].c();f(e,"class","svelte-q7wjrm"),t[0]===void 0&&us(()=>t[2].call(e))},m(o,a){A(o,e,a);for(let c=0;c<i.length;c+=1)i[c]&&i[c].m(e,null);pc(e,t[0],!0),n||(s=B(e,"change",t[2]),n=!0)},p(o,[a]){if(a&2){r=Object.entries(o[1]);let c;for(c=0;c<r.length;c+=1){const l=vu(o,r,c);i[c]?i[c].p(l,a):(i[c]=wu(l),i[c].c(),i[c].m(e,null))}for(;c<i.length;c+=1)i[c].d(1);i.length=r.length}a&3&&pc(e,o[0])},i:C,o:C,d(o){o&&S(e),Lt(i,o),n=!1,s()}}}function tk(t,e,n){let{options:s}=e,{value:r}=e;function i(){r=Yp(this),n(0,r),n(1,s)}return t.$$set=o=>{"options"in o&&n(1,s=o.options),"value"in o&&n(0,r=o.value)},[r,s,i]}class nk extends W{constructor(e){super(),G(this,e,tk,ek,K,{options:1,value:0})}}function sk(t){let e,n,s,r;return{c(){e=b("button"),n=oe(t[0]),f(e,"class","svelte-17m158f")},m(i,o){A(i,e,o),v(e,n),s||(r=[B(e,"click",t[1]),B(e,"keyup",kt(t[1]))],s=!0)},p(i,[o]){o&1&&ge(n,i[0])},i:C,o:C,d(i){i&&S(e),s=!1,_e(r)}}}function rk(t,e,n){let s,r,{options:i}=e,{value:o}=e,a=Object.keys(i).indexOf(o);const c=()=>{n(4,a=(a+1)%s.length),n(2,o=s[a][0])};return t.$$set=l=>{"options"in l&&n(3,i=l.options),"value"in l&&n(2,o=l.value)},t.$$.update=()=>{t.$$.dirty&8&&n(5,s=Object.entries(i)),t.$$.dirty&48&&n(0,r=s[a][1])},[r,c,o,i,a,s]}class ik extends W{constructor(e){super(),G(this,e,rk,sk,K,{options:3,value:2})}}function bu(t){let e,n;return e=new Cp({props:{$$slots:{default:[ok]},$$scope:{ctx:t}}}),e.$on("close",t[5]),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p(s,r){const i={};r&1025&&(i.$$scope={dirty:r,ctx:s}),e.$set(i)},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function ok(t){let e,n,s,r,i,o,a,c,l,u,h,d,p,m,g,y,_,I,E,N,O,R,Q,$;function ne(J){t[6](J)}let Se={options:lk};t[0].sortDirection!==void 0&&(Se.value=t[0].sortDirection),o=new Dp({props:Se}),Ue.push(()=>yt(o,"value",ne));function ae(J){t[7](J)}let fn={options:ck};t[0].sortProperty!==void 0&&(fn.value=t[0].sortProperty),l=new nk({props:fn}),Ue.push(()=>yt(l,"value",ae));function te(J){t[8](J)}let ye={options:uk};return t[0].scoreComparator!==void 0&&(ye.value=t[0].scoreComparator),y=new ik({props:ye}),Ue.push(()=>yt(y,"value",te)),O=new oc({props:{text:"Done",title:"Return to searching."}}),O.$on("click",t[5]),{c(){e=b("div"),n=b("label"),s=b("b"),s.textContent="Sorting",r=P(),i=b("div"),x(o.$$.fragment),c=P(),x(l.$$.fragment),h=P(),d=b("label"),p=b("b"),p.textContent="Score Filtering",m=P(),g=b("div"),x(y.$$.fragment),I=P(),E=b("input"),N=P(),x(O.$$.fragment),f(i,"class","row svelte-1k7zufl"),f(n,"class","svelte-1k7zufl"),f(E,"type","number"),f(E,"min",0),f(E,"max",1e5),f(E,"step",1),f(E,"class","svelte-1k7zufl"),f(g,"class","row svelte-1k7zufl"),f(d,"class","svelte-1k7zufl"),f(e,"class","container svelte-1k7zufl")},m(J,fe){A(J,e,fe),v(e,n),v(n,s),v(n,r),v(n,i),L(o,i,null),v(i,c),L(l,i,null),v(e,h),v(e,d),v(d,p),v(d,m),v(d,g),L(y,g,null),v(g,I),v(g,E),rt(E,t[0].scoreValue),v(e,N),L(O,e,null),R=!0,Q||($=[B(E,"input",t[9]),B(E,"keyup",kt(dk))],Q=!0)},p(J,fe){const xt={};!a&&fe&1&&(a=!0,xt.value=J[0].sortDirection,mt(()=>a=!1)),o.$set(xt);const nr={};!u&&fe&1&&(u=!0,nr.value=J[0].sortProperty,mt(()=>u=!1)),l.$set(nr);const sr={};!_&&fe&1&&(_=!0,sr.value=J[0].scoreComparator,mt(()=>_=!1)),y.$set(sr),fe&1&&Go(E.value)!==J[0].scoreValue&&rt(E,J[0].scoreValue)},i(J){R||(w(o.$$.fragment,J),w(l.$$.fragment,J),w(y.$$.fragment,J),w(O.$$.fragment,J),R=!0)},o(J){T(o.$$.fragment,J),T(l.$$.fragment,J),T(y.$$.fragment,J),T(O.$$.fragment,J),R=!1},d(J){J&&S(e),U(o),U(l),U(y),U(O),Q=!1,_e($)}}}function ak(t){let e,n,s,r,i,o,a,c,l,u,h,d,p,m,g,y=t[1]&&bu(t);return{c(){e=b("button"),n=b("i"),s=P(),r=b("span"),i=oe(t[3]),o=P(),a=b("i"),c=P(),l=b("span"),u=oe(t[2]),h=P(),y&&y.c(),d=tt(),f(n,"class","codicon codicon-filter svelte-1k7zufl"),f(a,"class","codicon codicon-arrow-swap svelte-1k7zufl"),f(e,"class","svelte-1k7zufl")},m(_,I){A(_,e,I),v(e,n),v(e,s),v(e,r),v(r,i),v(e,o),v(e,a),v(e,c),v(e,l),v(l,u),A(_,h,I),y&&y.m(_,I),A(_,d,I),p=!0,m||(g=[B(e,"click",t[4]),B(e,"keypress",kt(t[4]))],m=!0)},p(_,[I]){(!p||I&8)&&ge(i,_[3]),(!p||I&4)&&ge(u,_[2]),_[1]?y?(y.p(_,I),I&2&&w(y,1)):(y=bu(_),y.c(),w(y,1),y.m(d.parentNode,d)):y&&(he(),T(y,1,1,()=>{y=null}),de())},i(_){p||(w(y),p=!0)},o(_){T(y),p=!1},d(_){_&&S(e),_&&S(h),y&&y.d(_),_&&S(d),m=!1,_e(g)}}}const ck=Object.freeze({id:"Upload",score:"Score",updated:"Change"}),lk=Object.freeze({desc:"codicon codicon-arrow-down",asc:"codicon codicon-arrow-up"}),uk=Object.freeze({">=":"≥","<=":"≤"}),hk=Object.freeze({id:{asc:"Oldest",desc:"Newest"},score:{asc:"Worst",desc:"Best"},updated:{asc:"Inactive",desc:"Active"}}),dk=t=>t.target.blur();function fk(t,e,n){let s,r,i;Me(t,bn,p=>n(0,i=p));let o=!1;const a=()=>n(1,o=!0),c=()=>n(1,o=!1);function l(p){t.$$.not_equal(i.sortDirection,p)&&(i.sortDirection=p,bn.set(i))}function u(p){t.$$.not_equal(i.sortProperty,p)&&(i.sortProperty=p,bn.set(i))}function h(p){t.$$.not_equal(i.scoreComparator,p)&&(i.scoreComparator=p,bn.set(i))}function d(){i.scoreValue=Go(this.value),bn.set(i)}return t.$$.update=()=>{t.$$.dirty&1&&n(3,s=i.scoreValue===0&&i.scoreComparator===">="?"All":`Score${i.scoreComparator}${Et(i.scoreValue)}`),t.$$.dirty&1&&n(2,r=hk[i.sortProperty][i.sortDirection])},[i,o,r,s,a,c,l,u,h,d]}class pk extends W{constructor(e){super(),G(this,e,fk,ak,K,{})}}function gk(t){let e,n,s=Et(t[0])+"",r,i,o,a,c,l;return c=new pk({}),{c(){e=b("div"),n=b("span"),r=oe(s),i=oe(" results"),a=P(),x(c.$$.fragment),f(n,"title",o=`${t[0]} results`),f(n,"class","svelte-1rplsy"),f(e,"class","container svelte-1rplsy")},m(u,h){A(u,e,h),v(e,n),v(n,r),v(n,i),v(e,a),L(c,e,null),l=!0},p(u,[h]){(!l||h&1)&&s!==(s=Et(u[0])+"")&&ge(r,s),(!l||h&1&&o!==(o=`${u[0]} results`))&&f(n,"title",o)},i(u){l||(w(c.$$.fragment,u),l=!0)},o(u){T(c.$$.fragment,u),l=!1},d(u){u&&S(e),U(c)}}}function mk(t,e,n){let s;return Me(t,uc,r=>n(0,s=r)),[s]}class yk extends W{constructor(e){super(),G(this,e,mk,gk,K,{})}}function Iu(t,e,n){const s=t.slice();return s[8]=e[n],s}function _k(t){let e,n;return e=new G1({}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p:C,i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function vk(t){let e,n,s,r,i,o,a,c;e=new yk({}),e.$on("configchange",t[6]);let l=t[1].pages,u=[];for(let g=0;g<l.length;g+=1)u[g]=Tu(Iu(t,l,g));const h=g=>T(u[g],1,1,()=>{u[g]=null}),d=[bk,wk],p=[];function m(g,y){return g[3]?0:1}return i=m(t),o=p[i]=d[i](t),{c(){x(e.$$.fragment),n=P(),s=b("ol");for(let g=0;g<u.length;g+=1)u[g].c();r=P(),o.c(),a=tt(),f(s,"class","svelte-dsypei")},m(g,y){L(e,g,y),A(g,n,y),A(g,s,y);for(let _=0;_<u.length;_+=1)u[_]&&u[_].m(s,null);A(g,r,y),p[i].m(g,y),A(g,a,y),c=!0},p(g,y){if(y&2){l=g[1].pages;let I;for(I=0;I<l.length;I+=1){const E=Iu(g,l,I);u[I]?(u[I].p(E,y),w(u[I],1)):(u[I]=Tu(E),u[I].c(),w(u[I],1),u[I].m(s,null))}for(he(),I=l.length;I<u.length;I+=1)h(I);de()}let _=i;i=m(g),i===_?p[i].p(g,y):(he(),T(p[_],1,1,()=>{p[_]=null}),de(),o=p[i],o?o.p(g,y):(o=p[i]=d[i](g),o.c()),w(o,1),o.m(a.parentNode,a))},i(g){if(!c){w(e.$$.fragment,g);for(let y=0;y<l.length;y+=1)w(u[y]);w(o),c=!0}},o(g){T(e.$$.fragment,g),u=u.filter(Boolean);for(let y=0;y<u.length;y+=1)T(u[y]);T(o),c=!1},d(g){U(e,g),g&&S(n),g&&S(s),Lt(u,g),g&&S(r),p[i].d(g),g&&S(a)}}}function Tu(t){let e,n;return e=new F1({props:{posts:t[8]}}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p(s,r){const i={};r&2&&(i.posts=s[8]),e.$set(i)},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function wk(t){let e,n;return e=new z1({}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p:C,i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function bk(t){let e,n;return e=new B1({}),e.$on("visible",t[7]),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p:C,i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function Ik(t){let e,n,s,r;const i=[vk,_k],o=[];function a(c,l){return c[0]?0:c[2]?1:-1}return~(e=a(t))&&(n=o[e]=i[e](t)),{c(){n&&n.c(),s=tt()},m(c,l){~e&&o[e].m(c,l),A(c,s,l),r=!0},p(c,[l]){let u=e;e=a(c),e===u?~e&&o[e].p(c,l):(n&&(he(),T(o[u],1,1,()=>{o[u]=null}),de()),~e?(n=o[e],n?n.p(c,l):(n=o[e]=i[e](c),n.c()),w(n,1),n.m(s.parentNode,s)):n=null)},i(c){r||(w(n),r=!0)},o(c){T(n),r=!1},d(c){~e&&o[e].d(c),c&&S(s)}}}function Tk(t,e,n){let s,r,i,o,a;Me(t,uc,h=>n(0,o=h)),Me(t,ts,h=>n(1,a=h));const c=Xe(),l=()=>c("configchange"),u=()=>c("endreached");return t.$$.update=()=>{t.$$.dirty&1&&n(5,s=o/Op),t.$$.dirty&34&&n(3,r=a.pages.length<s),t.$$.dirty&1&&n(2,i=o===0)},[o,a,i,r,c,s,l,u]}class Ek extends W{constructor(e){super(),G(this,e,Tk,Ik,K,{})}}function kk(t){let e,n,s;return{c(){e=b("button"),e.innerHTML='<i class="codicon codicon-arrow-up"></i>',f(e,"aria-label","back to top"),f(e,"title","Go back up"),f(e,"class","svelte-1b7u605"),ce(e,"visible",t[0])},m(r,i){A(r,e,i),n||(s=B(e,"click",t[1]),n=!0)},p(r,[i]){i&1&&ce(e,"visible",r[0])},i:C,o:C,d(r){r&&S(e),n=!1,s()}}}function Sk(t,e,n){let s=0,r=!1;const i=()=>{const a=window.scrollY;n(0,r=a<s&&a>0||window.innerHeight+a>=document.body.scrollHeight),s=a};return Ds(()=>{document.addEventListener("scroll",i,{passive:!0})}),ti(()=>{document.removeEventListener("scroll",i)}),[r,()=>window.scrollTo(0,0)]}class Ak extends W{constructor(e){super(),G(this,e,Sk,kk,K,{})}}function Ck(t){let e,n,s,r,i,o,a,c,l,u,h;return{c(){e=b("div"),n=b("div"),s=b("i"),i=P(),o=b("div"),a=b("h3"),c=oe(t[2]),l=P(),u=b("span"),h=oe(t[1]),f(s,"class",r=Qe(`codicon codicon-${t[0]}`)+" svelte-12hjxw5"),f(n,"class","icon svelte-12hjxw5"),f(a,"class","svelte-12hjxw5"),f(e,"class","error svelte-12hjxw5")},m(d,p){A(d,e,p),v(e,n),v(n,s),v(e,i),v(e,o),v(o,a),v(a,c),v(o,l),v(o,u),v(u,h)},p(d,[p]){p&1&&r!==(r=Qe(`codicon codicon-${d[0]}`)+" svelte-12hjxw5")&&f(s,"class",r),p&4&&ge(c,d[2]),p&2&&ge(h,d[1])},i:C,o:C,d(d){d&&S(e)}}}function Dk(t,e,n){let{icon:s}=e,{message:r}=e,{title:i}=e;return t.$$set=o=>{"icon"in o&&n(0,s=o.icon),"message"in o&&n(1,r=o.message),"title"in o&&n(2,i=o.title)},[s,r,i]}class Vp extends W{constructor(e){super(),G(this,e,Dk,Ck,K,{icon:0,message:1,title:2})}}function Rk(t){let e;return{c(){e=b("h1"),e.textContent="kurosearch",f(e,"id","title"),f(e,"class","svelte-1qsrrgo")},m(n,s){A(n,e,s)},p:C,i:C,o:C,d(n){n&&S(e)}}}class Nk extends W{constructor(e){super(),G(this,e,null,Rk,K,{})}}function Eu(t,e,n){const s=t.slice();return s[6]=e[n],s[8]=n,s}function ku(t){let e,n,s,r=t[0],i=[];for(let c=0;c<r.length;c+=1)i[c]=Su(Eu(t,r,c));const o=c=>T(i[c],1,1,()=>{i[c]=null});let a=t[0].length>1&&t[1].loggedIn&&Au(t);return{c(){for(let c=0;c<i.length;c+=1)i[c].c();e=P(),a&&a.c(),n=tt()},m(c,l){for(let u=0;u<i.length;u+=1)i[u]&&i[u].m(c,l);A(c,e,l),a&&a.m(c,l),A(c,n,l),s=!0},p(c,l){if(l&1){r=c[0];let u;for(u=0;u<r.length;u+=1){const h=Eu(c,r,u);i[u]?(i[u].p(h,l),w(i[u],1)):(i[u]=Su(h),i[u].c(),w(i[u],1),i[u].m(e.parentNode,e))}for(he(),u=r.length;u<i.length;u+=1)o(u);de()}c[0].length>1&&c[1].loggedIn?a?a.p(c,l):(a=Au(c),a.c(),a.m(n.parentNode,n)):a&&(a.d(1),a=null)},i(c){if(!s){for(let l=0;l<r.length;l+=1)w(i[l]);s=!0}},o(c){i=i.filter(Boolean);for(let l=0;l<i.length;l+=1)T(i[l]);s=!1},d(c){Lt(i,c),c&&S(e),a&&a.d(c),c&&S(n)}}}function Su(t){let e,n;function s(){return t[3](t[8])}function r(){return t[4](t[6])}return e=new Ap({props:{tag:t[6]}}),e.$on("click",s),e.$on("contextmenu",r),{c(){x(e.$$.fragment)},m(i,o){L(e,i,o),n=!0},p(i,o){t=i;const a={};o&1&&(a.tag=t[6]),e.$set(a)},i(i){n||(w(e.$$.fragment,i),n=!0)},o(i){T(e.$$.fragment,i),n=!1},d(i){U(e,i)}}}function Au(t){let e,n,s;return{c(){e=b("button"),e.innerHTML='<i class="codicon codicon-star-full svelte-lsipoc"></i>',f(e,"class","add-supertag svelte-lsipoc"),f(e,"title","Click to create a new supertag")},m(r,i){A(r,e,i),n||(s=B(e,"click",t[5]),n=!0)},p:C,d(r){r&&S(e),n=!1,s()}}}function Ok(t){let e,n,s=t[0].length&&ku(t);return{c(){e=b("ul"),s&&s.c(),f(e,"class","svelte-lsipoc")},m(r,i){A(r,e,i),s&&s.m(e,null),n=!0},p(r,[i]){r[0].length?s?(s.p(r,i),i&1&&w(s,1)):(s=ku(r),s.c(),w(s,1),s.m(e,null)):s&&(he(),T(s,1,1,()=>{s=null}),de())},i(r){n||(w(s),n=!0)},o(r){T(s),n=!1},d(r){r&&S(e),s&&s.d()}}}function Pk(t,e,n){let s,r;Me(t,_t,l=>n(0,s=l)),Me(t,Ip,l=>n(1,r=l));const i=Xe();return[s,r,i,l=>_t.removeByIndex(l),l=>_t.addOrReplace(new Fi(IT(l.modifier),l.name,l.count,l.type)),()=>i("supertag")]}class $k extends W{constructor(e){super(),G(this,e,Pk,Ok,K,{})}}const ES=Object.freeze(["Loli","Animal-Related","Non-Consentual"]),Mk=Object.freeze({Loli:Object.freeze(["young","younger","younger_*","young_*","lolita_*","loli*"]),"Animal-Related":Object.freeze(["zoophilia","zoo","canine*","equine*","feral_*","*_feral","bestiality*","zoophilia*","animal"]),"Non-Consentual":Object.freeze(["captive","captured","defeated","rape","*_rape","rape_*","*_slave","no_consent","molestation","non-consensual","non-con","scared","forced"])});class Lk{constructor(){this.pid=0,this.tags=[],this.blockedContent=[],this.sortProperty="id",this.sortDirection="desc",this.scoreValue=0,this.scoreComparator=">=",this.tagString=null}withPid(e){return this.pid=e,this}withTags(e){return this.tags=e,this}withSupertags(e){return this.supertags=e,this}withSortProperty(e){return this.sortProperty=e,this}withSortDirection(e){return this.sortDirection=e,this}withScoreValue(e){return this.scoreValue=e,this}withScoreComparator(e){return this.scoreComparator=e,this}withBlockedContent(e){return this.blockedContent=e,this}async getPageAndCount(){return this.tagString=co(this.tags,this.sortProperty,this.sortDirection,this.scoreValue,this.scoreComparator,this.blockedContent,this.supertags),Promise.all([this.getPage(),this.getCount()])}async getPage(){return this.tagString||(this.tagString=co(this.tags,this.sortProperty,this.sortDirection,this.scoreValue,this.scoreComparator,this.blockedContent,this.supertags)),eE(this.pid,this.tagString)}async getCount(){return this.tagString||(this.tagString=co(this.tags,this.sortProperty,this.sortDirection,this.scoreValue,this.scoreComparator,this.blockedContent,this.supertags)),tE(this.tagString)}}const Cu=()=>new Lk,co=(t,e,n,s,r,i,o)=>{const a=t.filter(h=>h.type==="supertag"),c=t.filter(h=>h.type!=="supertag"),l=[`score:${r}${s}`,`sort:${e}:${n}`];if(c.length>0){const h=lo(c.map(d=>kp(d)));l.push(h)}if(a.length>0){const h=a.map(d=>o.find(p=>d.name===p.name).tags).map(d=>`${lo(d)}`).join("+");l.push(h)}if(i.length>0){const h=i.flatMap(p=>Mk[p]).map(p=>new Ui("-",p)),d=lo(h);l.push(d)}const u=l.join("+");return console.log("searching for",u),u},lo=t=>{const e=Uk(t);let n=[...Du([...e["+"],...e["-"]])];return e["~"].length>0&&n.push(`( ${Du(e["~"]).join(" ~ ")} )`),n.join("+")},Uk=t=>{const e={"+":[],"-":[],"~":[]};return t.forEach(n=>e[n.modifier].push(n)),e},Du=t=>t.map(e=>e.serialize()),Fk=()=>{const t=[],{subscribe:e,update:n}=xi("blockedContent",t);return{subscribe:e,toggle(s){n(r=>r.includes(s)?r.filter(i=>i!==s):[...r,s])}}},xk=Fk();function Vk(t){let e,n;return e=new Ek({}),e.$on("endreached",t[4]),e.$on("configchange",t[3]),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p:C,i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function Bk(t){let e,n,s,r;const i=[qk,jk],o=[];function a(c,l){return c[1].message==="Failed to fetch"?0:1}return e=a(t),n=o[e]=i[e](t),{c(){n.c(),s=tt()},m(c,l){o[e].m(c,l),A(c,s,l),r=!0},p(c,l){let u=e;e=a(c),e===u?o[e].p(c,l):(he(),T(o[u],1,1,()=>{o[u]=null}),de(),n=o[e],n?n.p(c,l):(n=o[e]=i[e](c),n.c()),w(n,1),n.m(s.parentNode,s))},i(c){r||(w(n),r=!0)},o(c){T(n),r=!1},d(c){o[e].d(c),c&&S(s)}}}function jk(t){let e,n;return e=new Vp({props:{title:"Application Error",icon:"error",message:t[1].message}}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p(s,r){const i={};r&2&&(i.message=s[1].message),e.$set(i)},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function qk(t){let e,n;return e=new Vp({props:{title:"Connection Error",icon:"debug-disconnect",message:"Failed to connect to the server. Make sure you have a stable internet connection."}}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p:C,i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function Ru(t){let e,n;return e=new jT({props:{tags:t[2]}}),e.$on("submit",t[9]),e.$on("close",t[10]),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p(s,r){const i={};r&4&&(i.tags=s[2]),e.$set(i)},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function zk(t){let e,n,s,r,i,o,a,c,l,u,h,d,p,m,g,y,_;n=new Nk({}),r=new TE({}),r.$on("pick",t[7]),o=new $k({}),o.$on("supertag",t[8]),l=new oc({props:{title:"Click to search with active tags",text:"Search"}}),l.$on("click",t[3]);const I=[Bk,Vk],E=[];function N(R,Q){return R[1]!==void 0?0:1}h=N(t),d=E[h]=I[h](t),m=new Ak({});let O=t[0]&&Ru(t);return{c(){e=b("div"),x(n.$$.fragment),s=P(),x(r.$$.fragment),i=P(),x(o.$$.fragment),a=P(),c=b("div"),x(l.$$.fragment),u=P(),d.c(),p=P(),x(m.$$.fragment),g=P(),O&&O.c(),y=tt(),f(c,"class","sort-row svelte-1lt5aa2"),f(e,"class","search-config svelte-1lt5aa2")},m(R,Q){A(R,e,Q),L(n,e,null),v(e,s),L(r,e,null),v(e,i),L(o,e,null),v(e,a),v(e,c),L(l,c,null),A(R,u,Q),E[h].m(R,Q),A(R,p,Q),L(m,R,Q),A(R,g,Q),O&&O.m(R,Q),A(R,y,Q),_=!0},p(R,[Q]){let $=h;h=N(R),h===$?E[h].p(R,Q):(he(),T(E[$],1,1,()=>{E[$]=null}),de(),d=E[h],d?d.p(R,Q):(d=E[h]=I[h](R),d.c()),w(d,1),d.m(p.parentNode,p)),R[0]?O?(O.p(R,Q),Q&1&&w(O,1)):(O=Ru(R),O.c(),w(O,1),O.m(y.parentNode,y)):O&&(he(),T(O,1,1,()=>{O=null}),de())},i(R){_||(w(n.$$.fragment,R),w(r.$$.fragment,R),w(o.$$.fragment,R),w(l.$$.fragment,R),w(d),w(m.$$.fragment,R),w(O),_=!0)},o(R){T(n.$$.fragment,R),T(r.$$.fragment,R),T(o.$$.fragment,R),T(l.$$.fragment,R),T(d),T(m.$$.fragment,R),T(O),_=!1},d(R){R&&S(e),U(n),U(r),U(o),U(l),R&&S(u),E[h].d(R),R&&S(p),U(m,R),R&&S(g),O&&O.d(R),R&&S(y)}}}function Hk(t,e,n){let s,r,i,o,a;Me(t,bn,I=>n(6,s=I)),Me(t,xk,I=>n(12,r=I)),Me(t,Cs,I=>n(13,i=I)),Me(t,_t,I=>n(2,o=I)),Me(t,ts,I=>n(14,a=I));let c=!1,l,u=!1,h=JSON.stringify(s);const d=async()=>{n(1,l=void 0),u=!0,ts.reset();try{const[I,E]=await Cu().withPid(a.nextPage).withTags(o).withSupertags(i.supertags).withSortProperty(s.sortProperty).withSortDirection(s.sortDirection).withScoreValue(s.scoreValue).withScoreComparator(s.scoreComparator).withBlockedContent(r).getPageAndCount();ts.addPage(I),uc.set(E)}catch(I){n(1,l=I),console.warn(I)}finally{u=!1}},p=async()=>{if(!u){n(1,l=void 0),u=!0;try{const I=await Cu().withPid(a.nextPage).withTags(o).withSupertags(i.supertags).withSortProperty(s.sortProperty).withSortDirection(s.sortDirection).withScoreValue(s.scoreValue).withScoreComparator(s.scoreComparator).withBlockedContent(r).getPage();ts.addPage(I)}catch(I){n(1,l=I),console.warn(I)}finally{u=!1}}},m=I=>_t.addOrReplace(I.detail),g=()=>{n(0,c=!0)},y=I=>{Cs.addSupertag(I.detail),_t.set([new Fi("+",I.detail.name,I.detail.tags.length,"supertag")])},_=()=>{n(0,c=!1)};return t.$$.update=()=>{if(t.$$.dirty&96){const I=JSON.stringify(s);h!==I&&(n(5,h=I),d())}},[c,l,o,d,p,h,s,m,g,y,_]}class Kk extends W{constructor(e){super(),G(this,e,Hk,zk,K,{})}}function Gk(t){let e,n;return e=new cc({}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},p:C,i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function Wk(t){let e,n,s;var r=t[0];function i(o){return{}}return r&&(e=gc(r,i())),{c(){e&&x(e.$$.fragment),n=tt()},m(o,a){e&&L(e,o,a),A(o,n,a),s=!0},p(o,a){if(a&1&&r!==(r=o[0])){if(e){he();const c=e;T(c.$$.fragment,1,0,()=>{U(c,1)}),de()}r?(e=gc(r,i()),x(e.$$.fragment),w(e.$$.fragment,1),L(e,n.parentNode,n)):e=null}},i(o){s||(e&&w(e.$$.fragment,o),s=!0)},o(o){e&&T(e.$$.fragment,o),s=!1},d(o){o&&S(n),e&&U(e,o)}}}function Qk(t){let e,n,s,r;const i=[Wk,Gk],o=[];function a(c,l){return c[0]?0:1}return e=a(t),n=o[e]=i[e](t),{c(){n.c(),s=tt()},m(c,l){o[e].m(c,l),A(c,s,l),r=!0},p(c,[l]){let u=e;e=a(c),e===u?o[e].p(c,l):(he(),T(o[u],1,1,()=>{o[u]=null}),de(),n=o[e],n?n.p(c,l):(n=o[e]=i[e](c),n.c()),w(n,1),n.m(s.parentNode,s))},i(c){r||(w(n),r=!0)},o(c){T(n),r=!1},d(c){o[e].d(c),c&&S(s)}}}function Yk(t,e,n){let{loadComponent:s}=e,r;return Ds(async()=>{n(0,r=(await s()).default)}),t.$$set=i=>{"loadComponent"in i&&n(1,s=i.loadComponent)},[r,s]}class hc extends W{constructor(e){super(),G(this,e,Yk,Qk,K,{loadComponent:1})}}function Xk(t){let e;return{c(){e=b("p"),e.textContent="You got lost..."},m(n,s){A(n,e,s)},i:C,o:C,d(n){n&&S(e)}}}function Jk(t){let e,n;return e=new hc({props:{loadComponent:iS}}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function Zk(t){let e,n;return e=new hc({props:{loadComponent:rS}}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function eS(t){let e,n;return e=new hc({props:{loadComponent:sS}}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function tS(t){let e,n;return e=new Kk({}),{c(){x(e.$$.fragment)},m(s,r){L(e,s,r),n=!0},i(s){n||(w(e.$$.fragment,s),n=!0)},o(s){T(e.$$.fragment,s),n=!1},d(s){U(e,s)}}}function nS(t){let e,n,s,r;const i=[tS,eS,Zk,Jk,Xk],o=[];function a(c,l){return c[0]==="search"?0:c[0]==="account"?1:c[0]==="settings"?2:c[0]==="help"?3:4}return n=a(t),s=o[n]=i[n](t),{c(){e=b("main"),s.c(),f(e,"class","svelte-628m8p")},m(c,l){A(c,e,l),o[n].m(e,null),r=!0},p(c,[l]){let u=n;n=a(c),n!==u&&(he(),T(o[u],1,1,()=>{o[u]=null}),de(),s=o[n],s||(s=o[n]=i[n](c),s.c()),w(s,1),s.m(e,null))},i(c){r||(w(s),r=!0)},o(c){T(s),r=!1},d(c){c&&S(e),o[n].d()}}}const sS=()=>$i(()=>import("./Account-5f26eb9f.js"),["assets/Account-5f26eb9f.js","assets/Account-0bbfdf36.css"]),rS=()=>$i(()=>import("./Preferences-c5efa60f.js"),["assets/Preferences-c5efa60f.js","assets/ParagraphHeading-160207b1.js","assets/ParagraphHeading-5a89239e.css","assets/Preferences-f3816ec2.css"]),iS=()=>$i(()=>import("./Help-9b898324.js"),["assets/Help-9b898324.js","assets/ParagraphHeading-160207b1.js","assets/ParagraphHeading-5a89239e.css","assets/Help-9081c352.css"]);function oS(t,e,n){let s;return Me(t,In,r=>n(0,s=r)),[s]}class aS extends W{constructor(e){super(),G(this,e,oS,nS,K,{})}}function cS(t){let e;return{c(){e=b("footer"),e.innerHTML=`<div class="flex left svelte-1bok05j"><a title="Source Code" href="https://github.com/kurozenzen/kurosearch" target="_newtab" class="svelte-1bok05j"><i class="codicon codicon-github"></i> Github</a></div> 
  <span class="copyright svelte-1bok05j">© 2022 kurozenzen</span> 
  <div class="flex right svelte-1bok05j"><a title="Application Status" href="https://stats.uptimerobot.com/EZVwES34jJ" target="_newtab" class="svelte-1bok05j"><i class="codicon codicon-zap"></i> Status</a></div>`,f(e,"class","svelte-1bok05j")},m(n,s){A(n,e,s)},p:C,i:C,o:C,d(n){n&&S(e)}}}class lS extends W{constructor(e){super(),G(this,e,null,cS,K,{})}}const{subscribe:uS,set:hS}=Up("theme","dark"),Nu={subscribe:uS,set(t){hS(t),dS(t),Cs.setTheme(t)}},dS=t=>{document.documentElement.classList.replace(fS(t),t)},fS=t=>t==="dark"?"light":"dark";function pS(t){let e,n,s,r,i,o;return e=new vT({}),s=new aS({}),i=new lS({}),{c(){x(e.$$.fragment),n=P(),x(s.$$.fragment),r=P(),x(i.$$.fragment)},m(a,c){L(e,a,c),A(a,n,c),L(s,a,c),A(a,r,c),L(i,a,c),o=!0},p:C,i(a){o||(w(e.$$.fragment,a),w(s.$$.fragment,a),w(i.$$.fragment,a),o=!0)},o(a){T(e.$$.fragment,a),T(s.$$.fragment,a),T(i.$$.fragment,a),o=!1},d(a){U(e,a),a&&S(n),U(s,a),a&&S(r),U(i,a)}}}function gS(t){return Nu.subscribe(e=>Nu.set(e))(),[]}class mS extends W{constructor(e){super(),G(this,e,gS,pS,K,{})}}function yS(t={}){const{immediate:e=!1,onNeedRefresh:n,onOfflineReady:s,onRegistered:r,onRegisteredSW:i,onRegisterError:o}=t;let a,c;const l=async(h=!0)=>{await c};async function u(){if("serviceWorker"in navigator){const{Workbox:h}=await $i(()=>import("./workbox-window.prod.es5-dc90f814.js"),[]);a=new h("/sw.js",{scope:"/",type:"classic"}),a.addEventListener("activated",d=>{(d.isUpdate||d.isExternal)&&window.location.reload()}),a.addEventListener("installed",d=>{d.isUpdate||s==null||s()}),a.register({immediate:e}).then(d=>{i?i("/sw.js",d):r==null||r(d)}).catch(d=>{o==null||o(d)})}}return c=u(),l}new mS({target:document.getElementById("app")});yS();export{CE as $,ce as A,oc as B,Fu as C,Cp as D,Ue as E,yt as F,mt as G,rt as H,Zt as I,Ip as J,Me as K,Cs as L,Ql as M,Kl as N,Up as O,Pu as P,Lu as Q,Uu as R,W as S,Mu as T,Nu as U,xk as V,_S as W,nk as X,ES as Y,Ap as Z,Fi as _,f as a,Yr as a0,Ak as a1,PT as a2,A as b,v as c,ge as d,b as e,Un as f,C as g,S as h,G as i,P as j,tt as k,B as l,w as m,Qe as n,kt as o,he as p,de as q,T as r,K as s,oe as t,Lt as u,_e as v,Xe as w,x,L as y,U as z};
