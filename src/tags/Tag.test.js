...
describe("Tag", () => {
  describe("constructor", () => {
    ...
    describe("count", () => {
      test("undefined throws TypeError", () => {
        expect(() => new Tag("example", undefined, "general")).toThrow(
          TypeError
        );
      });
    ...
    describe("toActiveTag", () => {
      describe("modifier", () => {
        test("undefined throws TypeError", () => {
          expect(() =>
            new Tag("example", 10, "general").toActiveTag(undefined)
          ).toThrow(TypeError);
        });

        test("null throws TypeError", () => {
          expect(() =>
            new Tag("example", 10, "general").toActiveTag(null)
          ).toThrow(TypeError);
        });

        test("invalid string TypeError", () => {
          expect(() =>
            new Tag("example", 10, "general").toActiveTag("a")
          ).toThrow(TypeError);
        });
      });
