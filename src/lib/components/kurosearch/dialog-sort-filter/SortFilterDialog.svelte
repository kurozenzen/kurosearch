...
<Dialog bind:dialog onclose={oncloseinternal}>
	<div class="container">
		...
		<TextButton title="Return to searching" class="mixin-accent" onclick={oncloseinternal}>
			Done
		</TextButton>
		<TextButton title="Reset sort and filter" class="mixin-secondary" onclick={reset}>
			Reset
		</TextButton>
	</div>
</Dialog>
