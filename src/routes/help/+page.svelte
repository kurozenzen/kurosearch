...
<PageGeneric title="Documentation">
	<div class="cards">
		<SummaryCard
			id="search"
			icon="search"
	...
	<DocsSection id="search" title="Searching">
		<p>
			All searching in kurosearch is based on so-called <em>tags</em>. In that sense it is not like
			Google. With Google you can search for whole sentences or questions. In kurosearch you have to
			search for one of the predefined tags. Luckily, there are quite a lot of them.
		</p>
		...
		<Heading3>Number Of Results</Heading3>

		<p>
			In addition to the posts themselves you can also see how many posts matched your search. The
			count is located to the left immediately above the first post.
		</p>

		<p>
			If your search did not match any posts that means you search for some tags that do not have
			any posts in common. You will also get a cute error message saying so.
		</p>

		<Heading3>Sorting results</Heading3>

		<p>
			Once you have searched, you can sort your results by using the selector above the first post.
		...
		<ul>
			<li>
				<em>Date</em>
				<p>
					This is the default sorting. It will order the results in a way that newer results appear
					at the top of the search and older results at the bottom. This is useful if you want to
					see new posts.
				</p>
			</li>
			<li>
				<em>Score</em>
				<p>
					This option will order posts according to the number of likes they received. Posts with
					more likes will be shown first. This is useful if you are interested in the most popular
					posts.
				</p>
			</li>
			<li>
		...
		<Heading3>Filtering results</Heading3>

		<p>
			In addition to sorting kurosearch also support a simple form of filtering. Currently, only
			filtering by score is supported.
		</p>
	...
	<DocsSection id="tags" title="Tags">
		<p>
			When you input something into the searchbar you will get some suggestions. These things are
			called <em>tags</em>. They will usually be presented like this.
		</p>

		<div class="flex-row">
			<DetailedTag
				tag={{ modifier: '+', name: 'some_tag_you_search_for', count: 124232, type: 'copyright' }}
				active
			/>
			<DetailedTag tag={{ modifier: '+', name: 'some_tag', count: 1123, type: 'ambiguous' }} />
		</div>
		...
		<p>
			The name of the tag is what you actually search for. It is usually pretty descriptive and well
			defined. Oftentimes, there are multiple tags for the same thing though so it might take a bit
			of trial and error to find the best one for you.
		</p>

		<Heading3>Type</Heading3>

		<p>
			The type indicates what kind of tag it is. It is displayed in form of an icon right before the
			name of the tag. the possible types are the following.
		</p>
		...
		<Heading3>Modifier</Heading3>

		<p>
			In kurosearch tags can have modifiers that change how they influence your search. You can
			change the modifier directly in the searchbar. Intuitively, you would think like this: Picking
			a tag means posts in the results will have it, right? In kurosearch this is done with the <em
				>include</em
			> modifier.
		</p>
		...
		<ul>
			<li>
				<em>Include</em> (+)
				<p>
					This is the default modifier. Using it with tags will make the search include them. This
			...
			<li>
				<em>Exclude</em> (-)
				<p>
					The exclude modifier is subtractive. If you exclude a tag, the results will NOT have that
					tag. Even if a post would be included in your search otherwise, if it has one of your
					exclude tags on it, it will not be shown. Use this for all things that you dislike and
			...
			<li>
				<em>Optional</em> (~)
				<p>
					The optional tags are the most complicated ones. When adding multiple optional tags, all
					results will include at least one of the optional tags. That means that optional tags only
					become effective once you have two of them. Optional tags are useful when there are
					multiple tags for the same thing or you are not searching for one specific thing but
					multiple instead.
				</p>
	...
	<DocsSection id="account" title="Account & Data">
		<p>
			While kurosearch does not have dedicated accounts, it offers the ability to connect your
			google account. This allows you to save your settings, supertags and favourite posts to Google
			Drive so you can access them from any device.
		</p>
	</DocsSection>

	<DocsSection id="development" title="Development">
		<p>
			Kurosearch is built using SvelteKit.<br />
			All content is hosted by rule34.xxx and fetched using their API.<br />
		</p>
	</DocsSection>
</PageGeneric>
